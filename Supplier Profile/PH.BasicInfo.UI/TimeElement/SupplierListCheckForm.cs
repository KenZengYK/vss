...
{
    public partial class SupplierListCheckForm : PH.Platform.UI.CS.UI2.ListForm
    {
        string Param1;
        string Param2;
        public SupplierListCheckForm()
        {
            InitializeComponent();
        ...
        public SupplierListCheckForm(string AParam1, string AParam2)
            : this()
        {
            Param1 = AParam1;
            Param2 = AParam2;
        ...
        public SupplierListCheckForm(string supplierType)
        {
            InitializeComponent();
        ...
        private void objListGridControl_Load(object sender, EventArgs e)
        {
            ...
            colSupplier.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.None;
            colRegionCode.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.None;
            colCountry.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.None;
            colSupplier.SummaryItem.SummaryType = DevExpress.Data.SummaryItemType.None;
