...
{
    public partial class SupplierContactModeForm : PH.Platform.UI.CS.UI2.ListForm
    {
        string Param1;
        string Param2;
        public SupplierContactModeForm()
        {
            InitializeComponent();
        ...
        //只显示有Co. Group的Supplier, 第一个参数只能是: OnlyShowCoGroup, 第二个参数固定为1
        public SupplierContactModeForm(string AParam1, string AParam2)
            : this()
        {
            Param1 = AParam1;
            Param2 = AParam2;
        ...
        public SupplierContactModeForm(string supplierType)
        {
            InitializeComponent();
        ...
        public override void DataBind()
        {
            ...
            {
                this.BindingSource.DataSource = SPDataList.GetDataByCondition("(DeleteFlag=0 or DeleteFlag is null) and Active='1'");
