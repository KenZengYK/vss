...
namespace PH.BasicInfo.BackEnd.TimeElement.Report
{
    public partial class SupplierWithAffiliatePartnersGroupRpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void Detail1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            //Xsj100820:い丁︽,陪ボㄢ娩娩,狦琌程︽玥陪ボㄢ娩㎝场娩(Θ虫じ狦).
            ...
            //Xsj:留旅FCL︽
            if (sp.IncontermsTransits == null || sp.IncontermsTransits.Count == 0 || _currGroupRowIndex <= 0) return;
