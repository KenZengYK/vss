...
{
    public partial class sFabric_Insp_Header : PH.Platform.BO.BaseEntity
    {
        //string _OddEvenRowFlag = "";
        public string OddEvenRowFlag { get; set; }
        //{
        //    get
        //    {
        //        return _OddEvenRowFlag;
        //    }
        //    set
        //    {
        //        _OddEvenRowFlag = value;
        //    }
        //}
        ...
        public string RegularLossWidth
        {
            get
            {
                ...
                var lists = this.sFabric_Insp_SpreadDefects.Where(p => p.AddtionalPercent > 0 && !(p.IsCutOut??false) );
        ...
        public string ShowScoreGrpQty
        {
            get
            {
                int Degree = this.sFabric_Insp_PartDefects.Where(dr => dr.Defect_Degree != 4).Select(dr => dr.Defect_Degree * (dr.Defect_Degree_Count ?? 0)).Sum();
                int Acount = this.sFabric_Insp_PartDefects.Where(dr => dr.Defect_Degree == 4).Select(dr => dr.Defect_Degree_Count ?? 0).Sum();
        ...
        public string ChainDefectWidthPercentShow
        {
            get
            {
                ...
                if (!this.Usable_Width.HasValue || (this.sFabric_Insp_SpreadDefects.Where(p => (p.AddtionalPercent ?? 0) > 0).Count() == 0))
                {
                    return "";
                }
                ...
                decimal ChainDefectWidth = this.sFabric_Insp_SpreadDefects.Where(p => (p.AddtionalPercent ?? 0) > 0 && !(p.IsCutOut??false) )
                    .Select(p => new { Qty = p.To_Place - p.From_Place }).Sum(p => p.Qty);
        ...
        public string ChainDefectLengthPercentShow
        {
            get
            {
                ...
                if (!this.MeasLengthShow.HasValue || (this.sFabric_Insp_SpreadDefects.Where(p => (p.AddtionalPercent ?? 0) > 0).Count() == 0))
                {
                    return "";
                }
                ...
                decimal ChainDefectLength = this.sFabric_Insp_SpreadDefects.Where(p => (p.AddtionalPercent ?? 0) > 0 && !(p.IsCutOut??false) )
                    .Select(p => new { Qty = (p.To_Place_Length ?? 0) - (p.From_Place_Length ?? 0) }).Sum(p => p.Qty);
    ...
    public  partial class sFabric_Insp_PartDefect : PH.Platform.BO.BaseEntity
    {
        public string Lot_Id
        {
            get
            {
                if (this.sFabric_Insp_Header != null)
                {
                    return this.sFabric_Insp_Header.Lot_Id;
                }
                else
                {
                    return "";
        ...
        public Nullable<decimal> Actual_Length
        {
            get
            {
                return this.sFabric_Insp_Header.Actual_Length;
            }
        }
        ...
        public string Supplier_Length_Unit
        {
            get
            {
                return this.sFabric_Insp_Header.Supplier_Length_Unit;
            }
        }
        ...
        public string Roll_No
        {
            get
            {
                return this.sFabric_Insp_Header.Roll_No;
            }
        }
        ...
        public string Supplich_Batch
        {
            get
            {
                return this.sFabric_Insp_Header.Supplich_Batch;
            }
        }
        ...
        public ImgMsg Photo_A
        {
            get
            {
                ...
                string itemNo = this.sFabric_Insp_Header.Item_No.Substring(0, 12);
                string lotId = this.sFabric_Insp_Header.Lot_Id;
                string imgPath = null;
    ...
    public partial class sFabric_Insp_Picture : PH.Platform.BO.BaseEntity
    {
    ...
    public partial class sFabric_Insp_SpreadDefect : PH.Platform.BO.BaseEntity
    {
        public string Lot_Id
        {
            get
        ...
        public decimal? Special_Marker
        {
            get
            {
                return this.sFabric_Insp_Header.Special_Marker;
            }
        }
        public decimal? SpecialMarkerDeductiveQty
        {
            get
            {
                return this.sFabric_Insp_Header.SpecialMarkerDeductiveQty;
            }
        }
    ...
    partial class sFabric_Defect_File : PH.Platform.BO.BaseEntity
    {
    ...
    public class sActionLogIncompleteResult
    {
