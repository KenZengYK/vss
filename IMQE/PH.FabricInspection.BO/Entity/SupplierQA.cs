...
{
    public class SupplierQA
    {
        #region 構造函數
        //帶參數構造函數
        //帶參數構造函數
        public SupplierQA(string supplier_Code)
        {

            this._Supplier_Code = supplier_Code;
          
        }
        public SupplierQA(string company,string supplier_Code, string system_Install_No, decimal? panel_Size1, decimal? panel_Size2,decimal? usable_Width)  
        {
       ...
       private decimal? _Usable_Width = 0M;
        ...
        private string _SupplierName;//1
        ...
        /// <summary>
        /// Xsj20120908:合計SpreadDefectPercentage和PartDefectPercentage
        /// </summary>
        public decimal? DefectPercentage
        {
            get
            {
                return (this.SpreadDefectPercentage ?? 0) + (this.PartDefectPercentage ?? 0);
            }
        }
