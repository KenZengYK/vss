...
namespace PH.FabricInspection.BO
{
    ...
    public partial class sAccessoryHeader : BaseEntity
    {
        ...
        public override void Save(System.Data.Linq.DataContext ADataContext, System.Windows.Forms.BindingSource ABindingSource)
        {
            ...
            IEnumerable<sAccessoryHeader> lists = ABindingSource.List as IEnumerable<sAccessoryHeader>;
            ...
            //计算Defect Qty
            this.DefectQty = this.sAccessoryDefects.Select(p => p.Qty).Sum();
            ...
            //计算Spot Defect
            SpotDefectPointQty = this.sAccessoryDefects.Select(p => (p.Qty ?? 0)).Sum();
            ...
            foreach (var o in ByLots)
            {
                ...
                int? iDefectCount = o.sAccessoryDefects.Where(p => DefectTop4.Contains(p.DefectCode)).Count();
                o.DefectCount = iDefectCount;

                //计算Casing Top 1 ~ Top 4中的疵点个数 Ttl Casing Defect *
                o.CasingTotalDefectQty = o.sAccessoryCasingDefects.Where(p => CasingDefectTop2.Contains(p.DefectCode)).Count();
    ...
    public partial class sAccessoryDefect : BaseEntity
    {
    ...
    public partial class sAccessoryCasingDefect : BaseEntity
    {
        private PHQCDefect QCDefect
        {
            get
