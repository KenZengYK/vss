...
{
    public partial class sMasterListForm : PH.Platform.UI.CS.UI2.ListForm
    {
        #region//auto code
        ...
        private void InitializeComponent()
        {
            ...
            this.objListGridControl.Size = new System.Drawing.Size(1518, 383);
            ...
            this.gridBand4,
            this.gridBand5});
            this.bandedGridView1.ColumnPanelRowHeight = 85;
            ...
            this.colActionLogIsCompleted.Width = 47;
            // 
            // Columns_System_NO
            // 
            ...
            this.Size = new System.Drawing.Size(1518, 440);
        ...
        public sMasterListForm()
        {
            this.Disposed += new EventHandler(sMasterListForm_Disposed);
            InitializeComponent();
        ...
        string _DailyDate = "";
        public sMasterListForm(string ADailyDate, string AWarehouse)
            : this()
        {
        ...
        string _ToDate = "";
        string _Warehouse = "";
        public sMasterListForm(string AFromDate, string AToDate, string AWarehouse)
            : this()
        {
            _FromDate = AFromDate;
            _ToDate = AToDate;
        ...
        public sMasterListForm(bool AOnlyShowIncompleted)
            : this()
        {
        ...
        public override void DataBind()
        {
            ...
            sFabric_Insp_HeaderList fabric_Insp_HeaderList = new sFabric_Insp_HeaderList();
            ...
            {
                var lists = fabric_Insp_HeaderList.GetFabric_Insp_HeaderListFilter(strToday);
        ...
        /// <param name="e"></param>
        void sMasterListForm_Disposed(object sender, EventArgs e)
        {
        ...
        private void barBtnTouchScreen_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            //    string strToday = MasterTableUtil.getTodayBefore60String();
            //    Fabric_Insp_HeaderList fabric_Insp_HeaderList = new Fabric_Insp_HeaderList();
            //    this.BindingSource.DataSource = fabric_Insp_HeaderList.GetFabric_Insp_HeaderListFilter(strToday);
            //    this.DataContext = fabric_Insp_HeaderList.CurrentDataContext;
            //}
            //catch (Exception ex)
            //{
        ...
        private void toolStripMenuItemCopyto2ndAudit_Click(object sender, EventArgs e)
        {
            ...
            if (frmCopy.ShowDialog() == DialogResult.OK)
            {
                ...
                {
                    string Str = string.Format("Exists {0} approval audit row, please re-select", ToAuditStage);
