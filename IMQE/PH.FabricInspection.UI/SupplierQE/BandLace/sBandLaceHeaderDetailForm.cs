...
{
    public partial class sBandLaceHeaderDetailForm : PH.Platform.UI.CS.UI2.ParentChildForm
    {
        public sBandLaceHeaderDetailForm()
        {
            InitializeComponent();
        }
        ...
        protected override void SaveCurrent()
        {
            ...
            BandLaceHeader obj = this.BindingSource.Current as BandLaceHeader;
            obj.Save(db, (this.ListForm as sBandLaceHeaderListForm).BindingSource);
            base.SaveCurrent();
        }
        ...
        private void buttonEdit1_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            AlertLogForm frmAlertLog = new AlertLogForm(ActionLogProcessModes.BandLace, db, MissingAudit, obj.ActionLogOID, (this.ListForm as sBandLaceHeaderListForm), Suppliers, Projects, Batchs);
        ...
        //    var List = (this.ListForm as sBandLaceHeaderListForm).BindingSource.DataSource as IEnumerable<BandLaceHeader>;
