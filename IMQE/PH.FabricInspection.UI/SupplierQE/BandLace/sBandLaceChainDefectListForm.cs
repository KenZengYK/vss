...
{
    public partial class sBandLaceChainDefectListForm : PH.Platform.UI.CS.UI2.ListForm
    {
        public sBandLaceChainDefectListForm()
        {
            InitializeComponent();
        }
        ...
        public override void SaveData()
        {
            ...
            //BandLaceChainDefect Obj = this.BindingSource.Current as BandLaceChainDefect;
            //if(Obj != null) 
            base.SaveData();
        }
