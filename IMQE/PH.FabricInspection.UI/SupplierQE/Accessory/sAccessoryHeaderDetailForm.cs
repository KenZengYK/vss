...
{
    public partial class sAccessoryHeaderDetailForm : PH.Platform.UI.CS.UI2.ParentChildForm
    {
        public sAccessoryHeaderDetailForm()
        {
            InitializeComponent();
        }
        ...
        protected override void SaveCurrent()
        {
            ...
            AccessoryHeader obj = this.BindingSource.Current as AccessoryHeader;
            obj.Save(db, (this.ListForm as sAccessoryHeaderListForm).BindingSource);
        }
        ...
        private void actionLogNOButtonEdit_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            FabricInspectionDataContext db = this.DataContext as FabricInspectionDataContext;
            AccessoryHeader obj = this.BindingSource.Current as AccessoryHeader;
            sAccessoryHeaderListForm HeaderListForm = this.ListForm as sAccessoryHeaderListForm;
            ...
            AlertLogForm frmAlertLog = new AlertLogForm(ActionLogProcessModes.Accessories, db, MissingAudit, obj.ActionLogOID, (this.ListForm as sAccessoryHeaderListForm), Suppliers, Projects, Batchs);
