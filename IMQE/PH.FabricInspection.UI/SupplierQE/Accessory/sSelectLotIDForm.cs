...
namespace PH.FabricInspection.UI.SupplierQE.Accessory
{
    public partial class sSelectLotIDForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        void PrepareData(string AAuditStage, string ACompany, DateTime AIDCreateDate, string AItemCode, string AColorCode)
        {
            ...
            List<sAccessorySelectLotIDResult> lists = dt.AsEnumerable().Select(dr => new sAccessorySelectLotIDResult
            {
        ...
        public List<sAccessorySelectLotIDResult> GetSelectData()
        {
            List<sAccessorySelectLotIDResult> SelectLists = new List<sAccessorySelectLotIDResult>();
            for (int i = 0; i < this.gridView.RowCount; i++)
            {
                sAccessorySelectLotIDResult obj = this.gridView.GetRow(i) as sAccessorySelectLotIDResult;
        ...
        public List<sAccessorySelectLotIDResult> GetAllData()
        {
            return this.bindingSource.DataSource as List<sAccessorySelectLotIDResult>;
        }
    ...
    //用于Accessory和Bra cup从ERP中导入检查ID
    public class sAccessorySelectLotIDResult : BaseEntity
    {
