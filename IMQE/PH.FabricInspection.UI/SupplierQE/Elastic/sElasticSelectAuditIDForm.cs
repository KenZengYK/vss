...
{
    public partial class sElasticSelectAuditIDForm : DevExpress.XtraEditors.XtraForm
    {
        public sElasticSelectAuditIDForm(string APONO, DateTime AIDCreateDate)
        {
            InitializeComponent();
            this.PrepareData(APONO, AIDCreateDate);
        }

        void PrepareData(string APONO, DateTime AIDCreateDate)
        {
            ...
            string SqlStr = string.Format("exec sp_ImportDataFromERP_Elastic '{0}', '{1}', '{2}'", "P1", APONO, ConvertedIDCreateDate);
