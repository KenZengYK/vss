...
{
    public partial class sElasticHeaderDetailForm : PH.Platform.UI.CS.UI2.ParentChildForm
    {
        public sElasticHeaderDetailForm()
        {
            InitializeComponent();
        }
        ...
        {
            base.DataBind();
            sElasticHeader obj = this.BindingSource.Current as sElasticHeader;
            elasticSpotDefectListForm1.BindingSource.DataSource = obj.sElasticSpotDefects;
            elasticChainDefectListForm1.BindingSource.DataSource = obj.sElasticChainDefects;
        ...
        protected override void SaveCurrent()
        {
            ...
            obj.Save(db, (this.ListForm as sElasticHeaderListForm).BindingSource);
        }
        ...
        private void buttonEdit1_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            ...
            {
                var lists = ((this.ListForm as sElasticHeaderListForm).BindingSource.DataSource as IEnumerable<sElasticHeader>).Where(p => p.ActionLogOID == obj.ActionLogOID).Select(p => new { p.SuppCode, p.ProjectNo, p.BoxNo });
            ...
            AlertLogForm frmAlertLog = new AlertLogForm(ActionLogProcessModes.Elastic, db, MissingAudit, obj.ActionLogOID, (this.ListForm as sElasticHeaderListForm), Suppliers, Projects, "");
        ...
        //    var List = (this.ListForm as sElasticHeaderListForm).BindingSource.DataSource as IEnumerable<sElasticHeader>;
