...
{
    public partial class RN_Basic : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        //版本號:  
        public RN_Basic(string VersionNum):this()
        {
            this.xrLblVersionNum.Text = VersionNum;
        }
        //----End

        private void RN_Basic_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
