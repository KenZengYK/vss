...
{
    public partial class MaterialQAReport_OldVersion : DevExpress.XtraReports.UI.XtraReport
    {
        List<MaterialQA> MList = new List<MaterialQA>();
        public MaterialQAReport_OldVersion(List<MaterialQA> mqas, string period)
        {
            InitializeComponent();
            MList = mqas;
            bindRptDataSource();
