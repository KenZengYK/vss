...
{
    public partial class SupplierAnalyseReport_OldVersion : DevExpress.XtraReports.UI.XtraReport
    {
        List<SupplierQA> SList = new List<SupplierQA>();
        public SupplierAnalyseReport_OldVersion(List<SupplierQA> sqas, string period)
        {
            InitializeComponent();
            SList = sqas;
            bindRptDataSource();
