...
{
    public partial class RN_WeftYarn : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        //版本號:  
        public RN_WeftYarn(string VersionNum)
            : this()
        {
        ...
        private void RN_WeftYarn_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
