...
{
    class RNHeaderByShortLengthReport
    {
        ...
        public RNHeaderByShortLengthReport()
        {
            ...
            QC_Summary = "";
            this.RNDetailItems = new List<RNDetailByShortLengthReport>();
        }
        ...
        public decimal ShortLengthSubPHSample
        {
            get { return _actual_Short_Length - _total_PH_Sample; }
        }
        ...
        private List<RNDetailByShortLengthReport> _RNDetailItems;

        public List<RNDetailByShortLengthReport> RNDetailItems
        {
            get
            {
