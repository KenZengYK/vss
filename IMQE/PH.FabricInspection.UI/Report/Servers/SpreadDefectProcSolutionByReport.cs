...
{
    class SpreadDefectProcSolutionByReport
    {
        ...
        private string _SpreadDefect_NameName;
        public string SpreadDefect_NameName
        {
            get
            {
                ...
                var objs = (from c in context.PHQCDefects where c.PHDefectCode == this.SpreadDefect_Name select c).FirstOrDefault();
                if (objs == null)
                    return "";
                else
