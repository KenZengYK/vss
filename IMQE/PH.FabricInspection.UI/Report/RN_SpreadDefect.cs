...
{
    public partial class RN_SpreadDefect : DevExpress.XtraReports.UI.XtraReport
    {
        public string WhereCondition { get; set; }
        public FabricInspectionDataContext DataContext { get; set; }
        public RN_SpreadDefect()
        {
            InitializeComponent();
        }
        ...
        //版本號:  
        public RN_SpreadDefect(string VersionNum)
            : this()
        {
        ...
        private void RN_SpreadDefect_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
