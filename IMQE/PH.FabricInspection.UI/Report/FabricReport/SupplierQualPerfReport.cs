...
{
    public partial class SupplierQualPerfReport : DevExpress.XtraReports.UI.XtraReport
    {
        public SupplierQualPerfReport(DataTable ADataTable, string AReportTitle, DateTime ADateFrom, DateTime ADateTo, string AWarehouse)
        {
            InitializeComponent();
