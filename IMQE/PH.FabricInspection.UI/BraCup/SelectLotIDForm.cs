...
namespace PH.FabricInspection.UI.BraCup
{
    public partial class SelectLotIDForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        void PrepareData(string AAuditStage, string ACompany, DateTime AIDCreateDate, string AItemCode, string AColorCode)
        {
            ...
            List<BraCupSelectLotIDResult> lists = dt.AsEnumerable().Select(dr => new BraCupSelectLotIDResult
            {
        ...
        public List<BraCupSelectLotIDResult> GetSelectData()
        {
            List<BraCupSelectLotIDResult> SelectLists = new List<BraCupSelectLotIDResult>();
            for (int i = 0; i < this.gridView.RowCount; i++)
            {
                BraCupSelectLotIDResult obj = this.gridView.GetRow(i) as BraCupSelectLotIDResult;
        ...
        public List<BraCupSelectLotIDResult> GetAllData()
        {
            return this.bindingSource.DataSource as List<BraCupSelectLotIDResult>;
        }
    ...
    public class BraCupSelectLotIDResult : BaseEntity
    {
