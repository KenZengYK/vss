...
{
    public partial class BraCupHeaderDetailForm : PH.Platform.UI.CS.UI2.ParentChildForm
    {
        public BraCupHeaderDetailForm()
        {
            InitializeComponent();
        }
        ...
        protected override void SaveCurrent()
        {
            ...
            BraCupHeader obj = this.BindingSource.Current as BraCupHeader;
            obj.Save(db, (this.ListForm as BraCupHeaderListForm).BindingSource);
        }
        ...
        private void actionLogNOButtonEdit_ButtonClick(object sender, DevExpress.XtraEditors.Controls.ButtonPressedEventArgs e)
        {
            FabricInspectionDataContext db = this.DataContext as FabricInspectionDataContext;
            BraCupHeader obj = this.BindingSource.Current as BraCupHeader;
            BraCupHeaderListForm HeaderListForm = this.ListForm as BraCupHeaderListForm;
            ...
            AlertLogForm frmAlertLog = new AlertLogForm(ActionLogProcessModes.BraCup, db, MissingAudit, obj.ActionLogID, (this.ListForm as BraCupHeaderListForm), Suppliers, Projects, Batchs, obj.AuditStage);
