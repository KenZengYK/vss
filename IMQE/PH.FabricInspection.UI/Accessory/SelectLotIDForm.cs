...
namespace PH.FabricInspection.UI.Accessory
{
    public partial class SelectLotIDForm : DevExpress.XtraEditors.XtraForm
    {
        ...
        void PrepareData(string AAuditStage, string ACompany, DateTime AIDCreateDate, string AItemCode, string AColorCode)
        {
            ...
            List<AccessorySelectLotIDResult> lists = dt.AsEnumerable().Select(dr => new AccessorySelectLotIDResult
            {
        ...
        public List<AccessorySelectLotIDResult> GetSelectData()
        {
            List<AccessorySelectLotIDResult> SelectLists = new List<AccessorySelectLotIDResult>();
            for (int i = 0; i < this.gridView.RowCount; i++)
            {
                AccessorySelectLotIDResult obj = this.gridView.GetRow(i) as AccessorySelectLotIDResult;
        ...
        public List<AccessorySelectLotIDResult> GetAllData()
        {
            return this.bindingSource.DataSource as List<AccessorySelectLotIDResult>;
        }
    ...
    public class AccessorySelectLotIDResult : BaseEntity
    {
