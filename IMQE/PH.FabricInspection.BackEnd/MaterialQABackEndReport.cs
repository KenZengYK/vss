...
namespace PH.FabricInspection.BackEnd
{
    ...
    public class MaterialQABackEndReport : PH.Platform.BackEnd.BO.IServerReport
    {
        ...
        private List<MaterialQA> mmm = null;
        ...
        public XtraReport CreateReport(string parameters)
        {
            ...
            mmm = (List<MaterialQA>)GetReportData();
            MaterialQAReport rpt = new MaterialQAReport(mmm, period);
    ...
    //+ GetSortedColumnNames();
        ...
        //        {
        //            int iSortOrder = (int)hsSortedColumns[column.FieldName];
        //            column.SortOrder = (DevExpress.Data.ColumnSortOrder)iSortOrder;
        //        }
