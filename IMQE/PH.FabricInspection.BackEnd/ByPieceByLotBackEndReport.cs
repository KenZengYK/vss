...
//    public class ByPieceByLotBackEndReport : PH.Platform.BackEnd.BO.IServerReport
//    {
...
//            {
//                rpt.LoadLayout(strAppPath + "informationByPieceBackEnd.repx");

//            }
//            else if (strReportType.Equals("ByLot"))
//            {
//                rpt.LoadLayout(strAppPath + "informationBylotBackEnd.repx");
//            }
...
//            //List<Fabric_Insp_Header> fabricInspectionDataSource = fabric_Insp_HeaderList.GetFabric_Insp_HeaderList();
//            List<Fabric_Insp_Header> fabricInspectionDataSource = fabric_Insp_HeaderList.GetFabric_Insp_HeaderList().ToList<Fabric_Insp_Header>();
...
//                    //return ByPieceByLotReportUtil.getDataByPiece(strVersionNo, fabricInspectionDataSource);
//                }
//                else if (strReportType.Equals("ByLot"))
//                {
...
//                    //return (List<MaterialByLot>)ByPieceByLotReportUtil.getDataByLot(strVersionNo, fabricInspectionDataSource);
//                }
//            }
