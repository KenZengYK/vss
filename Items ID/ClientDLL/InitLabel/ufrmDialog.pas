...
begin
  ...
  try
    ...
    begin
      Close;
      SQL.Clear;
      //      SQL.Add('select distinct ch1t84 as pakl64 from ault4f1.app84 ');
      //      SQL.Add('where Upper(cono84)=' + QuotedStr(ACONO) + ' and ch1t84<>'''' ');
      SQL.Add('select distinct pakl64 from ault4f1.qtp64 ');
      SQL.Add('where cono64=' + QuotedStr(ACONO) + ' and pakl64<>'''' ');
      Open;
