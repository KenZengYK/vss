...
uses
  ...
  cxCheckBox, cxBlobEdit, cxRadioGroup;
...
begin
  ...
  begin
    ...
    begin
      ...
      CommandText := ' Insert into  IDO1' + fSuffixTable + '(cono,bh,rq,sj,site,jlr,ydc,ReserveMaterial,IsDO,IsSC,IsUPI) values(:cono,:bh,:rq,:sj,:site,:jlr,:ydc,:reserveMaterial,:IsDO,:IsSC,:IsUPI)';
