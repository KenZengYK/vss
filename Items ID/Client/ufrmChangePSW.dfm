object frmChangePSW: TfrmChangePSW
  Left = 238
  Top = 187
  Width = 310
  Height = 211
  ...
  object editOldPsw: TcxTextEdit
    Left = 142
    Top = 18
    Properties.CharCase = ecUpperCase
    Properties.EchoMode = eemPassword
    TabOrder = 0
    OnKeyDown = editOldPswKeyDown
    Width = 131
  end
  object editNewPsw: TcxTextEdit
    Left = 142
    Top = 50
    Properties.CharCase = ecUpperCase
    Properties.EchoMode = eemPassword
    TabOrder = 1
    OnKeyDown = editNewPswKeyDown
    Width = 131
  end
  object editConfirmNewPsw: TcxTextEdit
    Left = 142
    Top = 82
    Properties.CharCase = ecUpperCase
    Properties.EchoMode = eemPassword
    TabOrder = 2
    OnKeyDown = editConfirmNewPswKeyDown
    Width = 131
  end
