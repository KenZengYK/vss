...
begin
  ...
  if frmido.dbedit10.text<>'' then begin
    ...
    with query1 do begin
      ...
      sql.add('substr(dref71,8,4)=substr('+chr(39)+'000'+chr(39)+'||cast(opsq42 as varchar(4)),length('+chr(39)+'000'+chr(39)+'||cast(opsq42 as varchar(4)))-3,4) ');
      sql.add('and a.cono40=b.cono40 and substr(a.w1rf40,1,7)=b.ordn40 and cono42=:cono42 and word42=:word42 and b.cuso40=:cuso40 and b.dtlc40=0 ');
      sql.add('group by a.w1rf40,odsc41,word42,opsq42,comp42,wuom42,aqty71,sref71 order by worder,oper,code');
      prepare;
      params[0].asstring:=uppercase(frmido.edit2.text);
