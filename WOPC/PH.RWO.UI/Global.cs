...
namespace PH.RWO.UI
{
    ...
    public class Global
    {
        ...
        public static PH.RWO.BO.RoundWorkOrder RwoClone(PH.RWO.BO.RoundWorkOrder r)
        {
            ...
            rwo.Version = 0;
            rwo.WOVersion = r.WorkOrderColor.WorkOrder.Version;
            return rwo;
        }
        ...
        {
            RoundWorkOrderDetail details = rwo.RoundWorkOrderDetails[index];
            ...
            {
                RoundWorkOrderDetailTemp1 t = temp["temp" + i.ToString()].Where(p => p.Cup == details.Cup && p.Size == details.Size).FirstOrDefault();
                if (t != null)
                {
            ...
            qty = (int)(bulkqty - bulkqty1);
            sqty = (int)(sampleqty - sampleqty1);
        }
        ...
        public static void PrintWorkNoteReport(PH.SPC.BO.StyleSortEdition edition)
        {
