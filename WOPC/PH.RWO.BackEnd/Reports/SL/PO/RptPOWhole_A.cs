...
{
    public partial class RptPOWhole_A : DevExpress.XtraReports.UI.XtraReport
    {
        public bool IsPH;
        ...
        private void RptPOWhole_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
              ...
              //else
              //{
              //    RptPOFooter_Domestic rptdomes = new RptPOFooter_Domestic();
              //    rptdomes.Header = _header; rptdomes.HedarConfirmDT = _headerconfdt;
              //    rptdomes.Toper = _toper; rptdomes.ToperConfirmDT = _topconfdt;
              //    this.xrSubFooter.ReportSource = rptdomes;
