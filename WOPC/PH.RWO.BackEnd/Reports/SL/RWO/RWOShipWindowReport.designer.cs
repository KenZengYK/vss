namespace PH.RWO.BackEnd
{
    partial class RWOShipWindowReport
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.xrTableCell109.Text = "RWO\'s Time Elements / 輪制單之時間元素 ";
            ...
            this.xrTableCell114.Text = "WO\'s Time Elements / 制單之時間元素";
            ...
            this.xrTableCell100.Text = "Ship window is appliable / 適用於航班窗框\r\nShpt is based on LCL / 船運以散貨為基礎";
            ...
            this.xrTableCell105.Text = "Ship window is appliable / 適用於航班窗框\r\nShpt is based on LCL / 船運以散貨為基礎";
            ...
            new DevExpress.XtraReports.UI.XRBinding("Text", null, "LineWorkStartDate_SpecialFactory", "{0:yyyy/MM/dd}")});
            ...
            this.xrTableCell47.Text = "[WorkOrderColor.WorkOrder.FCLShipExFtyDateStr]";
            ...
            this.xrTableCell123.Text = "SW window [SW start (Start ship) vs T3 \r\n(Ship complete)]\r\n縫合窗框 [縫合開始日期 (首航期) vs " +
                "T3日期 (尾航期)]";
            // 
            // xrTableCell124
            // 
            ...
            this.xrTableCell125.Text = "[WorkOrderColor.WorkOrder.LWShipWindow] days/天\r\n(incl. [WorkOrderColor.WorkOrder." +
                "LWShipWindow_NonWorkingdays] non-working days)";
            ...
            this.xrTableCell1.Text = "aT3 day(s) (Adjusted T3 minus default T3)\r\naT3天數 (修正T3 減 預設T3)";
            // 
            // xrTableCell2
            // 
            ...
            this.xrTableCell5.Text = "aT3 day(s) (Adjusted T3 minus default T3)\r\nT3 天數 (修正T3 減 預設T3)";
            // 
            // xrTableCell6
            // 
            ...
            this.xrTableCell7.Text = "[WorkOrderColor.WorkOrder.T3Window] days/天\r\n(incl. [WorkOrderColor.WorkOrder.T3Wi" +
                "ndow_NonWorkingdays] non-working days)";
