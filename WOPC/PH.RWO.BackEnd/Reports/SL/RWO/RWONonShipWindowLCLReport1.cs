...
{
    public partial class RWONonShipWindowLCLReport1 : DevExpress.XtraReports.UI.XtraReport
    {
        public RWONonShipWindowLCLReport1()
        {
            InitializeComponent();
        }
        string _customer;
        ...
        //public RWONonShipWindowLCLReport1(object dataSource, string customer)
        public RWONonShipWindowLCLReport1(WorkOrder AWorkOrder, string customer)
        {
            InitializeComponent();

            _customer = customer;
            _WorkOrder = AWorkOrder;
            this.bindingSource1.DataSource = _WorkOrder;
