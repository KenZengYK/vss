...
namespace PH.RWO.BackEnd.KB
{
    public partial class AgreedRWOShipWindowReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            this.cellOpt12.Text = string.Format("{0}", rwo.Opt2vs1);
            ...
            this.cellCU.Text = string.Format("{0:N2} %", rwo.CU );
            ...
            this.cellCTdays.Text = string.Format("{0} days/วัน", rwo.FWvsLW_CalendarDay);
