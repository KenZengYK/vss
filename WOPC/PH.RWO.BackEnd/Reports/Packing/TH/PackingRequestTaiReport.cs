...
{
    public partial class PackingRequestTaiReport : DevExpress.XtraReports.UI.XtraReport
    {
        public PackingRequestTaiReport()
        {
            InitializeComponent();
        }
        ...
        public PackingRequestTaiReport(string company, string salesOrderNo, string workOrderNo, string productcategory)
            : this()
        {
        ...
        private XRTableRow RowCaption(System.Data.DataTable dt)
        {
        ...
        private XRTableRow GetNewRow(System.Data.DataTable dt, DataRow datarow)
        {
            XRTableRow row = new XRTableRow();
            for (int i = 0; i < dt.Columns.Count; i++)
            {
