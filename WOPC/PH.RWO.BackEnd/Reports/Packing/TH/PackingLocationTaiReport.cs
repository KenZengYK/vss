...
{
    public partial class PackingLocationTaiReport : DevExpress.XtraReports.UI.XtraReport
    {
        public PackingLocationTaiReport()
        {
            InitializeComponent();
        }
        ...
        public PackingLocationTaiReport(string company, string salesOrderNo, string workOrderNo, string productcategory)
            : this()
        {
