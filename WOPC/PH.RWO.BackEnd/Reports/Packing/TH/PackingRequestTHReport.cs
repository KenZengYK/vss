...
{
    public partial class PackingRequestTHReport : DevExpress.XtraReports.UI.XtraReport
    {
        public PackingRequestTHReport()
        {
            InitializeComponent();
        }
        ...
        public PackingRequestTHReport(string company, string salesOrderNo, string workOrderNo, string productcategory)
            : this()
        {
