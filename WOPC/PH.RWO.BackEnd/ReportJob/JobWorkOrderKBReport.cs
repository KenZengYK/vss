...
{
    public class JobWorkOrderKBReport : PH.Platform.BackEnd.BO.IServerReport
    {
        public JobWorkOrderKBReport()
        {
        ...
        public DevExpress.XtraReports.UI.XtraReport CreateReport(string parameters)
        {
            ...
            KB.WOReport report = new KB.WOReport(parms);
        ...
        void report_AfterPrint(object sender, EventArgs e)
        {
            ...
            KB.WOStyleMakingReport report = new KB.WOStyleMakingReport(parms);
