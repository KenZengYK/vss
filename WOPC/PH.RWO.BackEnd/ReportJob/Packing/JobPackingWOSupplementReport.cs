...
{
    public partial class JobPackingWOSupplementReport : UserControl, PH.Platform.BackEnd.BO.IServerReport, PH.Platform.BackEnd.BO.IParameterSetControl
    {

        public JobPackingWOSupplementReport()
        {
            InitializeComponent();
        ...
        public DevExpress.XtraReports.UI.XtraReport CreateReport(string parameters)
        {
            ...
            PH.RWO.BackEnd.Reports.Packing.PackingWOSupplementReport report = new PH.RWO.BackEnd.Reports.Packing.PackingWOSupplementReport();
        ...
        {
            JobPackingWOSupplementReport ctl = new JobPackingWOSupplementReport();
