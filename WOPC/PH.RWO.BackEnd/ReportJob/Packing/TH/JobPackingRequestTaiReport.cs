...
{
    public partial class JobPackingRequestTaiReport : UserControl, PH.Platform.BackEnd.BO.IServerReport, PH.Platform.BackEnd.BO.IParameterSetControl
    {

        public JobPackingRequestTaiReport()
        {
            InitializeComponent();
        ...
        public DevExpress.XtraReports.UI.XtraReport CreateReport(string parameters)
        {
            ...
            PH.RWO.BackEnd.Reports.TH.PackingRequestTHReport report = new PH.RWO.BackEnd.Reports.TH.PackingRequestTHReport(this._company, this._salesOrderNo, this._workOrderNo, this._Skind);
        ...
        {
            JobPackingRequestTaiReport ctl = new JobPackingRequestTaiReport();
