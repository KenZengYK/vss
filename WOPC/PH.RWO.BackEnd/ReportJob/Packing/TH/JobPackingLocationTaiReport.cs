...
{
    public partial class JobPackingLocationTaiReport : UserControl, PH.Platform.BackEnd.BO.IServerReport, PH.Platform.BackEnd.BO.IParameterSetControl
    {

        public JobPackingLocationTaiReport()
        {
            InitializeComponent();
        ...
        public DevExpress.XtraReports.UI.XtraReport CreateReport(string parameters)
        {
            ...
            GetValues(parameters);
             ...
             PH.RWO.BackEnd.Reports.TH.PackingLocationTaiReport report = new PH.RWO.BackEnd.Reports.TH.PackingLocationTaiReport(this._company, this._salesOrderNo, this._workOrderNo, this._productcategory);
        ...
        {
            JobPackingLocationTaiReport ctl = new JobPackingLocationTaiReport();
