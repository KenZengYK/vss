...
uses
  ...
  Dialogs, StdCtrls, Buttons, DB, DBClient, DateUtils, ADODB, Menus;
...
type
  Tfrmnewcap = class(TForm)
    ...
    BitBtn23: TBitBtn;
    pm1: TPopupMenu;
    WOlistwithoutSAH1: TMenuItem;
    CustStyleswithSAHQty1: TMenuItem;
    ...
    procedure WOlistwithoutSAH1Click(Sender: TObject);
    procedure CustStyleswithSAHQty1Click(Sender: TObject);
  private
...
uses mainformu, oaprojectionformu, ftydefaultformu, newcap_comformu,
  ...
  newcap_fcbalformu, newcap_cpsettingsformu, newcap_budgetformu,
  CP_ActionlogFormu, cap_wowithoutsahformu, Cap_SAHEnqueryFormu;
...
procedure Tfrmnewcap.WOlistwithoutSAH1Click(Sender: TObject);
begin
  if frmcap_wowithoutsah=nil then frmcap_wowithoutsah:=tfrmcap_wowithoutsah.create(nil);
  frmcap_wowithoutsah.show;
end;
...
procedure Tfrmnewcap.CustStyleswithSAHQty1Click(Sender: TObject);
begin
  if frmCAP_SAHEnquery=nil then frmCAP_SAHEnquery:=tfrmCAP_SAHEnquery.create(nil);
  frmCAP_SAHEnquery.windowstate:=wsMaximized;
  frmCAP_SAHEnquery.show;
end;
