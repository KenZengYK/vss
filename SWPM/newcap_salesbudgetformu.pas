...
begin
  ...
  if not query1.fieldbyname('s01').isnull then
  str1:=str1+'s01='+query1.fieldbyname('s01').asstring+','
  else str1:=str1+'s01=0,';
  if not query1.fieldbyname('s02').isnull then
  str1:=str1+'s02='+query1.fieldbyname('s02').asstring+','
  else str1:=str1+'s02=0,';
  if not query1.fieldbyname('s03').isnull then
  str1:=str1+'s03='+query1.fieldbyname('s03').asstring+','
  else str1:=str1+'s03=0,';
  if not query1.fieldbyname('s04').isnull then
  str1:=str1+'s04='+query1.fieldbyname('s04').asstring+','
  else str1:=str1+'s04=0,';
  if not query1.fieldbyname('s05').isnull then
  str1:=str1+'s05='+query1.fieldbyname('s05').asstring+','
  else str1:=str1+'s05=0,';
  if not query1.fieldbyname('s06').isnull then
  str1:=str1+'s06='+query1.fieldbyname('s06').asstring+','
  else str1:=str1+'s06=0,';
  if not query1.fieldbyname('s07').isnull then
  str1:=str1+'s07='+query1.fieldbyname('s07').asstring+','
  else str1:=str1+'s07=0,';
  if not query1.fieldbyname('s08').isnull then
  str1:=str1+'s08='+query1.fieldbyname('s08').asstring+','
  else str1:=str1+'s08=0,';
  if not query1.fieldbyname('s09').isnull then
  str1:=str1+'s09='+query1.fieldbyname('s09').asstring+','
  else str1:=str1+'s09=0,';
  if not query1.fieldbyname('s10').isnull then
  str1:=str1+'s10='+query1.fieldbyname('s10').asstring+','
  else str1:=str1+'s10=0,';
  if not query1.fieldbyname('s11').isnull then
  str1:=str1+'s11='+query1.fieldbyname('s11').asstring+','
  else str1:=str1+'s11=0,';
  if not query1.fieldbyname('s12').isnull then
  str1:=str1+'s12='+query1.fieldbyname('s12').asstring+','
  else str1:=str1+'s12=0,';
