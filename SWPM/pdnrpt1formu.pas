...
uses
  ...
  Dialogs, ppCtrls, ppBands, ppClass, myChkBox, ppVar, ppPrnabl, ppCache,
  ppProd, ppReport, ppDB, ppComm, ppRelatv, ppDBPipe, DB, DBClient, ppViewr,
  ppStrtch, ppSubRpt, ppMemo, ppParameter;

type
  Tfrmpdnrpt1 = class(TForm)
...
procedure Tfrmpdnrpt1.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppReport1.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport1.PreviewForm.Viewer).ZoomPercentage:=100;
end;

procedure Tfrmpdnrpt1.ppGroupHeaderBand4BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppDetailBand1BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppGroupFooterBand4BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppDetailBand3BeforePrint(Sender: TObject);
var
...
procedure Tfrmpdnrpt1.ppSummaryBand3BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
...
procedure Tfrmpdnrpt1.ppGroupHeaderBand3BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
...
procedure Tfrmpdnrpt1.ppGroupHeaderBand5BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppGroupHeaderBand6BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppGroupHeaderBand7BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppGroupHeaderBand8BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppGroupHeaderBand9BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppGroupFooterBand5BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppGroupFooterBand6BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppGroupFooterBand7BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppGroupFooterBand8BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppGroupFooterBand9BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt1.ppTitleBand1BeforePrint(Sender: TObject);
begin
  //
end;

procedure Tfrmpdnrpt1.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  title002.caption:=title001.caption;
  fty002.Caption:=fty001.Caption;
  pdn002.Caption:=pdn001.Caption;
  exfty003.Caption:=exfty001.Caption;
  exfty004.Caption:=exfty002.Caption;
  week02.Caption:=week01.Caption;
end;

procedure Tfrmpdnrpt1.ppSummaryBand2BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
