...
procedure Tfrmpdnactd2.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppReport1.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport1.PreviewForm.Viewer).ZoomPercentage:=100;
end;

procedure Tfrmpdnactd2.ppDetailBand1BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnactd2.ppGroupFooterBand2BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnactd2.ppTitleBand1BeforePrint(Sender: TObject);
begin
  srwo01.Caption:=rwo001.Caption;
...
procedure Tfrmpdnactd2.ppDetailBand3BeforePrint(Sender: TObject);
begin
  if srwo01.Caption>'' then begin
...
procedure Tfrmpdnactd2.ppSummaryBand3BeforePrint(Sender: TObject);
begin
  ...
  else if sb107.Value=sb108.Value then sb108.Font.Color:=clBlack else sb108.Font.Color:=clGreen;
{
  ...
  if sbq01.Value>0 then begin
    if sbd01.Value*100.0/sbq01.Value>=-1.0 then grade001.Caption:='Grade: A'
    else if sbd01.Value*100.0/sbq01.Value>=-2.0 then grade001.Caption:='Grade: B'
    else if sbd01.Value*100.0/sbq01.Value>=-3.0 then grade001.Caption:='Grade: C'
    else if sbd01.Value*100.0/sbq01.Value>=-4.0 then grade001.Caption:='Grade: D'
    else if sbd01.Value*100.0/sbq01.Value>=-5.0 then grade001.Caption:='Grade: F'
    else if sbd01.Value*100.0/sbq01.Value<-5.0 then grade001.Caption:='Grade: U';
  end;
...
procedure Tfrmpdnactd2.ppGroupHeaderBand3BeforePrint(Sender: TObject);
begin
  ...
  with query2 do begin
    ...
    commandtext:='select * from tbl_pdn_r_tmp1 where seq=:x1 and tm=:x2 and j_no='''+query1.fieldbyname('j_no').value+''' and j2_job='''+query1.fieldbyname('j2_job').value+''' and acol='''+query1.fieldbyname('acol').value+'''';
...
procedure Tfrmpdnactd2.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  ...
  grade003.Caption:=grade002.Caption;
  acted002.Caption:=acted001.Caption;
end;

procedure Tfrmpdnactd2.ppSummaryBand2BeforePrint(Sender: TObject);
begin
