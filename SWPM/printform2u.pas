...
uses
  ...
  ppComm, ppRelatv, ppDB, ppDBPipe, ppDBBDE, ppViewr, ppParameter;
...
implementation
uses printschedule1u;

{$R *.DFM}

procedure Tfrmprint2.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppreport1.previewform.windowstate:=wsmaximized;
  tppviewer(ppreport1.previewform.viewer).ZoomPercentage:=100;
end;

procedure Tfrmprint2.ppSummaryBand1BeforePrint(Sender: TObject);
begin
  {
