unit newcap_sumformu;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, ppRichTx, ppBands, ppClass, ppReport, ppStrtch, ppSubRpt,
  ppCtrls, ppVar, ppPrnabl, ppCache, ppProd, ppComm, ppRelatv, ppDB,
  ppDBPipe, DB, DBClient, ppViewr, ppParameter;

type
  Tfrmnewcap_sum = class(TForm)
...
procedure Tfrmnewcap_sum.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppReport1.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport1.PreviewForm.Viewer).ZoomPercentage:=100;
end;

procedure Tfrmnewcap_sum.ppDetailBand3BeforePrint(Sender: TObject);
begin
      ...
      if (query4.fieldbyname('seq').value=fieldbyname('seq').value) or (query4.fieldbyname('seq').value=fieldbyname('seq1').value) then begin
        ...
        spt02.Visible:=false;
          ...
          if query4.fieldbyname('seq').value>=17 then begin
            ...
            ax005.DisplayFormat:='n.a.'; ax010.DisplayFormat:='n.a.'; ax015.DisplayFormat:='n.a.';
            ...
            ax005.DisplayFormat:='0.00'; ax010.DisplayFormat:='0.00'; ax015.DisplayFormat:='0.00';
...
procedure Tfrmnewcap_sum.ppGroupFooterBand13BeforePrint(Sender: TObject);
var
  dt:tdate;
begin
...
procedure Tfrmnewcap_sum.ppGroupFooterBand17BeforePrint(Sender: TObject);
begin
