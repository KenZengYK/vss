object frmwf_off: Tfrmwf_off
  Left = 192
  Top = 114
  Width = 772
  Height = 534
  Caption = 'Mobile Workforce - on-standard (Shortage / GSD gap)'
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'FS'
        Footers = <>
        Title.Caption = 'Fill SWF Shortage'
        Width = 100
      end
      item
        EditButtons = <>
  ...
  object Query1: TClientDataSet
    Aggregates = <>
    CommandText = 'select * from line_wf_off'
    Params = <>
