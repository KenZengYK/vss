...
begin
    ...
    frmnewcap_1stchoice.Caption:='Setup adjustment';
...
begin
    ...
    frmnewcap_1stchoice.BitBtn7.visible:=false;
    frmnewcap_1stchoice.BitBtn8.visible:=false;
...
begin
    decodedate(date,y,m,d);
    if frmnewcap_1stchoice=nil then frmnewcap_1stchoice:=tfrmnewcap_1stchoice.Create(nil);
    frmnewcap_1stchoice.Caption:='Setup confirmation';
    frmnewcap_1stchoice.combobox3.text:='SL';
    frmnewcap_1stchoice.spinedit2.value:=y;
    frmnewcap_1stchoice.BitBtn1.visible:=true;
    frmnewcap_1stchoice.BitBtn4.visible:=true;
...
procedure Tfrmnewcap_fcbal.BitBtn9Click(Sender: TObject);
begin
  Close;
end;
