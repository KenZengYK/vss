    ...
    with query1 do begin
      ...
      while not eof do begin
        if fieldbyname('ws').value='3A' then begin
          ...
          if f2>f1 then begin
            x00001.Caption:='¡ô  '+formatfloat('0.00',f2-f1);
            x00001.Font.Color:=clGreen;
          end else if f2<f1 then begin
            x00001.Caption:='¡õ  '+formatfloat('0.00',f1-f2);
          ...
          if f2>f1 then begin
            x00002.Caption:='¡ô  '+formatfloat('0.00',f2-f1);
            x00002.Font.Color:=clGreen;
          end else if f2<f1 then begin
            x00002.Caption:='¡õ  '+formatfloat('0.00',f1-f2);
          ...
          if f2>f1 then begin
            x00003.Caption:='¡ô  '+formatfloat('0.00',f2-f1);
            x00003.Font.Color:=clGreen;
          end else if f2<f1 then begin
            x00003.Caption:='¡õ  '+formatfloat('0.00',f1-f2);
          ...
          if f2>f1 then begin
            x00004.Caption:='¡ô  '+formatfloat('0.00',f2-f1);
            x00004.Font.Color:=clGreen;
          end else if f2<f1 then begin
            x00004.Caption:='¡õ  '+formatfloat('0.00',f1-f2);
          ...
          if f2>f1 then begin
            x00005.Caption:='¡ô  '+formatfloat('0.00',f2-f1);
            x00005.Font.Color:=clGreen;
          end else if f2<f1 then begin
            x00005.Caption:='¡õ  '+formatfloat('0.00',f1-f2);
          ...
          if f2>f1 then begin
            x00006.Caption:='¡ô  '+formatfloat('0.00',f2-f1);
            x00006.Font.Color:=clGreen;
          end else if f2<f1 then begin
            x00006.Caption:='¡õ  '+formatfloat('0.00',f1-f2);
          ...
          if f2>f1 then begin
            x00007.Caption:='¡ô  '+formatfloat('0.00',f2-f1);
            x00007.Font.Color:=clGreen;
          end else if f2<f1 then begin
            x00007.Caption:='¡õ  '+formatfloat('0.00',f1-f2);
          ...
          if f2>f1 then begin
            x00008.Caption:='¡ô  '+formatfloat('0.00',f2-f1);
            x00008.Font.Color:=clGreen;
          end else if f2<f1 then begin
            x00008.Caption:='¡õ  '+formatfloat('0.00',f1-f2);
          ...
          if f2>f1 then begin
            x00009.Caption:='¡ô  '+formatfloat('0.00',f2-f1);
            x00009.Font.Color:=clGreen;
          end else if f2<f1 then begin
            x00009.Caption:='¡õ  '+formatfloat('0.00',f1-f2);
          ...
          if f2>f1 then begin
            x00010.Caption:='¡ô  '+formatfloat('0.00',f2-f1);
            x00010.Font.Color:=clGreen;
          end else if f2<f1 then begin
            x00010.Caption:='¡õ  '+formatfloat('0.00',f1-f2);
