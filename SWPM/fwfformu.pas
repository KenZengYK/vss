...
uses
  ...
  Dialogs, StdCtrls, Buttons, Mask, rxToolEdit, myChkBox, ppCtrls, ppBands,
  ppClass, ppStrtch, ppMemo, ppVar, ppPrnabl, ppCache, ppProd, ppReport,
  ppComm, ppRelatv, ppDB, ppDBPipe, DB, DBClient, ppViewr, Spin,
  ppParameter;
...
procedure Tfrmfwf.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action:=cafree;
  frmfwf:=nil;
end;

procedure Tfrmfwf.ppGroupFooterBand1BeforePrint(Sender: TObject);
var
...
procedure Tfrmfwf.ppGroupFooterBand2BeforePrint(Sender: TObject);
var
  f01,f02,f03,f04,f05,f06,f07,f08,f09,f10,p1,p2,p3:double;
  s1,s2,s3,s4:string;
  lt1,p4:double;
...
procedure Tfrmfwf.BitBtn1Click(Sender: TObject);
begin
...
procedure Tfrmfwf.ppReport1PreviewFormCreate(Sender: TObject);
begin
