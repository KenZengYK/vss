...
procedure Tfrmganotepad.FormClose(Sender: TObject;
...
procedure Tfrmganotepad.FormShow(Sender: TObject);
begin
...
procedure Tfrmganotepad.BitBtn1Click(Sender: TObject);
var
  s1:string;
begin
  with query1 do begin
  ...
  if y01.Checked then s1:=s1+'~效率'+y01.Caption;
  if y02.Checked then s1:=s1+'~效率'+y02.Caption;
...
procedure Tfrmganotepad.y01Click(Sender: TObject);
begin
