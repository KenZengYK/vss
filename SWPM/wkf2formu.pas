...
procedure Tfrmwkf2.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppReport1.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport1.PreviewForm.Viewer).ZoomPercentage:=100;
end;

procedure Tfrmwkf2.ppDetailBand1BeforePrint(Sender: TObject);
begin
  ...
  cwfttl01.Caption:=formatfloat('0',frmwkf.query1.fieldbyname('cwfttl').value+frmwkf.Query1.fieldbyname('bwfa').value);
...
procedure Tfrmwkf2.ppSummaryBand1BeforePrint(Sender: TObject);
var
