...
procedure Tfrmtransit4_1.BitBtn1Click(Sender: TObject);
var
  dt:tdate;
begin
  ...
  if lblcs.Caption='The fifteenth time' then begin
    with query2 do begin
      ...
      commandtext:='select max(idt14) as dt from tbl_lwo where pline=:x1 and seq=:x2';
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq14');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt13) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq13');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt12) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq12');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt11) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq11');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt10) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq10');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt9) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq9');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt8) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq8');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt7) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq7');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt6) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq6');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt5) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq5');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt4) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq4');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt3) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq3');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt2) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq2');
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq1');
    lblcs.Caption:='The first time';
    bitbtn1.Enabled:=false;
  end;
end;

procedure Tfrmtransit4_1.BitBtn2Click(Sender: TObject);
var
  dt:tdate;
begin
  ...
  if lblcs.Caption='The first time' then begin
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(idt15) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('iq15');
    lblcs.Caption:='The fifteenth time';
    BitBtn2.Enabled:=false;
  end;
end;

procedure Tfrmtransit4_1.BitBtn3Click(Sender: TObject);
var
  s1:string;
  pstr:string;
  str1:string;
begin
  ...
  with query2 do begin
    ...
    commandtext:='update tbl_lwo set idt'+s1+'=:x1 where pline=:x2 and seq=:x3';
  ...
  str1:='update tbl_lwo set idt'+s1+'='''+formatdatetime('yyyy-MM-dd',dateedit1.Date)+''' where pline='''+frmlwo.Query1.fieldbyname('pline').value+''' and seq='+frmlwo.Query1.fieldbyname('seq').asstring;
  if frmmain.PHService.UpdateLWPM(str1)=0 then showmessage('Can not save!');

  label8.Caption:='Save';
  {
    pstr:='12 G '+frmlwo.query1.fieldbyname('pline').value+' '+frmlwo.query1.fieldbyname('seq').asstring+' '+s1+' '+dateedit1.text;
...
procedure Tfrmtransit4_1.DBGridEh1KeyPress(Sender: TObject; var Key: Char);
var
  r23:boolean;
begin
  with query2 do begin
...
procedure Tfrmtransit4_1.FormClose(Sender: TObject;
...
procedure Tfrmtransit4_1.FormShow(Sender: TObject);
var
...
begin
{
  ...
  with query2 do begin
    ...
    dbgrideh1.Columns[3].Footers[1].Value:=i6;
    dbgrideh1.Columns[4].Footers[1].Value:=i7;
  end;
end;
