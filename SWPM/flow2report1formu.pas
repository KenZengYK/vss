...
var
  frmflow2report1: Tfrmflow2report1;
...
procedure Tfrmflow2report1.ppReport2PreviewFormCreate(Sender: TObject);
begin
  ppReport2.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport2.PreviewForm.Viewer).ZoomPercentage:=100;
end;

procedure Tfrmflow2report1.ppHeaderBand2BeforePrint(Sender: TObject);
var
  i:integer;
begin
  seq01.caption:='';seq02.caption:='';seq03.caption:='';seq04.caption:='';seq05.caption:='';seq06.caption:='';
  seq0101.Caption:='';seq0102.Caption:='';seq0103.caption:='';seq0201.Caption:='';seq0202.Caption:='';seq0203.caption:='';
  seq0301.Caption:='';seq0302.Caption:='';seq0303.caption:='';seq0401.Caption:='';seq0402.Caption:='';seq0403.caption:='';
  seq0501.Caption:='';seq0502.Caption:='';seq0503.caption:='';seq0601.Caption:='';seq0602.Caption:='';seq0603.caption:='';
  ...
  y011.Visible:=false;y012.Visible:=false;
  i:=0;
  with query3 do begin
    ...
    if not fieldbyname('dt01').isnull then begin
      ...
      with query4 do begin
        ...
        commandtext:='select * from SP_CALC_TRANS_SEQ_2AQL(:x1,:x2,:x3,:x4)';
        params[0].asdatetime:=query7.fieldbyname('tm').value;
        ...
        if not fieldbyname('o_cnt0').isnull then seq0102.Caption:=fieldbyname('o_cnt0').asstring else seq0102.Caption:='0';
        if not fieldbyname('o_cnt1').isnull then seq0103.Caption:=fieldbyname('o_cnt1').asstring else seq0103.Caption:='0';
      end;
    end;
    if not fieldbyname('dt02').isnull then begin
      ...
      with query4 do begin
        ...
        if not fieldbyname('o_cnt0').isnull then seq0202.Caption:=fieldbyname('o_cnt0').asstring else seq0202.Caption:='0';
        if not fieldbyname('o_cnt1').isnull then seq0203.Caption:=fieldbyname('o_cnt1').asstring else seq0203.Caption:='0';
      end;
    end;
    if not fieldbyname('dt03').isnull then begin
      ...
      with query4 do begin
        ...
        if not fieldbyname('o_cnt0').isnull then seq0302.Caption:=fieldbyname('o_cnt0').asstring else seq0302.Caption:='0';
        if not fieldbyname('o_cnt1').isnull then seq0303.Caption:=fieldbyname('o_cnt1').asstring else seq0303.Caption:='0';
      end;
    end;
    if not fieldbyname('dt04').isnull then begin
      ...
      with query4 do begin
        ...
        if not fieldbyname('o_cnt0').isnull then seq0402.Caption:=fieldbyname('o_cnt0').asstring else seq0402.Caption:='0';
        if not fieldbyname('o_cnt1').isnull then seq0403.Caption:=fieldbyname('o_cnt1').asstring else seq0403.Caption:='0';
      end;
    end;
    if not fieldbyname('dt05').isnull then begin
      ...
      with query4 do begin
        ...
        if not fieldbyname('o_cnt0').isnull then seq0502.Caption:=fieldbyname('o_cnt0').asstring else seq0502.Caption:='0';
        if not fieldbyname('o_cnt1').isnull then seq0503.Caption:=fieldbyname('o_cnt1').asstring else seq0503.Caption:='0';
      end;
    end;
    if not fieldbyname('dt06').isnull then begin
      ...
      with query4 do begin
        ...
        if not fieldbyname('o_cnt0').isnull then seq0602.Caption:=fieldbyname('o_cnt0').asstring else seq0602.Caption:='0';
        if not fieldbyname('o_cnt1').isnull then seq0603.Caption:=fieldbyname('o_cnt1').asstring else seq0603.Caption:='0';
      end;
    end;
  end;
end;

procedure Tfrmflow2report1.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ...
  if dt01.Caption>'' then begin
    ...
    p02.Caption:=query7.fieldbyname('q01').value;
    t02.Caption:=query7.fieldbyname('ttq01').value;
    if query7.fieldbyname('tq01').value>0 then t01.Font.Style:=[fsBold]
    else t01.Font.Style:=[];
    if query7.fieldbyname('q01').value>0 then p02.Font.Style:=[fsBold]
    else p02.Font.Style:=[];
    if query7.fieldbyname('ttq01').value>0 then t02.Font.Style:=[fsBold]
    else t02.Font.Style:=[];
  end;
  if dt02.Caption>'' then begin
    p03.Caption:='0';
    t03.Caption:=query7.fieldbyname('tq02').value;
    p04.Caption:=query7.fieldbyname('q02').value;
    t04.Caption:=query7.fieldbyname('ttq02').value;
    if query7.fieldbyname('tq02').value>0 then t03.Font.Style:=[fsBold]
    else t03.Font.Style:=[];
    if query7.fieldbyname('q02').value>0 then p04.Font.Style:=[fsBold]
    else p04.Font.Style:=[];
    if query7.fieldbyname('ttq02').value>0 then t04.Font.Style:=[fsBold]
    else t04.Font.Style:=[];
  end;
  if dt03.Caption>'' then begin
    p05.Caption:='0';
    t05.Caption:=query7.fieldbyname('tq03').value;
    p06.Caption:=query7.fieldbyname('q03').value;
    t06.Caption:=query7.fieldbyname('ttq03').value;
    if query7.fieldbyname('tq03').value>0 then t05.Font.Style:=[fsBold]
    else t05.Font.Style:=[];
    if query7.fieldbyname('q03').value>0 then p06.Font.Style:=[fsBold]
    else p06.Font.Style:=[];
    if query7.fieldbyname('ttq03').value>0 then t06.Font.Style:=[fsBold]
    else t06.Font.Style:=[];
  end;
  if dt04.Caption>'' then begin
    p07.Caption:='0';
    t07.Caption:=query7.fieldbyname('tq04').value;
    p08.Caption:=query7.fieldbyname('q04').value;
    t08.Caption:=query7.fieldbyname('ttq04').value;
    if query7.fieldbyname('tq04').value>0 then t07.Font.Style:=[fsBold]
    else t07.Font.Style:=[];
    if query7.fieldbyname('q04').value>0 then p08.Font.Style:=[fsBold]
    else p08.Font.Style:=[];
    if query7.fieldbyname('ttq04').value>0 then t08.Font.Style:=[fsBold]
    else t08.Font.Style:=[];
  end;
  if dt05.Caption>'' then begin
    p09.Caption:='0';
    t09.Caption:=query7.fieldbyname('tq05').value;
    p10.Caption:=query7.fieldbyname('q05').value;
    t10.Caption:=query7.fieldbyname('ttq05').value;
    if query7.fieldbyname('tq05').value>0 then t09.Font.Style:=[fsBold]
    else t09.Font.Style:=[];
    if query7.fieldbyname('q05').value>0 then p10.Font.Style:=[fsBold]
    else p10.Font.Style:=[];
    if query7.fieldbyname('ttq05').value>0 then t10.Font.Style:=[fsBold]
    else t10.Font.Style:=[];
  end;
  if dt06.Caption>'' then begin
    p11.Caption:='0';
    t11.Caption:=query7.fieldbyname('tq06').value;
    p12.Caption:=query7.fieldbyname('q06').value;
    t12.Caption:=query7.fieldbyname('ttq06').value;
    if query7.fieldbyname('tq06').value>0 then t11.Font.Style:=[fsBold]
    else t11.Font.Style:=[];
    if query7.fieldbyname('q06').value>0 then p12.Font.Style:=[fsBold]
    else p12.Font.Style:=[];
    if query7.fieldbyname('ttq06').value>0 then t12.Font.Style:=[fsBold]
    else t12.Font.Style:=[];
  end;
end;

procedure Tfrmflow2report1.ppSummaryBand2BeforePrint(Sender: TObject);
var
...
begin
  with query3 do begin
    ...
    commandtext:='select sum(tq01) as q1,sum(tq02) as q2,sum(tq03) as q3,sum(tq04) as q4,sum(tq05) as q5,sum(tq06) as q6,'
                +'sum(ttq01) as q01,sum(ttq02) as q02,sum(ttq03) as q03,sum(ttq04) as q04,sum(ttq05) as q05,sum(ttq06) as q06,'
                +'sum(q01) as q001,sum(q02) as q002,sum(q03) as q003,sum(q04) as q004,sum(q05) as q005,sum(q06) as q006 '
                +'from tbl_trans_qty where pline=:x1 and seq=:x2 and tm=:x3 and typ=''2''';
    ...
    open;
    if dt01.Caption>'' then begin
      st01.Caption:=fieldbyname('q1').asstring;
      sp02.Caption:=fieldbyname('q001').asstring;
      st02.Caption:=fieldbyname('q01').AsString;
    end else begin
      sp01.Caption:='';st01.Caption:='';sp02.Caption:='';st02.Caption:='';
    end;
    if dt02.Caption>'' then begin
      st03.Caption:=fieldbyname('q2').asstring;
      sp04.Caption:=fieldbyname('q002').asstring;
      st04.Caption:=fieldbyname('q02').AsString;
    end else begin
      sp03.Caption:='';st03.Caption:='';sp04.Caption:='';st04.Caption:='';
    end;
    if dt03.Caption>'' then begin
      st05.Caption:=fieldbyname('q3').asstring;
      sp06.Caption:=fieldbyname('q003').asstring;
      st06.Caption:=fieldbyname('q03').AsString;
    end else begin
      sp05.Caption:='';st05.Caption:='';sp06.Caption:='';st06.Caption:='';
    end;
    if dt04.Caption>'' then begin
      st07.Caption:=fieldbyname('q4').asstring;
      sp08.Caption:=fieldbyname('q004').asstring;
      st08.Caption:=fieldbyname('q04').AsString;
    end else begin
      sp07.Caption:='';st07.Caption:='';sp08.Caption:='';st08.Caption:='';
    end;
    if dt05.Caption>'' then begin
      st09.Caption:=fieldbyname('q5').asstring;
      sp10.Caption:=fieldbyname('q005').asstring;
      st10.Caption:=fieldbyname('q05').AsString;
    end else begin
      sp09.Caption:='';st09.Caption:='';sp10.Caption:='';st10.Caption:='';
    end;
    if dt06.Caption>'' then begin
      st11.Caption:=fieldbyname('q6').asstring;
      sp12.Caption:=fieldbyname('q006').asstring;
      st12.Caption:=fieldbyname('q06').AsString;
    end else begin
      sp11.Caption:='';st11.Caption:='';sp12.Caption:='';st12.Caption:='';
    end;
  end;
  with query3 do begin
    close;
...
procedure Tfrmflow2report1.ppReport2BeforePrint(Sender: TObject);
var
