object frmnewcap_salesvalue: Tfrmnewcap_salesvalue
  Left = 0
  Top = 0
  ...
  object xh5: TRadioButton
    ...
    Width = 313
    Height = 17
    Caption = 'CP in Qty, Sales Value, Working Hrs && dWF Needed Report'
    Checked = True
    TabOrder = 4
    TabStop = True
    Visible = False
  ...
  object Query1: TClientDataSet
    Aggregates = <>
    CommandText = 'select * from tbl_cap_oa_valuesah order by qt,seq,seq1,grp'
    Params = <>
                ...
                object ppGroup7: TppGroup
                  ...
                  object ppGroupFooterBand7: TppGroupFooterBand
                    ...
                    object ppMemo1: TppMemo
                      ...
                      Lines.Strings = (
                        'Notepad:-'
                        '    1. dWF Needed* is the projected figure for reference only.'
                        '    2. Delivered (actual) figures captured after month-end.')
                      Transparent = True
                      mmHeight = 8731
                      mmLeft = 2910
                      mmTop = 3969
  ...
  object Query6: TClientDataSet
    Aggregates = <>
    CommandText = 'select * from tbl_cap_oa_valuesah3 order by qt,seq'
    Params = <>
    ProviderName = 'dspschedule'
    RemoteServer = frmmain.SocketConnection1
    Left = 128
