...
procedure Tfrmnewcap_custt3day.DBGridEh1Enter(Sender: TObject);
begin
  if query1.fieldbyname('lck').value=true then dbgrideh1.columns[2].readonly:=true
  else dbgrideh1.columns[2].readonly:=false;
end;
