object frmoutput_sect: Tfrmoutput_sect
  Left = 192
  Top = 114
  Caption = 'Total Output Vs Sect Hr'
  ClientHeight = 343
  ClientWidth = 369
  Color = clBtnFace
  ...
  object Query2: TClientDataSet
    Aggregates = <>
    CommandText = 'select * from analysis_tmp4 order by seq'
    Params = <>
