...
begin
  if frmtransitflow.Caption='Flow 1' then frmlwo.previewT1
  else if frmtransitflow.Caption='Flow 2' then frmlwo.previewT_2
  else if frmtransitflow.Caption='Flow 3' then frmlwo.previewT_3
  else if frmtransitflow.Caption='Flow 4' then frmlwo.previewT_4;
end;
...
begin
  ...
  if frmtransitflow.Caption='Transit Flow 1' then begin
    ...
    dbgrideh1.columns[57].Title.Caption:='Flow Diff|LWO Qty Picked';
