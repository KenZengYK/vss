...
procedure Tfrmmaintenance.BitBtn2Click(Sender: TObject);
begin
  if frmcompletedprojectlist=nil then frmcompletedprojectlist:=tfrmcompletedprojectlist.create(nil);
  frmcompletedprojectlist.windowstate:=wsMaximized;
  frmcompletedprojectlist.show;
end;
