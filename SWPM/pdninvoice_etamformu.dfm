object frmpdninvoice_etam: Tfrmpdninvoice_etam
  Left = 192
  Top = 114
  Caption = 'frmpdninvoice_etam'
  ClientHeight = 138
  ClientWidth = 339
  Color = clBtnFace
    ...
    object ppSummaryBand1: TppSummaryBand
      ...
      object ppMemo1: TppMemo
        ...
        Lines.Strings = (
            ...
            'The right to receive payment of this invoice has been assigned t' +
            'o DAH SING BANK LIMITED ('#8220'DSB'#8221'). '
          
            'Payment must be made to DSB to constitute a valid discharge of y' +
            'our indebtedness of this invoice. '
          
            'Please notify DSB immediately if any content of this invoice is ' +
            'found to be incorrect. '
          
            'Please settle the invoice by ways of chats transfer or remittanc' +
            'e to the following bank account.'
          #160
          'Account Name: P.H. Garment Manufacturing Co Ltd'
          'Bank Name: Dah Sing Bank, Limited'
          'Account Number: 040-774-71200544'
          'SWIFT Code: DSBAHKHH')
        Transparent = True
        mmHeight = 36513
        mmLeft = 3704
  ...
  object frxReport1: TfrxReport
    ...
    ReportOptions.CreateDate = 42941.466191342600000000
    ReportOptions.LastChange = 42941.466191342600000000
