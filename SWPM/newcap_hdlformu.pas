...
begin
  if frmnewcap_wf=nil then frmnewcap_wf:=tfrmnewcap_wf.create(nil);
  frmnewcap_wf.Caption:=bitbtn4.Caption;
...
procedure Tfrmnewcap_HDL.BitBtn5Click(Sender: TObject);
begin
  if frmnewcap_wf=nil then frmnewcap_wf:=tfrmnewcap_wf.create(nil);
  frmnewcap_wf.Caption:=bitbtn5.Caption;
  frmnewcap_wf.label4.Caption:='PP';
  with frmnewcap_wf.dbgrideh1 do begin
    columns[2].visible:=false;
    columns[8].Visible:=false;
    columns[14].visible:=false;
