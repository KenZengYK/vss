...
uses
  ...
  ppDBPipe, DB, DBClient, ppViewr, dateutils, ppMemo, ppParameter;
...
begin
  ...
  if query2.Active=false then begin
  ...
  if (frmpdnpast.label10.Caption='PDN Qty') or (frmpdnpast.label10.caption='Both') then begin
    ...
    with query3 do begin
      ...
      params[0].asdatetime:=query1.fieldbyname('tm').value;
      params[1].asstring:=query1.fieldbyname('cust').value;//query2.fieldbyname('cust').value;
      open;
      first;
    ...
    if frmpdnpast.label10.Caption='Both' then begin
      if pt1>=3.5 then grd003.Caption:=grd003.Caption+' / A'
      ...
      if pt1>=3.5 then grd003.Caption:='A'
...
begin
  ...
  if (frmpdnpast.label10.Caption='PDN Qty') or (frmpdnpast.label10.caption='Both') then begin
    ...
    pt1:=pt1/pt;
    if frmpdnpast.label10.Caption='Both' then begin
      if pt1>=3.5 then grd002.Caption:=grd002.Caption+' / A'
      ...
      if pt1>=3.5 then grd002.Caption:='A'
