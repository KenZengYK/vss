...
procedure Tfrmaqltransit.FormClose(Sender: TObject;
...
procedure Tfrmaqltransit.BitBtn1Click(Sender: TObject);
var
  dt:tdate;
begin
  //bitbtn3click(self);
  ...
  if lblcs.Caption='The twentyth time' then begin
    with query2 do begin
      ...
      commandtext:='select max(adt19) as dt from tbl_lwo where pline=:x1 and seq=:x2';
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq19');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt18) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq18');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt17) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq17');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt16) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq16');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt15) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq15');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt14) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq14');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt13) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq13');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt12) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq12');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt11) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq11');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt10) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq10');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt9) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq003');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt8) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq002');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt7) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq001');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt6) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq03');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt5) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq02');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt4) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq01');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt3) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt2) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    //dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('aq02');
    //dbgrideh1.Columns[8].Field:=frmlwo.query1.fieldbyname('aq002');
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq1');
    //dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('aq01');
    //dbgrideh1.Columns[8].Field:=frmlwo.query1.fieldbyname('aq001');
    lblcs.Caption:='The first time';
    bitbtn1.Enabled:=false;
  end;
end;

procedure Tfrmaqltransit.BitBtn2Click(Sender: TObject);
var
  dt:tdate;
begin
  //bitbtn3click(self);
  ...
  if lblcs.Caption='The first time' then begin
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(adt20) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[6].Field:=frmlwo.query1.fieldbyname('aq20');
    lblcs.Caption:='The twentyth time';
    bitbtn2.Enabled:=false;
  end;
end;

procedure Tfrmaqltransit.BitBtn3Click(Sender: TObject);
var
  s1:string;
  pstr:string;
  str1:string;
begin
  ...
  with query2 do begin
    ...
    commandtext:='update tbl_lwo set adt'+s1+'=:x1 where pline=:x2 and seq=:x3';
  ...
  str1:='update tbl_lwo set adt'+s1+'='''+formatdatetime('yyyy-MM-dd',dateedit1.Date)+''' where pline='''+frmlwo.Query1.fieldbyname('pline').value+' and seq='+frmlwo.Query1.fieldbyname('seq').asstring;
  if frmmain.PHService.UpdateLWPM(str1)=0 then showmessage('Can not save!');

  label8.Caption:='Save';
  {
    pstr:='12 A '+frmlwo.query1.fieldbyname('pline').value+' '+frmlwo.query1.fieldbyname('seq').asstring+' '+s1+' '+dateedit1.text;
...
procedure Tfrmaqltransit.DBGridEh1KeyPress(Sender: TObject; var Key: Char);
var
  r24:boolean;
begin
  with query2 do begin
    ...
    open;
    if not fieldbyname('r49').isnull then r24:=fieldbyname('r49').value
    else r24:=false;
  end;
...
procedure Tfrmaqltransit.FormShow(Sender: TObject);
var
