...
procedure Tfrmpdnrpt2.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppReport1.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport1.PreviewForm.Viewer).ZoomPercentage:=100;
end;

procedure Tfrmpdnrpt2.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  srwo01.Caption:='123';
...
procedure Tfrmpdnrpt2.ppDetailBand1BeforePrint(Sender: TObject);
begin
  if srwo01.Caption>'' then begin
...
procedure Tfrmpdnrpt2.ppGroupFooterBand1BeforePrint(Sender: TObject);
var
  woqty:integer;
begin
...
procedure Tfrmpdnrpt2.ppGroupFooterBand4BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt2.ppGroupHeaderBand8BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
...
procedure Tfrmpdnrpt2.ppGroupHeaderBand7BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt2.ppDetailBand3BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt2.ppGroupFooterBand6BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt2.ppSummaryBand3BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt2.ppGroupHeaderBand4BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
...
procedure Tfrmpdnrpt2.ppTitleBand1BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
...
procedure Tfrmpdnrpt2.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ...
  with query2 do begin
    close;
    params.clear;
    commandtext:='select castl1 from tbl_pdn_rwo where seq='+query5.fieldbyname('seq').asstring+' and j_no='''+query5.fieldbyname('j_no').value+''' and j2_job='''+
  end;
  }
end;

procedure Tfrmpdnrpt2.ppGroupFooterBand15BeforePrint(Sender: TObject);
var
...
procedure Tfrmpdnrpt2.ppGroupHeaderBand15BeforePrint(Sender: TObject);
var
  box1:integer;
  wght1,cbm1:double;
begin
...
procedure Tfrmpdnrpt2.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
...
procedure Tfrmpdnrpt2.ppGroupFooterBand7BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt2.ppGroupHeaderBand6BeforePrint(Sender: TObject);
begin
  s1001.Visible:=false;s1002.Visible:=false;s1003.Visible:=false;s1004.Visible:=false;s1005.Visible:=false;s1006.Visible:=false;s1007.Visible:=false;s1008.Visible:=false;
  s2001.Visible:=false;s2002.Visible:=false;s2003.Visible:=false;s2004.Visible:=false;s2005.Visible:=false;s2006.Visible:=false;s2007.Visible:=false;s2008.Visible:=false;
  s1101.Visible:=false;s1102.Visible:=false;s1103.Visible:=false;s1104.Visible:=false;s1105.Visible:=false;s1106.Visible:=false;s1107.Visible:=false;s1108.Visible:=false;
