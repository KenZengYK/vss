object frmtransit2: Tfrmtransit2
  Left = 154
  Top = 98
  Caption = 'QN - Transit 2'
  ClientHeight = 380
  ClientWidth = 603
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        Footers = <>
        ReadOnly = True
        Title.Caption = 'Flow Diff (Sewn - T2 Qty)'
        Width = 65
      end
      item
        EditButtons = <>
        ...
        ReadOnly = True
        Title.Caption = 'Total Transit 2 Qty'
        Width = 65
      end
      item
        EditButtons = <>
