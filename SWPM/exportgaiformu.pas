    ...
    with query1 do begin
      ...
      if worksheet1.lbl850.Caption='SPE' then
        commandtext:='select distinct a.tshop as "Workshop",a.pline as "Line #",a.j_no as "Project #",a.j2_job as "WO #",'
                    ...
                    +'a.lstr-a.ewf as "Def WF",a.sjrs-a.sjrs3 as "Actual WF",a.trs as "Def Mc",a.sgt as "Def Work table",a.gzw as "Def Workstation",a.sjyc as "Actual Mc",'
                    +'a.prj1*100.00/a.xjs/a.eff1 as "Def Sect hr",a.csect as "Curr Sect hr",a.prj1 as "Target",substr(b.flag6,1,1) as "Prod Category",'
        ...
        commandtext:='select distinct a.tshop as "Workshop",a.pline as "Line #",a.j_no as "Project #",a.j2_job as "WO #",'
                    +'a.cstyle as "Cust Style",a.acol as "Clr Code",a.rwo as "RWO #",a.fccs as "QN #",a.dt1 as "Date",'
                    +'a.lstr as "Def WF",a.sjrs as "Actual WF",a.trs as "Def Mc",a.sgt as "Def Work table",a.gzw as "Def Workstation",a.sjyc as "Actual Mc",'
                    +'a.prj1*100.00/a.xjs/a.eff1 as "Def Sect hr",a.csect as "Curr Sect hr",a.prj1 as "Target",substr(b.flag6,1,1) as "Prod Category",'
