...
uses
  ...
  Dialogs, ppDB, ppCtrls, ppBands, ppClass, ppStrtch, ppMemo, myChkBox,
  ppVar, ppPrnabl, ppCache, ppProd, ppReport, ppComm, ppRelatv, ppDBPipe,
  DB, DBClient, Spin, StdCtrls, Mask, rxToolEdit, Buttons, ppViewr,
  ppParameter;

type
  Tfrmfwf2 = class(TForm)
    Label1: TLabel;
    Label3: TLabel;
    Label4: TLabel;
    Label5: TLabel;
...
procedure Tfrmfwf2.BitBtn1Click(Sender: TObject);
begin
...
procedure Tfrmfwf2.FormClose(Sender: TObject; var Action: TCloseAction);
begin
  action:=cafree;
  frmfwf2:=nil;
end;

procedure Tfrmfwf2.ppGroupFooterBand2BeforePrint(Sender: TObject);
var
...
procedure Tfrmfwf2.ppReport1PreviewFormCreate(Sender: TObject);
begin
