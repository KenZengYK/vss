object frmigapack: Tfrmigapack
  Left = 192
  Top = 114
  Caption = 'QN - iPack/gPack/aPack'
  ClientHeight = 0
  ClientWidth = 108
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        ReadOnly = True
        Title.Caption = 'Flow Diff (T2 - iPack / gPack / aPack Qty)'
        Width = 59
      end
      item
        EditButtons = <>
        ...
        ReadOnly = True
        Title.Caption = 'Total iPack / gPack / aPack Qty'
        Width = 52
      end
      item
        EditButtons = <>
        ...
        PickList.Strings = (
          ...
          'g'
          'a')
        Title.Caption = 'iPack / gPack / aPack| '
        Visible = False
        Width = 23
      end
      item
        ...
        Title.Caption = 'iPack / gPack / aPack Qty'
        Width = 53
      end
      item
        EditButtons = <>
