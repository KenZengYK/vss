...
procedure TfrmdailyT2_1.ppReport2PreviewFormCreate(Sender: TObject);
begin
  ppReport2.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport2.PreviewForm.Viewer).ZoomPercentage:=100;
end;

procedure TfrmdailyT2_1.ppDetailBand2BeforePrint(Sender: TObject);
begin
  ...
  if dt01.Caption>'' then begin
    p01.Caption:=query7.fieldbyname('tq14').value;
    t01.Caption:=query7.fieldbyname('ttq14').value;
    if query7.fieldbyname('tq14').value>0 then p01.Font.Style:=[fsBold]
    else p01.Font.Style:=[];
    if query7.fieldbyname('ttq14').value>0 then t01.Font.Style:=[fsBold]
    else t01.Font.Style:=[];
  end;
  if dt02.Caption>'' then begin
    p02.Caption:=query7.fieldbyname('tq15').value;
    t02.Caption:=query7.fieldbyname('ttq15').value;
    if query7.fieldbyname('tq15').value>0 then p02.Font.Style:=[fsBold]
    else p02.Font.Style:=[];
    if query7.fieldbyname('ttq15').value>0 then t02.Font.Style:=[fsBold]
    else t02.Font.Style:=[];
  end;
  if dt03.Caption>'' then begin
    p03.Caption:=query7.fieldbyname('tq16').value;
    t03.Caption:=query7.fieldbyname('ttq16').value;
    if query7.fieldbyname('tq16').value>0 then p03.Font.Style:=[fsBold]
    else p03.Font.Style:=[];
    if query7.fieldbyname('ttq16').value>0 then t03.Font.Style:=[fsBold]
    else t03.Font.Style:=[];
  end;
  if dt04.Caption>'' then begin
    p04.Caption:=query7.fieldbyname('tq17').value;
    t04.Caption:=query7.fieldbyname('ttq17').value;
    if query7.fieldbyname('tq17').value>0 then p04.Font.Style:=[fsBold]
    else p04.Font.Style:=[];
    if query7.fieldbyname('ttq17').value>0 then t04.Font.Style:=[fsBold]
    else t04.Font.Style:=[];
  end;
  if dt05.Caption>'' then begin
    p05.Caption:=query7.fieldbyname('tq18').value;
    t05.Caption:=query7.fieldbyname('ttq18').value;
    if query7.fieldbyname('tq18').value>0 then p05.Font.Style:=[fsBold]
    else p05.Font.Style:=[];
    if query7.fieldbyname('ttq18').value>0 then t05.Font.Style:=[fsBold]
    else t05.Font.Style:=[];
  end;
  if dt06.Caption>'' then begin
    p06.Caption:=query7.fieldbyname('tq19').value;
    t06.Caption:=query7.fieldbyname('ttq19').value;
    if query7.fieldbyname('tq19').value>0 then p06.Font.Style:=[fsBold]
    else p06.Font.Style:=[];
    if query7.fieldbyname('ttq19').value>0 then t06.Font.Style:=[fsBold]
    else t06.Font.Style:=[];
  end;
  if dt07.Caption>'' then begin
    p07.Caption:=query7.fieldbyname('tq20').value;
    t07.Caption:=query7.fieldbyname('ttq20').value;
    if query7.fieldbyname('tq20').value>0 then p07.Font.Style:=[fsBold]
    else p07.Font.Style:=[];
    if query7.fieldbyname('ttq20').value>0 then t07.Font.Style:=[fsBold]
    else t07.Font.Style:=[];
  end;
  if dt08.Caption>'' then begin
    p08.Caption:=query7.fieldbyname('tq21').value;
    t08.Caption:=query7.fieldbyname('ttq21').value;
    if query7.fieldbyname('tq21').value>0 then p08.Font.Style:=[fsBold]
    else p08.Font.Style:=[];
    if query7.fieldbyname('ttq21').value>0 then t08.Font.Style:=[fsBold]
    else t08.Font.Style:=[];
  end;
  if dt09.Caption>'' then begin
    p09.Caption:=query7.fieldbyname('tq22').value;
    t09.Caption:=query7.fieldbyname('ttq22').value;
    if query7.fieldbyname('tq22').value>0 then p09.Font.Style:=[fsBold]
    else p09.Font.Style:=[];
    if query7.fieldbyname('ttq22').value>0 then t09.Font.Style:=[fsBold]
    else t09.Font.Style:=[];
  end;
  if dt10.Caption>'' then begin
    p10.Caption:=query7.fieldbyname('tq23').value;
    t10.Caption:=query7.fieldbyname('ttq23').value;
    if query7.fieldbyname('tq23').value>0 then p10.Font.Style:=[fsBold]
    else p10.Font.Style:=[];
    if query7.fieldbyname('ttq23').value>0 then t10.Font.Style:=[fsBold]
    else t10.Font.Style:=[];
  end;
  if dt11.Caption>'' then begin
    p11.Caption:=query7.fieldbyname('tq24').value;
    t11.Caption:=query7.fieldbyname('ttq24').value;
    if query7.fieldbyname('tq24').value>0 then p11.Font.Style:=[fsBold]
    else p11.Font.Style:=[];
    if query7.fieldbyname('ttq24').value>0 then t11.Font.Style:=[fsBold]
    else t11.Font.Style:=[];
  end;
  if dt12.Caption>'' then begin
    p12.Caption:=query7.fieldbyname('tq25').value;
    t12.Caption:=query7.fieldbyname('ttq25').value;
    if query7.fieldbyname('tq25').value>0 then p12.Font.Style:=[fsBold]
    else p12.Font.Style:=[];
    if query7.fieldbyname('ttq25').value>0 then t12.Font.Style:=[fsBold]
    else t12.Font.Style:=[];
  end;
  if dt13.Caption>'' then begin
    p13.Caption:=query7.fieldbyname('tq26').value;
    t13.Caption:=query7.fieldbyname('ttq26').value;
    if query7.fieldbyname('tq26').value>0 then p13.Font.Style:=[fsBold]
    else p13.Font.Style:=[];
    if query7.fieldbyname('ttq26').value>0 then t13.Font.Style:=[fsBold]
    else t13.Font.Style:=[];
  end;
end;

procedure TfrmdailyT2_1.ppSummaryBand2BeforePrint(Sender: TObject);
var
...
procedure TfrmdailyT2_1.ppHeaderBand2BeforePrint(Sender: TObject);
var
  i:integer;
begin
...
procedure TfrmdailyT2_1.ppReport2BeforePrint(Sender: TObject);
var
