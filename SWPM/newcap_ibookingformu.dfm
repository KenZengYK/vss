object frmnewcap_ibooking: Tfrmnewcap_ibooking
  Left = 192
  Top = 114
  Width = 696
  Height = 480
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        Footers = <>
        Title.Caption = 'Internal Booking|B|Qty(pcs)'
        Width = 55
      end
      item
        ...
        FieldName = 'buprc'
        Footers = <>
        Title.Caption = 'Internal Booking|B|Unit Price'
        Width = 55
      end
      item
        EditButtons = <>
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'Internal Booking|K|Qty(pcs)'
        Width = 55
      end
      item
        DisplayFormat = '0.0000'
        ...
        FieldName = 'kuprc'
        Footers = <>
        Title.Caption = 'Internal Booking|K|Unit Price'
        Width = 55
      end
      item
        EditButtons = <>
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'Internal Booking|U|Qty(pcs)'
        Width = 55
      end
      item
        DisplayFormat = '0.0000'
        ...
        FieldName = 'uuprc'
        Footers = <>
        Title.Caption = 'Internal Booking|U|Unit Price'
        Width = 55
      end
      item
        Color = 13365228
        ...
        Footers = <>
        ReadOnly = True
        Title.Caption = 'Internal Booking|Total Qty'
        Width = 55
      end
      item
        Color = 13365228
        ...
        Footers = <>
        ReadOnly = True
        Title.Caption = 'Internal Booking|Total Value'
        Width = 55
      end
      item
        DisplayFormat = '0.00'
  ...
  object Query1: TClientDataSet
    Aggregates = <>
    CommandText = 'select * from tbl_cap_oa_book2'
    FieldDefs = <
      item
        Name = 'SEQ'
        DataType = ftInteger
