...
uses
  ...
  ppCtrls, ppPrnabl, ppBands, ppCache, ppVar, ppViewr, ppStrtch,
  ppMemo, Db, DBClient, ppSubRpt, ppParameter;
...
procedure Tfrmprint.ppSummaryBand1BeforePrint(Sender: TObject);
begin
