...
uses
  ...
  ppDBPipe, DB, DBClient, StdCtrls, ExtCtrls, Buttons, ppViewr, ppParameter;

type
  Tfrmordersummary_0 = class(TForm)
    Label1: TLabel;
    Label2: TLabel;
    Label3: TLabel;
    ComboBox1: TComboBox;
...
var
  frmordersummary_0: Tfrmordersummary_0;
...
procedure Tfrmordersummary_0.ppDetailBand1BeforePrint(
  Sender: TObject);
var
  s1,s2,s3:string;
begin
  ...
  with query3 do begin
    ...
    commandtext:='select distinct onr,bku,cstyle,pjc1 from tbl_tmp_ordsummary where tm=:x1 and jhrs2=:x2 and onr in (''O'',''Q'') and fc=:x3 and dcdate=:x4 and duedt=:x5';  //Q
    ...
    while not eof do begin
      ...
      if not fieldbyname('cstyle').isnull then begin
        if s1>'' then s1:=s1+' / '+fieldbyname('bku').value+'-'+fieldbyname('cstyle').value+'('+fieldbyname('pjc1').value+')'+s3//+s2
        else s1:=fieldbyname('bku').value+'-'+fieldbyname('cstyle').value+'('+fieldbyname('pjc1').value+')'+s3;//+s2;
      end;
  ...
  with query3 do begin
    ...
    params.createparam(ftstring,'x4',ptinput);
    params.createparam(ftstring,'x5',ptinput);
    commandtext:='select distinct onr,bku,cstyle,pjc1 from tbl_tmp_ordsummary where tm=:x1 and jhrs2=:x2 and onr in (''R'',''T'') and fc=:x3 and dcdate=:x4 and duedt=:x5';   //T
    params[0].asdatetime:=query2.fieldbyname('tm').value;
    params[1].asstring:=query2.fieldbyname('jhrs1').value;
    params[2].asstring:=query2.fieldbyname('fc').value;
    params[3].asstring:=query2.fieldbyname('dcdate').value;
  ...
  with query3 do begin
    ...
    params.createparam(ftstring,'x4',ptinput);
    params.createparam(ftstring,'x5',ptinput);
    commandtext:='select distinct onr,bku,cstyle,pjc1 from tbl_tmp_ordsummary where tm=:x1 and jhrs2=:x2 and onr in (''G'',''P'') and fc=:x3 and dcdate=:x4 and duedt=:x5'; //P
    params[0].asdatetime:=query2.fieldbyname('tm').value;
    params[1].asstring:=query2.fieldbyname('jhrs1').value;
    params[2].asstring:=query2.fieldbyname('fc').value;
    params[3].asstring:=query2.fieldbyname('dcdate').value;
  ...
  with query3 do begin
    ...
    params.createparam(ftstring,'x4',ptinput);
    params.createparam(ftstring,'x5',ptinput);
    commandtext:='select count(distinct cstyle) as s1,sum(scqty) as s2 from tbl_tmp_ordsummary where tm=:x1 and jhrs2=:x2 and onr in (''O'',''Q'') and fc=:x3 and dcdate=:x4 and duedt=:x5';  //Q
    params[0].asdatetime:=query2.fieldbyname('tm').value;
    params[1].asstring:=query2.fieldbyname('jhrs1').value;
    params[2].asstring:=query2.fieldbyname('fc').value;
    params[3].asstring:=query2.fieldbyname('dcdate').value;
  ...
  with query3 do begin
    ...
    params.createparam(ftstring,'x3',ptinput);
    params.createparam(ftstring,'x4',ptinput);
    commandtext:='select count(distinct cstyle) as s1,sum(scqty) as s2 from tbl_tmp_ordsummary where tm=:x1 and jhrs2=:x2 and onr in (''R'',''T'') and fc=:x3 and dcdate=:x4 and duedt=:x5'; //T
    params[0].asdatetime:=query2.fieldbyname('tm').value;
    params[1].asstring:=query2.fieldbyname('jhrs1').value;
    params[2].asstring:=query2.fieldbyname('fc').value;
    params[3].asstring:=query2.fieldbyname('dcdate').value;
  ...
  with query3 do begin
    ...
    params.createparam(ftstring,'x4',ptinput);
    params.createparam(ftstring,'x5',ptinput);
    commandtext:='select count(distinct cstyle) as s1,sum(scqty) as s2 from tbl_tmp_ordsummary where tm=:x1 and jhrs2=:x2 and onr in (''G'',''P'') and fc=:x3 and dcdate=:x4 and duedt=:x5';  //P
    params[0].asdatetime:=query2.fieldbyname('tm').value;
    params[1].asstring:=query2.fieldbyname('jhrs1').value;
    params[2].asstring:=query2.fieldbyname('fc').value;
    params[3].asstring:=query2.fieldbyname('dcdate').value;
...
procedure Tfrmordersummary_0.ppSummaryBand2BeforePrint(Sender: TObject);
var
  s1:string;
  s0,s00:integer;
begin
...
procedure Tfrmordersummary_0.ppDetailBand2BeforePrint(Sender: TObject);
begin
  with query3 do begin
    close;
    params.clear;
...
procedure Tfrmordersummary_0.ppSummaryBand1BeforePrint(Sender: TObject);
begin
  with query3 do begin
    close;
    params.clear;
  ...
  with query3 do begin
    ...
    params.clear;
    params.createparam(ftdatetime,'x1',ptinput);
    commandtext:='select count(distinct cstyle) as s1,sum(scqty) as s2 from tbl_tmp_ordsummary where tm=:x1'; //P
    params[0].asdatetime:=query1.fieldbyname('tm').value;
    open;
...
procedure Tfrmordersummary_0.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppReport1.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport1.PreviewForm.Viewer).ZoomPercentage:=100;
end;

procedure Tfrmordersummary_0.BitBtn1Click(Sender: TObject);
var
  tm,tm1:tdatetime;
  s1,s2,s3,s4:string;
  str1:string;
...
procedure Tfrmordersummary_0.ppGroupFooterBand1BeforePrint(
  Sender: TObject);
var
  i1,i2,i3:integer;
begin
...
procedure Tfrmordersummary_0.ppGroupFooterBand3BeforePrint(
  Sender: TObject);
var
  i1:integer;
begin
...
procedure Tfrmordersummary_0.FormClose(Sender: TObject;
  var Action: TCloseAction);
begin
  action:=cafree;
  frmordersummary_0:=nil;
end;
