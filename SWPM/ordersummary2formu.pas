...
uses
  ...
  ppVar, ppViewr, ExtCtrls, ppStrtch, ppMemo, ppParameter;
  ...
  if xh1.ItemIndex=0 then begin
    ...
    with query1 do begin
      ...
      if not fieldbyname('season').isnull then begin
        ...
        title01.Caption:='HBI Order Summary (Quantity)'
        else title01.Caption:=convertseason(combobox3.text)+' Order Summary (Quantity)';
