...
procedure Tfrmtransit3.FormClose(Sender: TObject;
...
procedure Tfrmtransit3.BitBtn1Click(Sender: TObject);
var
  dt:tdate;
begin
  //bitbtn3click(self);
  ...
  if lblcs.Caption='The twentyth time' then begin
    with query2 do begin
      ...
      commandtext:='select max(fdt19) as dt from tbl_lwo where pline=:x1 and seq=:x2';
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq19');
    lblcs.Caption:='The ninteenth time';
  end else if lblcs.Caption='The ninteenth time' then begin
    with query2 do begin
      close;
      params.clear;
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt18) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq18');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt17) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq17');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt16) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq16');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt15) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq15');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt14) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq14');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt13) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq13');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt12) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq12');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt11) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq11');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt10) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq10');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt9) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq9');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt8) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq8');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt7) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq7');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt6) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq6');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt5) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq5');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt4) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq4');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt3) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq3');
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt2) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq2');
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq1');
    lblcs.Caption:='The first time';
    bitbtn1.Enabled:=false;
  end;
end;

procedure Tfrmtransit3.BitBtn2Click(Sender: TObject);
var
  dt:tdate;
begin
  //bitbtn3click(self);
  ...
  if lblcs.Caption='The first time' then begin
    ...
    with query2 do begin
      ...
      params.createparam(ftstring,'x1',ptinput);
      params.createparam(ftinteger,'x2',ptinput);
      commandtext:='select max(fdt20) as dt from tbl_lwo where pline=:x1 and seq=:x2';
      params[0].asstring:=frmlwo.query1.fieldbyname('pline').value;
      params[1].asinteger:=frmlwo.query1.fieldbyname('seq').value;
      open;
      if not fieldbyname('dt').isnull then dt:=fieldbyname('dt').value;
    ...
    dateedit1.Date:=dt;
    dbgrideh1.Columns[7].Field:=frmlwo.query1.fieldbyname('fq20');
    lblcs.Caption:='The twentyth time';
    bitbtn2.Enabled:=false;
  end;
end;

procedure Tfrmtransit3.BitBtn3Click(Sender: TObject);
var
  s1:string;
  pstr:string;
  str1:string;
begin
  ...
  else if pos('ninteen',lblcs.Caption)>0 then s1:='19'
  ...
  with query2 do begin
    ...
    commandtext:='update tbl_lwo set fdt'+s1+'=:x1 where pline=:x2 and seq=:x3';
  ...
  str1:='update tbl_lwo set fdt'+s1+'='''+formatdatetime('yyyy-MM-dd',dateedit1.Date)+''' where pline='''+frmlwo.Query1.fieldbyname('pline').value+''' and seq='+frmlwo.Query1.fieldbyname('seq').asstring;
  if frmmain.PHService.UpdateLWPM(str1)=0 then showmessage('Can not save!');

  label8.Caption:='Save';
  {
    pstr:='12 E '+frmlwo.query1.fieldbyname('pline').value+' '+frmlwo.query1.fieldbyname('seq').asstring+' '+s1+' '+dateedit1.text;
...
procedure Tfrmtransit3.DBGridEh1KeyPress(Sender: TObject; var Key: Char);
var
  r24:boolean;
begin
  with query2 do begin
...
procedure Tfrmtransit3.FormShow(Sender: TObject);
var
