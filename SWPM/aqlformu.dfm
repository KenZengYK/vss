object frmaql: Tfrmaql
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        ReadOnly = True
        Title.Caption = 'Flow Diff (T3 - Total AQL-P)'
        Visible = False
        Width = 50
      end
      item
  ...
  object Query1: TClientDataSet
    Aggregates = <>
    CommandText = 'select * from tbl_lwo_aql'
    Params = <>
