...
uses
  ...
  ppViewr, ppMemo, ppRichTx, myChkBox, ppParameter;

type
  Tfrmpdnrpt3 = class(TForm)
...
procedure Tfrmpdnrpt3.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppReport1.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport1.PreviewForm.Viewer).ZoomPercentage:=100;
end;

procedure Tfrmpdnrpt3.ppHeaderBand1BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppDetailBand1BeforePrint(Sender: TObject);
var
...
begin
  ...
  sd102.Caption:=inttostr(p01+p03+p05+p07+p09+p11+p13+p15+p17);
  ...
  sd208.Caption:=inttostr(query4.fieldbyname('q2t4qty').value+query4.fieldbyname('q4t4qty').value+query4.fieldbyname('q6t4qty').value+query4.fieldbyname('q8t4qty').value+query4.fieldbyname('q10t4qty').value+query4.fieldbyname('q12t4qty').value+query4.fieldbyname('q14t4qty').value+query4.fieldbyname('q16t4qty').value+query4.fieldbyname('q18t4qty').value);
{
  ...
  if (p01+p03+p05+p07+p09+p11+p13+p15+p17>t101+t103+t105+t107+t109+t111+t113+t115+t117) then sd103.Font.Color:=clRed
  else if (p01+p03+p05+p07+p09+p11+p13+p15+p17=t101+t103+t105+t107+t109+t111+t113+t115+t117) then sd103.Font.Color:=clBlack else sd103.Font.color:=clGreen;
  if (t101+t103+t105+t107+t109+t111+t113+t115+t117>t201+t203+t205+t207+t209+t211+t213+t215+t217) then sd104.Font.Color:=clRed
  else if (t101+t103+t105+t107+t109+t111+t113+t115+t117=t201+t203+t205+t207+t209+t211+t213+t215+t217) then sd104.Font.Color:=clBlack else sd104.Font.color:=clGreen;
  if (t201+t203+t205+t207+t209+t211+t213+t215+t217>t301+t303+t305+t307+t309+t311+t313+t315+t317) then sd106.Font.Color:=clRed
  else if (t201+t203+t205+t207+t209+t211+t213+t215+t217=t301+t303+t305+t307+t309+t311+t313+t315+t317) then sd106.Font.Color:=clBlack else sd106.Font.color:=clGreen;
  if (t301+t303+t305+t307+t309+t311+t313+t315+t317>aq01+aq03+aq05+aq07+aq09+aq11+aq13+aq15+aq17) then sd107.Font.Color:=clRed
  else if (t301+t303+t305+t307+t309+t311+t313+t315+t317=aq01+aq03+aq07+aq10+aq13+aq16) then sd107.Font.Color:=clBlack else sd107.Font.color:=clGreen;
  if (aq01+aq03+aq05+aq07+aq09+aq11+aq13+aq15+aq17>t401+t403+t405+t407+t409+t411+t413+t415+t417) then sd108.Font.Color:=clRed
  else if (aq01+aq03+aq05+aq07+aq09+aq11+aq13+aq15+aq17=t401+t403+t405+t407+t409+t411+t413+t415+t417) then sd108.Font.Color:=clBlack else sd108.Font.color:=clGreen;
  ...
  end;
{
  ...
  if abs(query4.fieldbyname('diff').Value)=query4.fieldbyname('sqty').Value then diff001.Caption:='--'
  else diff001.Caption:=query4.fieldbyname('diff').asstring;
  ...
  v001.Caption:=query4.fieldbyname('shpqty').asstring;
...
procedure Tfrmpdnrpt3.ppGroupFooterBand14BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
    ...
    commandtext:='select sum(q1qty+q3qty+q5qty+q7qty+q9qty+q11qty+q13qty+q15qty+q17qty) as q01,sum(q1t1qty+q3t1qty+q5t1qty+q7t1qty+q9t1qty+q11t1qty+q13t1qty+q15t1qty+q17t1qty) as q03,'
                +'sum(q1t2qty+q3t2qty+q5t2qty+q7t2qty+q9t2qty+q11t2qty+q13t2qty+q15t2qty+q17t2qty) as q04,sum(q1t3qty+q3t3qty+q5t3qty+q7t3qty+q9t3qty+q11t3qty+q13t3qty+q15t3qty+q17t3qty) as q06,'
                +'sum(q1aqqty+q3aqqty+q5aqqty+q7aqqty+q9aqqty+q11aqqty+q13aqqty+q15aqqty+q17aqqty) as q07,sum(q1t4qty+q3t4qty+q5t4qty+q7t4qty+q9t4qty+q11t4qty+q13t4qty+q15t4qty+q17t4qty) as q08,'
                ...
                +'sum(q1pqty+q3pqty+q5pqty+q7pqty+q9pqty+q11pqty+q13pqty+q15pqty+q17pqty) as q02,sum(q2pqty+q4pqty+q6pqty+q8pqty+q10pqty+q12pqty+q14pqty+q16pqty+q18pqty) as q12,'
                +'sum(q1pkqty+q3pkqty+q5pkqty+q7pkqty+q9pkqty+q11pkqty+q13pkqty+q15pkqty+q17pkqty) as q05,sum(q2pkqty+q4pkqty+q6pkqty+q8pkqty+q10pkqty+q12pkqty+q14pkqty+q16pkqty+q18pkqty) as q15 '
    ...
    else if fieldbyname('q17').value=fieldbyname('q18').value then sb208.Font.Color:=clBlack else sb208.Font.Color:=clGreen;
{
  ...
  if abs(sbd01.Value)=sbq01.Value then diff002.Caption:='--'
  else diff002.Caption:=inttostr(sbd01.Value);
  ...
  v006.Caption:=inttostr(ppdbcalc1.Value-sbq01.Value-v004.Value);
end;

procedure Tfrmpdnrpt3.ppGroupFooterBand1BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppGroupHeaderBand13BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
...
procedure Tfrmpdnrpt3.ppGroupHeaderBand4BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
...
procedure Tfrmpdnrpt3.ppGroupHeaderBand5BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppGroupHeaderBand6BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppGroupHeaderBand7BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppGroupHeaderBand8BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppGroupHeaderBand9BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppGroupHeaderBand12BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppDetailBand3BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppGroupFooterBand12BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppGroupFooterBand9BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppGroupFooterBand8BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppGroupFooterBand7BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppGroupFooterBand6BeforePrint(Sender: TObject);
begin
  ...
  bs1306.Caption:=b3016.value+b3026.value;
...
procedure Tfrmpdnrpt3.ppGroupFooterBand5BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt3.ppSummaryBand3BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
...
procedure Tfrmpdnrpt3.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  with query2 do begin
    close;
    params.clear;
