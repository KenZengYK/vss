...
uses mainformu, wipimageformu, lineeffformu, wkfformu, fgaiformu, fwfformu,
  ...
  shp_accountformu, Salesforecast_PDNformu;
...
begin
  ...
  frm_outstandinggainotepad.label1.caption:='850';
  frm_outstandinggainotepad.caption:='850 GAI below index - Event Incomplete';
...
begin
  ...
  frmcmpgainotepad.label3.caption:='850';
  frmcmpgainotepad.caption:='850 GAI below index - Event Completed';
...
begin
  ...
  //frmshp_account.show;
  if frmcmpgainotepad=nil then frmcmpgainotepad:=tfrmcmpgainotepad.create(nil);
  frmcmpgainotepad.label3.caption:='915';
  frmcmpgainotepad.caption:='915 GAI below index - Event Completed';
  frmcmpgainotepad.show;
end;

procedure Tfrmanalysis.BitBtn25Click(Sender: TObject);
begin
  //if frmsalesforecast_pdn=nil then frmsalesforecast_pdn:=tfrmsalesforecast_pdn.create(nil);
  //frmsalesforecast_pdn.show;
  if frm_outstandinggainotepad=nil then frm_outstandinggainotepad:=tfrm_outstandinggainotepad.create(nil);
  frm_outstandinggainotepad.label1.caption:='915';
  frm_outstandinggainotepad.caption:='915 GAI below index - Event Incomplete';
  frm_outstandinggainotepad.show;
end;
