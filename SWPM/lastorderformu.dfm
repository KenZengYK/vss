object frmlastorders: Tfrmlastorders
  Left = 192
  Top = 107
  Caption = 'Last Order(s) Print'
  ClientHeight = 137
  ClientWidth = 225
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object cxView1: TcxGridDBBandedTableView
      ...
      object cxView1SHJS: TcxGridDBBandedColumn
        Caption = 'Default consolidate time lost'
      ...
      object cxView1YSJHL: TcxGridDBBandedColumn
        Caption = 'Line'#39's Time Eff (%) Default'
      ...
      object cxView1JHL: TcxGridDBBandedColumn
        Caption = 'Line'#39's Time Eff (%) Current'
  ...
  object xls1: TQExport4XLS
    DataSet = worksheet1.ClientDataSet4
  ...
  object tblshedule: TClientDataSet
    ...
    IndexDefs = <
      ...
      item
        Name = 'idx7'
        Fields = 'dta;tplant;tshop;pline;seq'
      end
      item
        Name = 'idx8'
