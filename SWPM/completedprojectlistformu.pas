...
begin
  ...
  cutcmp.Options.Editing:=rcut;
  shdcmp.Options.Editing:=rshd;
  wscmp.Options.Editing:=rws;
  pmccmp.Options.Editing:=rpmc;
  supcmp.Options.Editing:=rsup;
  whcmp.Options.Editing:=rwh;
end;
