...
procedure Tfrmwkf1.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppReport1.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport1.PreviewForm.Viewer).ZoomPercentage:=100;
end;

procedure Tfrmwkf1.ppDetailBand1BeforePrint(Sender: TObject);
var
...
procedure Tfrmwkf1.ppSummaryBand1BeforePrint(Sender: TObject);
var
