...
procedure Tfrmptrans3.ppDetailBand2BeforePrint(Sender: TObject);
begin
  //t102.Caption:=inttostr(frmlwo.query7.fieldbyname('ttqty').value-frmlwo.query7.fieldbyname('pqty').value);
  //t101.Caption:='0';//inttostr(frmlwo.query7.fieldbyname('ttqty').value-frmlwo.query7.fieldbyname('tqty').value);
  ...
  if dt01.Caption>'' then begin
    p01.Caption:=frmlwo.query7.fieldbyname('ttq01').value;
    t01.Caption:=frmlwo.query7.fieldbyname('ttq01').value;
    if frmlwo.query7.fieldbyname('ttq01').value>0 then p01.Font.Style:=[fsBold]
    else p01.Font.Style:=[];
    if frmlwo.query7.fieldbyname('ttq01').value>0 then t01.Font.Style:=[fsBold]
    else t01.Font.Style:=[];
    i01.Caption:=frmlwo.Query7.fieldbyname('q01').value;
    if frmlwo.query7.fieldbyname('q01').value>0 then i01.Font.Style:=[fsBold]
    else i01.Font.Style:=[];
  end;
  if dt02.Caption>'' then begin
    p02.Caption:=frmlwo.query7.fieldbyname('ttq02').value;
    t02.Caption:=frmlwo.query7.fieldbyname('ttq02').value;
    if frmlwo.query7.fieldbyname('ttq02').value>0 then p02.Font.Style:=[fsBold]
    else p02.Font.Style:=[];
    if frmlwo.query7.fieldbyname('ttq02').value>0 then t02.Font.Style:=[fsBold]
    else t02.Font.Style:=[];
    i02.Caption:=frmlwo.Query7.fieldbyname('q02').value;
    if frmlwo.query7.fieldbyname('q02').value>0 then i02.Font.Style:=[fsBold]
    else i02.Font.Style:=[];
  end;
  if dt03.Caption>'' then begin
    p03.Caption:=frmlwo.query7.fieldbyname('ttq03').value;
    t03.Caption:=frmlwo.query7.fieldbyname('ttq03').value;
    if frmlwo.query7.fieldbyname('ttq03').value>0 then p03.Font.Style:=[fsBold]
    else p03.Font.Style:=[];
    if frmlwo.query7.fieldbyname('ttq03').value>0 then t03.Font.Style:=[fsBold]
    else t03.Font.Style:=[];
    i03.Caption:=frmlwo.Query7.fieldbyname('q03').value;
    if frmlwo.query7.fieldbyname('q03').value>0 then i03.Font.Style:=[fsBold]
    else i03.Font.Style:=[];
  end;
  if dt04.Caption>'' then begin
    p04.Caption:=frmlwo.query7.fieldbyname('ttq04').value;
    t04.Caption:=frmlwo.query7.fieldbyname('ttq04').value;
    if frmlwo.query7.fieldbyname('ttq04').value>0 then p04.Font.Style:=[fsBold]
    else p04.Font.Style:=[];
    if frmlwo.query7.fieldbyname('ttq04').value>0 then t04.Font.Style:=[fsBold]
    else t04.Font.Style:=[];
    i04.Caption:=frmlwo.Query7.fieldbyname('q04').value;
    if frmlwo.query7.fieldbyname('q04').value>0 then i04.Font.Style:=[fsBold]
    else i04.Font.Style:=[];
  end;
  if dt05.Caption>'' then begin
    p05.Caption:=frmlwo.query7.fieldbyname('ttq05').value;
    t05.Caption:=frmlwo.query7.fieldbyname('ttq05').value;
    if frmlwo.query7.fieldbyname('ttq05').value>0 then p05.Font.Style:=[fsBold]
    else p05.Font.Style:=[];
    if frmlwo.query7.fieldbyname('ttq05').value>0 then t05.Font.Style:=[fsBold]
    else t05.Font.Style:=[];
    i05.Caption:=frmlwo.Query7.fieldbyname('q05').value;
    if frmlwo.query7.fieldbyname('q05').value>0 then i05.Font.Style:=[fsBold]
    else i05.Font.Style:=[];
  end;
  if dt06.Caption>'' then begin
    p06.Caption:=frmlwo.query7.fieldbyname('ttq06').value;
    t06.Caption:=frmlwo.query7.fieldbyname('ttq06').value;
    if frmlwo.query7.fieldbyname('ttq06').value>0 then p06.Font.Style:=[fsBold]
    else p06.Font.Style:=[];
    if frmlwo.query7.fieldbyname('ttq06').value>0 then t06.Font.Style:=[fsBold]
    else t06.Font.Style:=[];
    i06.Caption:=frmlwo.Query7.fieldbyname('q06').value;
    if frmlwo.query7.fieldbyname('q06').value>0 then i06.Font.Style:=[fsBold]
    else i06.Font.Style:=[];
  end;
  if dt07.Caption>'' then begin
    p07.Caption:=frmlwo.query7.fieldbyname('ttq07').value;
    t07.Caption:=frmlwo.query7.fieldbyname('ttq07').value;
    if frmlwo.query7.fieldbyname('ttq07').value>0 then p07.Font.Style:=[fsBold]
    else p07.Font.Style:=[];
    if frmlwo.query7.fieldbyname('ttq07').value>0 then t07.Font.Style:=[fsBold]
    else t07.Font.Style:=[];
    i07.Caption:=frmlwo.Query7.fieldbyname('q07').value;
    if frmlwo.query7.fieldbyname('q07').value>0 then i07.Font.Style:=[fsBold]
    else i07.Font.Style:=[];
  end;
  if dt08.Caption>'' then begin
    p08.Caption:=frmlwo.query7.fieldbyname('ttq08').value;
    t08.Caption:=frmlwo.query7.fieldbyname('ttq08').value;
    if frmlwo.query7.fieldbyname('ttq08').value>0 then p08.Font.Style:=[fsBold]
    else p08.Font.Style:=[];
    if frmlwo.query7.fieldbyname('ttq08').value>0 then t08.Font.Style:=[fsBold]
    else t08.Font.Style:=[];
    i08.Caption:=frmlwo.Query7.fieldbyname('q08').value;
    if frmlwo.query7.fieldbyname('q08').value>0 then i08.Font.Style:=[fsBold]
    else i08.Font.Style:=[];
  end;
end;

procedure Tfrmptrans3.ppSummaryBand2BeforePrint(Sender: TObject);
var
  ts301,ts302:string;
  c4:integer;
  tm0:tdatetime;
...
procedure Tfrmptrans3.ppHeaderBand2BeforePrint(Sender: TObject);
begin
...
procedure Tfrmptrans3.ppReport2PreviewFormCreate(Sender: TObject);
begin
