object frmpdnwrite: Tfrmpdnwrite
  Left = 199
  Top = 108
  Caption = 'PDN Write off / Delay Shipment'
  ClientHeight = 579
  ClientWidth = 809
  Color = clBtnFace
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'Washing Sample Qty'
        Visible = False
        Width = 48
      end
      item
      ...
      item
        ...
        FieldName = 'H_PDN'
        Footers = <>
        Title.Caption = 'Hold|Delay shpt to PDN'
        Width = 117
      end
      item
        EditButtons = <>
        ...
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'Delay Shipment|Qty'
        Width = 47
      end
      item
        EditButtons = <>
        FieldName = 'SWING_PDN'
        Footers = <>
        Title.Caption = 'Delay Shipment|Delay shpt to PDN'
        Width = 112
      end
      item
        EditButtons = <>
      ...
      item
        ...
        FieldName = 'DIS_REM'
        Footers = <>
        Title.Caption = 'Cutting more Sample|Remarks'
        Width = 141
      end>
