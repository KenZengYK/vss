...
uses
  ...
  ppRelatv, ppDB, ppDBPipe, ppStrtch, ppSubRpt, ppViewr;
...
begin
  ...
  with query2 do begin
    ...
    params.clear;
    params.createparam(ftdatetime,'x1',ptinput);
    commandtext:='select count(distinct pline) as p,count(distinct qn) as p1 from tbl_pdn_t3aqlexfty_qn where tm=:x1';
...
procedure TfrmPDN_T3AQLEXFTY.ppReport3PreviewFormCreate(Sender: TObject);
begin
