object frmpdn_deadstock: Tfrmpdn_deadstock
  Left = 0
  Top = 0
  Caption = 'PDN - Dead Stock Conducting'
  ClientHeight = 441
  ClientWidth = 825
  Color = clBtnFace
  ...
  object Panel1: TPanel
    ...
    object DBText1: TDBText
      ...
      Height = 17
      DataField = 'PDN'
      DataSource = frmselpdn.DataSource1
      Font.Charset = DEFAULT_CHARSET
      Font.Color = clBlue
      Font.Height = -11
  ...
  object DBGridEh1: TDBGridEh
    ...
    Columns = <
      ...
      item
        ...
        FieldName = 'H_PDN'
        Footers = <>
        Title.Caption = 'Hold|Swing to PDN'
        Visible = False
        Width = 117
      end
      item
      ...
      item
        ...
        FieldName = 'SWING_PDN'
        Footers = <>
        Title.Caption = 'Swing|Swing to PDN'
        Visible = False
        Width = 112
      end
      item
        EditButtons = <>
        FieldName = 'GMT_DEFECT'
        Footer.ValueType = fvtSum
        Footers = <>
        Title.Caption = 'Garment Defect'
        Width = 65
      end
      item
        Color = 13365228
  ...
  object Query1: TClientDataSet
    Aggregates = <>
    CommandText = 'select * from tbl_pdn_writeoff'
    FieldDefs = <
      item
        Name = 'SEQ'
