...
uses
  ...
  ppViewr, ppMemo, myChkBox, ppParameter;

type
  Tfrmpdnrpt10 = class(TForm)
...
procedure Tfrmpdnrpt10.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppReport1.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport1.PreviewForm.Viewer).ZoomPercentage:=100;
end;

procedure Tfrmpdnrpt10.ppGroupHeaderBand7BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt10.ppDetailBand3BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt10.ppGroupFooterBand6BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt10.ppSummaryBand3BeforePrint(Sender: TObject);
begin
...
procedure Tfrmpdnrpt10.ppGroupHeaderBand4BeforePrint(Sender: TObject);
begin
  srwo01.Caption:='123';
...
procedure Tfrmpdnrpt10.ppDetailBand1BeforePrint(Sender: TObject);
begin
  if srwo01.Caption>'' then begin
...
procedure Tfrmpdnrpt10.ppGroupFooterBand4BeforePrint(Sender: TObject);
begin
