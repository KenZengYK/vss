...
uses Carte_MainFormu, Carte_RequestactionFormu, Carte_OrdprocessingFormu,
Carte_GroupactionFormu;
  ...
  if key=#13 then begin
    if edit3.text>'' then begin
      ...
      with query3 do begin
        close;
        sql.text:='select mail from tbl_carte_user where mail like '''+trim(s1)+'%''';
        open;
