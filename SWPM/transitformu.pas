...
begin
  ...
  str1:='update tbl_lwo set ttd'+s1+'='''+formatdatetime('yyyy-MM-dd',dateedit1.Date)+''' where pline='''+frmlwo.Query1.fieldbyname('pline').value+''' and seq='+frmlwo.Query1.fieldbyname('seq').asstring;
