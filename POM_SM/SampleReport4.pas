...
var
  FrmsampleReport4: TFrmsampleReport4;
...
procedure TFrmsampleReport4.ppSummaryBand3BeforePrint(Sender: TObject);
var
  i:integer;
begin
  ppmemo6.Lines.clear;
...
procedure TFrmsampleReport4.ppReport2PreviewFormCreate(Sender: TObject);
begin
