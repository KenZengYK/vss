...
var
  FrmSizeReport3: TFrmSizeReport3;
...
procedure TFrmSizeReport3.ppSummaryBand1BeforePrint(Sender: TObject);
var
  i:integer;
begin
  ppmemo1.Lines.clear;
...
procedure TFrmSizeReport3.ppDetailBand1BeforePrint(Sender: TObject);
begin
...
procedure TFrmSizeReport3.ppReport1PreviewFormCreate(Sender: TObject);
begin
