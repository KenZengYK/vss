...
begin
  ...
  try
  btn2.enabled:=false; btn4.enabled:=false;
  lblr8.caption:='';
  ...
  with query1 do begin
    ...
    if fieldbyname('r7').value=true then btn4.enabled:=true else btn4.enabled:=false;
...
begin
  ...
  frmsz_img.label1.caption:='Library';
  frmsz_img.speedbutton6.enabled:=true;
  frmsz_img.show;
end;
