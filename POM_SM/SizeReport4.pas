...
var
  FrmSizeReport4: TFrmSizeReport4;
...
procedure TFrmSizeReport4.ppSummaryBand1BeforePrint(Sender: TObject);
var
  i:integer;
begin
  ppmemo1.Lines.clear;
...
procedure TFrmSizeReport4.ppDetailBand1BeforePrint(Sender: TObject);
begin
...
procedure TFrmSizeReport4.ppReport1PreviewFormCreate(Sender: TObject);
begin
