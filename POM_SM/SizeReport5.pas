...
var
  FrmSizeReport5: TFrmSizeReport5;
...
procedure TFrmSizeReport5.ppSummaryBand1BeforePrint(Sender: TObject);
var
  i:integer;
begin
  ppmemo1.Lines.clear;
...
procedure TFrmSizeReport5.ppDetailBand1BeforePrint(Sender: TObject);
begin
...
procedure TFrmSizeReport5.ppReport1PreviewFormCreate(Sender: TObject);
begin
