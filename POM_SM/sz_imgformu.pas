...
begin
  try
    if label1.caption='Library' then begin
      ...
      if not frmhistory.Table1.fieldbyname('img').isnull then begin
        if frmhistory.table1.fieldbyname('img').value>'' then
        cximage1.Picture.LoadFromFile(frmhistory.Table1.fieldbyname('img').value);
      end;
    end;
  except
