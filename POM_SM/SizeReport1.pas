...
var
  FrmSizeReport1: TFrmSizeReport1;
...
procedure TFrmSizeReport1.ppSummaryBand1BeforePrint(Sender: TObject);
var
  i:integer;
begin
  ppmemo1.Lines.clear;
...
procedure TFrmSizeReport1.ppDetailBand1BeforePrint(Sender: TObject);
begin
...
procedure TFrmSizeReport1.ppReport1PreviewFormCreate(Sender: TObject);
begin
