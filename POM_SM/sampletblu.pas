...
//     query2.prepare;
     ...
     begin
      if not query2.fieldbyname('size1').isnull then
       dbgrideh2.Columns[6].Title.caption:='¤Ø½X|'+query2.fieldbyname('size1').value
      else dbgrideh2.columns[6].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size2').isnull then
       dbgrideh2.Columns[7].Title.caption:='¤Ø½X|'+query2.fieldbyname('size2').value
      else dbgrideh2.columns[7].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size3').isnull then
       dbgrideh2.Columns[8].Title.caption:='¤Ø½X|'+query2.fieldbyname('size3').value
      else dbgrideh2.columns[8].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size4').isnull then
       dbgrideh2.Columns[9].Title.caption:='¤Ø½X|'+query2.fieldbyname('size4').value
      else dbgrideh2.columns[9].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size5').isnull then
       dbgrideh2.Columns[10].Title.caption:='¤Ø½X|'+query2.fieldbyname('size5').value
      else dbgrideh2.columns[10].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size6').isnull then
       dbgrideh2.Columns[11].Title.caption:='¤Ø½X|'+query2.fieldbyname('size6').value
      else dbgrideh2.columns[11].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size7').isnull then
       dbgrideh2.Columns[19].Title.caption:='¤Ø½X|'+query2.fieldbyname('size7').value
      else dbgrideh2.columns[19].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size8').isnull then
       dbgrideh2.Columns[20].Title.caption:='¤Ø½X|'+query2.fieldbyname('size8').value
      else dbgrideh2.columns[20].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size9').isnull then
       dbgrideh2.Columns[21].Title.caption:='¤Ø½X|'+query2.fieldbyname('size9').value
      else dbgrideh2.columns[21].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size10').isnull then
       dbgrideh2.Columns[22].Title.caption:='¤Ø½X|'+query2.fieldbyname('size10').value
      else dbgrideh2.columns[22].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size11').isnull then
       dbgrideh2.Columns[23].Title.caption:='¤Ø½X|'+query2.fieldbyname('size11').value
      else dbgrideh2.columns[23].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size12').isnull then
       dbgrideh2.Columns[24].Title.caption:='¤Ø½X|'+query2.fieldbyname('size12').value
      else dbgrideh2.columns[24].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size13').isnull then
       dbgrideh2.Columns[32].Title.caption:='¤Ø½X|'+query2.fieldbyname('size13').value
      else dbgrideh2.columns[32].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size14').isnull then
       dbgrideh2.Columns[33].Title.caption:='¤Ø½X|'+query2.fieldbyname('size14').value
      else dbgrideh2.columns[33].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size15').isnull then
       dbgrideh2.Columns[34].Title.caption:='¤Ø½X|'+query2.fieldbyname('size15').value
      else dbgrideh2.columns[34].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size16').isnull then
       dbgrideh2.Columns[35].Title.caption:='¤Ø½X|'+query2.fieldbyname('size16').value
      else dbgrideh2.columns[35].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size17').isnull then
       dbgrideh2.Columns[36].Title.caption:='¤Ø½X|'+query2.fieldbyname('size17').value
      else dbgrideh2.columns[36].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size18').isnull then
       dbgrideh2.Columns[37].Title.caption:='¤Ø½X|'+query2.fieldbyname('size18').value
      else dbgrideh2.columns[37].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size19').isnull then
       dbgrideh2.Columns[44].Title.caption:='¤Ø½X|'+query2.fieldbyname('size19').value
      else dbgrideh2.columns[44].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size20').isnull then
       dbgrideh2.Columns[45].Title.caption:='¤Ø½X|'+query2.fieldbyname('size20').value
      else dbgrideh2.columns[45].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size21').isnull then
       dbgrideh2.Columns[46].Title.caption:='¤Ø½X|'+query2.fieldbyname('size21').value
      else dbgrideh2.columns[46].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size22').isnull then
       dbgrideh2.Columns[47].Title.caption:='¤Ø½X|'+query2.fieldbyname('size22').value
      else dbgrideh2.columns[47].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size23').isnull then
       dbgrideh2.Columns[48].Title.caption:='¤Ø½X|'+query2.fieldbyname('size23').value
      else dbgrideh2.columns[48].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size24').isnull then
       dbgrideh2.Columns[49].Title.caption:='¤Ø½X|'+query2.fieldbyname('size24').value
      else dbgrideh2.columns[49].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size25').isnull then
       dbgrideh2.Columns[56].Title.caption:='¤Ø½X|'+query2.fieldbyname('size25').value
      else dbgrideh2.columns[56].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size26').isnull then
       dbgrideh2.Columns[57].Title.caption:='¤Ø½X|'+query2.fieldbyname('size26').value
      else dbgrideh2.columns[57].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size27').isnull then
       dbgrideh2.Columns[58].Title.caption:='¤Ø½X|'+query2.fieldbyname('size27').value
      else dbgrideh2.columns[58].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size28').isnull then
       dbgrideh2.Columns[59].Title.caption:='¤Ø½X|'+query2.fieldbyname('size28').value
      else dbgrideh2.columns[59].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size29').isnull then
       dbgrideh2.Columns[60].Title.caption:='¤Ø½X|'+query2.fieldbyname('size29').value
      else dbgrideh2.columns[60].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size30').isnull then
       dbgrideh2.Columns[61].Title.caption:='¤Ø½X|'+query2.fieldbyname('size30').value
      else dbgrideh2.columns[61].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size31').isnull then
       dbgrideh2.Columns[68].Title.caption:='¤Ø½X|'+query2.fieldbyname('size31').value
      else dbgrideh2.columns[68].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size32').isnull then
       dbgrideh2.Columns[69].Title.caption:='¤Ø½X|'+query2.fieldbyname('size32').value
      else dbgrideh2.columns[69].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size33').isnull then
       dbgrideh2.Columns[70].Title.caption:='¤Ø½X|'+query2.fieldbyname('size33').value
      else dbgrideh2.columns[70].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size34').isnull then
       dbgrideh2.Columns[71].Title.caption:='¤Ø½X|'+query2.fieldbyname('size34').value
      else dbgrideh2.columns[71].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size35').isnull then
       dbgrideh2.Columns[72].Title.caption:='¤Ø½X|'+query2.fieldbyname('size35').value
      else dbgrideh2.columns[72].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('size36').isnull then
       dbgrideh2.Columns[73].Title.caption:='¤Ø½X|'+query2.fieldbyname('size36').value
      else dbgrideh2.columns[73].title.caption:='¤Ø½X| ';
     end;
    end;
  end
  else begin
...
begin
  ...
  begin
   if pos('-',opendialog1.filename)>0 then begin
     application.MessageBox('¦¹¤å¥ó¦W«Dªk,½Ð­«·s©R¦W©Î­«·s¿ï¾Ü¹Ï¤ù¤å¥ó!','Äµ§i',mb_iconwarning);
   end
   else begin
