...
begin
  if application.messagebox('­n¨ú®ø¦¹´Ú¤Ø¤oªíªº½T»{«H®§¶Ü?','´£¥Ü«H®§',mb_iconquestion+mb_yesno)=idyes then begin
    ...
    showmessage('½T»{¤w¨ú®ø¡A»Ý­n­«·s½T»{¦¹´Ú¤Ø¤oªí¡I');
  end;
end;
...
begin
  ...
  begin
    if application.messagebox('­n§R°£¦¹´Ú¤Ø¤oªí¶Ü?','´£¥Ü«H®§',mb_iconquestion+mb_okcancel)=idok then
    begin
      query1.close;
      query1.params.clear;
   ...
   begin
    ...
    begin
      if not query2.fieldbyname('csiz1').isnull then
       dbgrideh2.Columns[13].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz1').value
      else dbgrideh2.columns[13].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz2').isnull then
       dbgrideh2.Columns[14].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz2').value
      else dbgrideh2.columns[14].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz3').isnull then
       dbgrideh2.Columns[15].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz3').value
      else dbgrideh2.columns[15].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz4').isnull then
       dbgrideh2.Columns[16].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz4').value
      else dbgrideh2.columns[16].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz5').isnull then
       dbgrideh2.Columns[17].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz5').value
      else dbgrideh2.columns[17].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz6').isnull then
       dbgrideh2.Columns[18].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz6').value
      else dbgrideh2.columns[18].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz7').isnull then
       dbgrideh2.Columns[19].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz7').value
      else dbgrideh2.columns[19].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz8').isnull then
       dbgrideh2.Columns[20].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz8').value
      else dbgrideh2.columns[20].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz9').isnull then
       dbgrideh2.Columns[21].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz9').value
      else dbgrideh2.columns[21].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz10').isnull then
       dbgrideh2.Columns[22].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz10').value
      else dbgrideh2.columns[22].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz11').isnull then
       dbgrideh2.Columns[23].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz11').value
      else dbgrideh2.columns[23].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz12').isnull then
       dbgrideh2.Columns[24].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz12').value
      else dbgrideh2.columns[24].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz13').isnull then
       dbgrideh2.Columns[25].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz13').value
      else dbgrideh2.columns[25].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz14').isnull then
       dbgrideh2.Columns[26].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz14').value
      else dbgrideh2.columns[26].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz15').isnull then
       dbgrideh2.Columns[27].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz15').value
      else dbgrideh2.columns[27].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz16').isnull then
       dbgrideh2.Columns[28].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz16').value
      else dbgrideh2.columns[28].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz17').isnull then
       dbgrideh2.Columns[29].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz17').value
      else dbgrideh2.columns[29].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz18').isnull then
       dbgrideh2.Columns[30].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz18').value
      else dbgrideh2.columns[30].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz19').isnull then
       dbgrideh2.Columns[31].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz19').value
      else dbgrideh2.columns[31].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz20').isnull then
       dbgrideh2.Columns[32].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz20').value
      else dbgrideh2.columns[32].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz21').isnull then
       dbgrideh2.Columns[33].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz21').value
      else dbgrideh2.columns[33].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz22').isnull then
       dbgrideh2.Columns[34].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz22').value
      else dbgrideh2.columns[34].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz23').isnull then
       dbgrideh2.Columns[35].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz23').value
      else dbgrideh2.columns[35].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz24').isnull then
       dbgrideh2.Columns[36].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz24').value
      else dbgrideh2.columns[36].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz25').isnull then
       dbgrideh2.Columns[37].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz25').value
      else dbgrideh2.columns[37].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz26').isnull then
       dbgrideh2.Columns[38].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz26').value
      else dbgrideh2.columns[38].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz27').isnull then
       dbgrideh2.Columns[39].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz27').value
      else dbgrideh2.columns[39].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz28').isnull then
       dbgrideh2.Columns[40].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz28').value
      else dbgrideh2.columns[40].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz29').isnull then
       dbgrideh2.Columns[41].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz29').value
      else dbgrideh2.columns[41].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz30').isnull then
       dbgrideh2.Columns[42].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz30').value
      else dbgrideh2.columns[42].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz31').isnull then
       dbgrideh2.Columns[43].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz31').value
      else dbgrideh2.columns[43].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz32').isnull then
       dbgrideh2.Columns[44].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz32').value
      else dbgrideh2.columns[44].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz33').isnull then
       dbgrideh2.Columns[45].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz33').value
      else dbgrideh2.columns[45].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz34').isnull then
       dbgrideh2.Columns[46].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz34').value
      else dbgrideh2.columns[46].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz35').isnull then
       dbgrideh2.Columns[47].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz35').value
      else dbgrideh2.columns[47].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz36').isnull then
       dbgrideh2.Columns[48].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz36').value
      else dbgrideh2.columns[48].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz37').isnull then
       dbgrideh2.Columns[49].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz37').value
      else dbgrideh2.columns[49].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz38').isnull then
       dbgrideh2.Columns[50].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz38').value
      else dbgrideh2.columns[50].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz39').isnull then
       dbgrideh2.Columns[51].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz39').value
      else dbgrideh2.columns[51].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz40').isnull then
       dbgrideh2.Columns[52].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz40').value
      else dbgrideh2.columns[52].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz41').isnull then
       dbgrideh2.Columns[53].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz41').value
      else dbgrideh2.columns[53].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz42').isnull then
       dbgrideh2.Columns[54].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz42').value
      else dbgrideh2.columns[54].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz43').isnull then
       dbgrideh2.Columns[55].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz43').value
      else dbgrideh2.columns[55].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz44').isnull then
       dbgrideh2.Columns[56].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz44').value
      else dbgrideh2.columns[56].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz45').isnull then
       dbgrideh2.Columns[57].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz45').value
      else dbgrideh2.columns[57].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz46').isnull then
       dbgrideh2.Columns[58].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz46').value
      else dbgrideh2.columns[58].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz47').isnull then
       dbgrideh2.Columns[59].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz47').value
      else dbgrideh2.columns[59].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz48').isnull then
       dbgrideh2.Columns[60].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz48').value
      else dbgrideh2.columns[60].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz49').isnull then
       dbgrideh2.Columns[61].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz49').value
      else dbgrideh2.columns[61].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz50').isnull then
       dbgrideh2.Columns[62].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz50').value
      else dbgrideh2.columns[62].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz51').isnull then
       dbgrideh2.Columns[63].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz51').value
      else dbgrideh2.columns[63].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz52').isnull then
       dbgrideh2.Columns[64].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz52').value
      else dbgrideh2.columns[64].title.caption:='¤Ø½X| ';
...
//     query2.prepare;
     ...
     begin
      if not query2.fieldbyname('csiz1').isnull then
       dbgrideh3.Columns[9].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz1').value
      else dbgrideh3.columns[9].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz2').isnull then
       dbgrideh3.Columns[10].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz2').value
      else dbgrideh3.columns[10].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz3').isnull then
       dbgrideh3.Columns[11].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz3').value
      else dbgrideh3.columns[11].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz4').isnull then
       dbgrideh3.Columns[12].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz4').value
      else dbgrideh3.columns[12].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz5').isnull then
       dbgrideh3.Columns[13].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz5').value
      else dbgrideh3.columns[13].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz6').isnull then
       dbgrideh3.Columns[14].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz6').value
      else dbgrideh3.columns[14].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz7').isnull then
       dbgrideh3.Columns[15].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz7').value
      else dbgrideh3.columns[15].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz8').isnull then
       dbgrideh3.Columns[16].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz8').value
      else dbgrideh3.columns[16].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz9').isnull then
       dbgrideh3.Columns[17].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz9').value
      else dbgrideh3.columns[17].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz10').isnull then
       dbgrideh3.Columns[18].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz10').value
      else dbgrideh3.columns[18].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz11').isnull then
       dbgrideh3.Columns[19].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz11').value
      else dbgrideh3.columns[19].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz12').isnull then
       dbgrideh3.Columns[20].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz12').value
      else dbgrideh3.columns[20].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz13').isnull then
       dbgrideh3.Columns[21].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz13').value
      else dbgrideh3.columns[21].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz14').isnull then
       dbgrideh3.Columns[22].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz14').value
      else dbgrideh3.columns[22].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz15').isnull then
       dbgrideh3.Columns[23].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz15').value
      else dbgrideh3.columns[23].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz16').isnull then
       dbgrideh3.Columns[24].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz16').value
      else dbgrideh3.columns[24].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz17').isnull then
       dbgrideh3.Columns[25].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz17').value
      else dbgrideh3.columns[25].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz18').isnull then
       dbgrideh3.Columns[26].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz18').value
      else dbgrideh3.columns[26].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz19').isnull then
       dbgrideh3.Columns[27].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz19').value
      else dbgrideh3.columns[27].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz20').isnull then
       dbgrideh3.Columns[28].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz20').value
      else dbgrideh3.columns[28].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz21').isnull then
       dbgrideh3.Columns[29].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz21').value
      else dbgrideh3.columns[29].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz22').isnull then
       dbgrideh3.Columns[30].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz22').value
      else dbgrideh3.columns[30].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz23').isnull then
       dbgrideh3.Columns[31].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz23').value
      else dbgrideh3.columns[31].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz24').isnull then
       dbgrideh3.Columns[32].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz24').value
      else dbgrideh3.columns[32].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz25').isnull then
       dbgrideh3.Columns[33].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz25').value
      else dbgrideh3.columns[33].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz26').isnull then
       dbgrideh3.Columns[34].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz26').value
      else dbgrideh3.columns[34].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz27').isnull then
       dbgrideh3.Columns[35].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz27').value
      else dbgrideh3.columns[35].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz28').isnull then
       dbgrideh3.Columns[36].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz28').value
      else dbgrideh3.columns[36].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz29').isnull then
       dbgrideh3.Columns[37].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz29').value
      else dbgrideh3.columns[37].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz30').isnull then
       dbgrideh3.Columns[38].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz30').value
      else dbgrideh3.columns[38].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz31').isnull then
       dbgrideh3.Columns[39].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz31').value
      else dbgrideh3.columns[39].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz32').isnull then
       dbgrideh3.Columns[40].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz32').value
      else dbgrideh3.columns[40].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz33').isnull then
       dbgrideh3.Columns[41].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz33').value
      else dbgrideh3.columns[41].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz34').isnull then
       dbgrideh3.Columns[42].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz34').value
      else dbgrideh3.columns[42].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz35').isnull then
       dbgrideh3.Columns[43].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz35').value
      else dbgrideh3.columns[43].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz36').isnull then
       dbgrideh3.Columns[44].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz36').value
      else dbgrideh3.columns[44].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz37').isnull then
       dbgrideh3.Columns[45].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz37').value
      else dbgrideh3.columns[45].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz38').isnull then
       dbgrideh3.Columns[46].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz38').value
      else dbgrideh3.columns[46].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz39').isnull then
       dbgrideh3.Columns[47].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz39').value
      else dbgrideh3.columns[47].title.caption:='¤Ø½X| ';
      if not query2.fieldbyname('csiz40').isnull then
       dbgrideh3.Columns[48].Title.caption:='¤Ø½X|'+query2.fieldbyname('csiz40').value
      else dbgrideh3.columns[48].title.caption:='¤Ø½X| ';
     end;
...
begin
  ...
  begin
    if table3methd.value='ª½½u«×' then table3emethd.value:='Strgt'
    else if table3methd.value='ªuÃä«×' then table3emethd.value:='Edge'
    else if table3methd.value='¤â©Ô«×' then table3emethd.value:='H.Strch'
    else if table3methd.value='©·½u«×' then table3emethd.value:='Curve'
    else if table3methd.value='¾÷©Ô«×' then table3emethd.value:='M.Strch'
    else if table3methd.value='¯¯©Ô«×' then table3emethd.value:='S.Strch';
    {
    ...
    begin
     ...
     begin
      if table3methd.value='ª½«×' then
      begin
       table3emethd.value:='Strt.';
      end
      else
      begin
       if table3methd.value='§é«×' then
        table3emethd.value:='Refl.'
       else if table3methd.value='©Ô«×' then
...
begin
  ...
  begin
    if application.messagebox('½T©w­n¨ú®ø­×§ï¶Ü?','´£¥Ü«H®§',mb_iconquestion+mb_okcancel)=idok then
    begin
...
begin
    if application.messagebox('­n§R°£¦¹¤Ø¤o¶Ü?','´£¥Ü«H®§',mb_iconquestion+mb_okcancel)=idok then
    begin
      //table3.delete;
      with query1 do begin
        close;
