...
uses
  ...
  cxGrid, cxContainer, cxImage, StdCtrls, DBCtrls, Mask, cxGridExportLink;
...
uses loginu, mainu, libraryu, sz_imgformu;
...
procedure Tfrmhistory.btn5Click(Sender: TObject);
begin
  try
...
procedure Tfrmhistory.cxImage1DblClick(Sender: TObject);
begin
  if frmsz_img=nil then frmsz_img:=tfrmsz_img.create(nil);
  frmsz_img.dbedit8.datasource:=DataSource1;
  frmsz_img.label1.caption:='History';
  frmsz_img.speedbutton6.enabled:=false;
  frmsz_img.show;
end;
