...
var
  FrmsampleReport1: TFrmsampleReport1;
...
procedure TFrmsampleReport1.ppSummaryBand3BeforePrint(Sender: TObject);
var
  i:integer;
begin
  ppmemo6.Lines.clear;
...
procedure TFrmsampleReport1.ppReport2PreviewFormCreate(Sender: TObject);
begin
