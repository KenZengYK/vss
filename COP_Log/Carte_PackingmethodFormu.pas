...
type
  TfrmCarte_Packingmethod = class(TForm)
    ...
    cxGrid1prd_mm: TcxGridDBBandedColumn;
    cxGrid1prd_ml: TcxGridDBBandedColumn;
    cxGrid1pak_typ: TcxGridDBBandedColumn;
    cxGrid1pak_bx1: TcxGridDBBandedColumn;
    cxGrid1pak_bx2a: TcxGridDBBandedColumn;
    cxGrid1pak_bx2b: TcxGridDBBandedColumn;
    cxGrid1pak_p1: TcxGridDBBandedColumn;
    cxGrid1pak_p2a: TcxGridDBBandedColumn;
    cxGrid1pak_p2b: TcxGridDBBandedColumn;
