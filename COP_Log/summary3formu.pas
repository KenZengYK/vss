...
uses
  ...
  Dialogs, ppBands, ppClass, ppStrtch, ppRichTx, ppCtrls, ppVar, ppPrnabl,
  ppCache, ppProd, ppReport, ppDB, ppComm, ppRelatv, ppDBPipe, DB, DBClient,
  ppViewr, jpeg, ppParameter;

type
  Tfrmsummary3 = class(TForm)
...
procedure Tfrmsummary3.ppSummaryBand1BeforePrint(Sender: TObject);
var
...
procedure Tfrmsummary3.ppGroupFooterBand2BeforePrint(Sender: TObject);
var
  dft,dft1,x1,x2,i:integer;
begin
  dft:=0;dft1:=0;x1:=0;x2:=0;i:=0;
...
procedure Tfrmsummary3.ppReport1PreviewFormCreate(Sender: TObject);
begin
