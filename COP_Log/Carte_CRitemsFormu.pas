...
begin
  ...
  frmCarte_Chaseitems.caption:='物料跟進行動誌明細表 (追料或補料) - 工作表';
...
begin
  if adodataset1.active then begin
    ...
    with adodataset1 do begin
      close;
      commandtext:='exec sp_carte_genchaseitems_new1 :x1,:x2';
      parameters[0].value:=seq31;
...
procedure TfrmCarte_CRitems.ppSummaryBand1BeforePrint(Sender: TObject);
begin
  with adoquery1 do begin
    close;
