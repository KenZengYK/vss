...
procedure TfrmCarte_Repenquery.Edit1Change(Sender: TObject);
begin
  //
end;
...
begin
  with adodataset1 do begin
    ...
    commandtext:='select distinct a.formno,substring(a.itemcode,1,3) as item_type,a.supplier,substring(a.color,1,3) as item_color,'
                +'sum(a.blnum) as item_qty,a.unit,b.verifyitemvalue from [ph.materialsupplement]..msasupplementmaterial a,[ph.materialsupplement]..verifyitemvalue b '
