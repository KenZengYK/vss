unit aqlreport5formu;

interface

uses
  Windows, Messages, SysUtils, Variants, Classes, Graphics, Controls, Forms,
  Dialogs, DB, DBClient, ppBands, jpeg, ppVar, ppCtrls, ppClass, ppPrnabl,
  ppCache, ppProd, ppReport, ppDB, ppComm, ppRelatv, ppDBPipe, ppViewr,
  ppParameter;

type
  Tfrmaqlreport5 = class(TForm)
...
procedure Tfrmaqlreport5.ppHeaderBand1BeforePrint(Sender: TObject);
var
  s1:string;
  edef1,edef2:string;
  i:integer;
...
procedure Tfrmaqlreport5.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppReport1.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport1.PreviewForm.Viewer).Zoompercentage:=100;
end;

procedure Tfrmaqlreport5.ppGroupHeaderBand1BeforePrint(Sender: TObject);
begin
  with query1 do begin
    close;
    params.clear;
