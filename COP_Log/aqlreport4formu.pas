...
uses
  ...
  ppReport, ppStrtch, ppSubRpt, ppPrnabl, ppCache, ppProd, ppDB, ppComm,
  ppRelatv, ppDBPipe, StdCtrls, ExtCtrls, ppViewr, myChkBox, ppParameter;

type
  Tfrmaqlreport4 = class(TForm)
...
procedure Tfrmaqlreport4.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppReport1.PreviewForm.WindowState:=wsMaximized;
  TppViewer(ppReport1.PreviewForm.Viewer).Zoompercentage:=100;
end;

procedure Tfrmaqlreport4.ppGroupHeaderBand1BeforePrint(Sender: TObject);
var
  s1:string;
  i:integer;
...
begin
    ...
    if frmaqlmain.qry_s0.FieldByName('dailyaql').value=false then begin
      ppshape8.Visible:=false;
      ...
      acc001.Visible:=false;
      acc002.Visible:=false;
      acc003.Visible:=false;
      acc004.Visible:=false;
      rej001.Visible:=false;
      rej002.Visible:=false;
      pplabel6.Visible:=true;
      ppdbtext60.Visible:=true;
      ppshape60.Visible:=true;
    end else begin
      ppshape8.Visible:=true;
  ...
  with query1 do begin
    ...
    if fieldbyname('q1').isnull then begin
      ...
      if frmaqlmain.qry_s0.fieldbyname('dailyaql').value=true then begin
    ...
    if not fieldbyname('q2').isnull then begin
      sd006.Caption:=fieldbyname('q2').asstring;
      if frmaqlmain.qry_s0.fieldbyname('dailyaql').value=true then begin
        if fieldbyname('q2').value>=mqty2 then begin
          acc002.Visible:=false;
          rej002.Visible:=true;
        end else begin
          acc002.Visible:=true;
  ...
  acc003.Caption:=frmaqlmain.qry_s0.fieldbyname('sqty1').asstring;
  acc004.Caption:=inttostr(mqty1);
