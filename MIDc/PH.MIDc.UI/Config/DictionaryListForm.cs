...
{
    public partial class DictionaryListForm : PH.Platform.UI.CS.UI2.ListForm
    {
        public string Deftype { get; set; }

        public DictionaryListForm()
        {
            InitializeComponent();
        ...
        public DictionaryListForm(string deftype)
        {
            InitializeComponent();
            Deftype = deftype;
        ...
        public override void DataBind()
        {
            ...
            this.EditorTypeName = typeof(DictionaryDetailForm).FullName;
