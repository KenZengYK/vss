...
{
    public partial class MaterialListbySuppReport : PH.Platform.UI.CS.UI0.BlankForm
    {
        public MaterialListbySuppReport()
        {
            InitializeComponent();
        }
        ...
        {
            if (string.IsNullOrEmpty(this.jobMaterialListbySuppReport1.Supp))
            {
        ...
        void PrintReport()
        {
            ...
            data.ClassFullName = typeof(PH.MIDc.BackEnd.JobMaterialListbySuppReport).FullName;//報表全名
            data.JobName = string.Format("MaterialList:(Supp-{0}-{1})", jobMaterialListbySuppReport1.Supp, jobMaterialListbySuppReport1.GroupStatusStudyRun ? "Study,Test&Run" : "Hold,Stop&Drop");//JOB名稱 
            ...
            data.Parameter = this.jobMaterialListbySuppReport1.GetParameter();
            data.RunServer = "SL";
