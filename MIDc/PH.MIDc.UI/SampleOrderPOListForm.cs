...
{
    public partial class SampleOrderPOListForm : PH.UI.UI2.ParentListForm
    {
        #region
        ...
        private void SetPOState(string state)
        {
            ...
            //PH.MIDc.BO.SampleOrderPO ms = this.CurBindingSource as (PH.MIDc.BO.SampleOrderPO);
            //if (m == null) return;
            foreach (PH.MIDc.BO.SampleOrderPO m in this.CurBindingSource)
            {
                if (m.Selected)
                    m.POState = state;
            }
            this.DataContext.SubmitChanges();
            //PH.Common.UI.Grid.PostGridValue(this.objListGridView);
            //foreach (PH.MIDc.BO.SampleOrderPO m in ((List<PH.MIDc.BO.SampleOrderPO>)this.curBindingSource.DataSource))
            //{
            //    if (m.Selected)
            //    {
            //       // m.BeginEdit();
        ...
        private void SampleOrderPOListForm_Load(object sender, EventArgs e)
        {
            PH.MIDc.BO.MIDcDataContext context = new PH.MIDc.BO.MIDcDataContext();
            this.DataContext = context;
            this.CurBindingSource.DataSource = from sapleorderpo in context.SampleOrderPOs select sapleorderpo;
        ...
        private void InitializeComponent()
        {
            ...
            // sampleOrderPOColumn
            // 
            this.sampleOrderPOColumn.Caption = "Sample Order PO";
            this.sampleOrderPOColumn.FieldName = "SampleOrderPO1";
            ...
            // sampleOrderColumn
            // 
            this.sampleOrderColumn.Caption = "Sample Order";
            this.sampleOrderColumn.FieldName = "SampleOrder";
            ...
            this.pO_DateColumn.FieldName = "PO Date";
            ...
            this.Load += new System.EventHandler(this.SampleOrderPOListForm_Load);
        ...
        {
            PH.MIDc.BO.SampleOrderPO m = (PH.MIDc.BO.SampleOrderPO)this.CurBindingSource.Current;
            if (m == null) return;
