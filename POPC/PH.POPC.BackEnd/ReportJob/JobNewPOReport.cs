...
{
    public partial class JobNewPOReport : UserControl, PH.Platform.BackEnd.BO.IServerReport, PH.Platform.BackEnd.BO.IParameterSetControl
    {

        public JobNewPOReport()
        {
            InitializeComponent();
            Area = "SL";
            _langID = "EN";
        ...
        public DevExpress.XtraReports.UI.XtraReport CreateReport(string parameters)
        {
            ...
            foreach (var item in this.Headers)
            {
                ...
                //_isDetailReport = item.MIDcDimensionDesc != "3Ds";
        ...
        {
            JobNewPOReport ctl = new JobNewPOReport();
