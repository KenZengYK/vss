...
{
    public partial class StickerPOReportEN : DevExpress.XtraReports.UI.XtraReport
    {
        public StickerPOReportEN()
        {
            InitializeComponent();
        }

        public StickerPOReportEN(object ADataSource, PH.POPC.BO.POHeader AHeader)
        {
            InitializeComponent();
        ...
        public StickerPOReportEN(List<PH.POPC.BO.POHeader> list, POPC.BO.POHeader poheader, string ReportName)
        {
            InitializeComponent();
