...
{
    public partial class ColloidPOReportCH : DevExpress.XtraReports.UI.XtraReport
    {
        public ColloidPOReportCH()
        {
            InitializeComponent();
        }

        private POPC.BO.POHeader _poheader;
        public ColloidPOReportCH(List<PH.POPC.BO.POHeader> list, POPC.BO.POHeader poheader)
        {
            InitializeComponent();
