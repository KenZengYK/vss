...
namespace PH.POPC.BackEnd.PO.SupplementSheet.EN
{
    /// <summary>
    /// Summary description for pcnReport
    /// </summary>
    public class Sub4DReport : DevExpress.XtraReports.UI.XtraReport
    {
        #region Designer
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Sub4DReport));
            ...
            this.pivotGridColumn1.HeaderText = "Our Item#";
            ...
            this.xrTableRow2});
            this.xrTable2.Size = new System.Drawing.Size(765, 18);
            ...
            this.xrTableCell1.Text = "WO# (if any): [PODetail.WorkOrderNo]";
            // 
            // cellDelivery
            // 
            ...
            this.xrTableCell4.Text = "End Cust Order No (if any):";
            // 
            // xrTableCell20
            // 
            ...
            this.xrLabel1.Text = "Notepad 2:- The Our Size or Size/cup of abv should  be same as the end Cust garme" +
                "nt label size or label size/cup.";
            // 
            // Sub4DReport
            // 
        ...
        public Sub4DReport(bool isPHCopy, bool isVatPrint, bool isScO, string langID, bool isDometisPrint, string AReportTitleType)
            : this()
        {
            _isPHCopy = isPHCopy;
        ...
        private void OnBeforePrint_Item(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            PH.POPC.BackEnd.PO.SupplementSheet.EN.Sub4DReport report1 = report.Tag as PH.POPC.BackEnd.PO.SupplementSheet.EN.Sub4DReport;
        ...
        private void pcn4DReport_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            string dll_2 = typeof(Sub4DReport).Assembly.Location;
        ...
        private void SetTitleInfor(POColorSizeDetail p)
        {
            ...
            this.lbCompanyGroup.Size = this._isDometisPrint ? new Size(152, 25) : new Size(234, 25);
            if (!this._isDometisPrint)
            {
