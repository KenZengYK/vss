...
namespace PH.POPC.BackEnd.PO.Share
{
    /// <summary>
    ...
    public class poErrorReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public poErrorReport(string pono, string langID)
            : this()
        {
            _pono = pono;
            _langID = langID;
        ...
        private void InitializeComponent()
        {
            ...
            this.lbWarn = new DevExpress.XtraReports.UI.XRLabel();
            ...
            // lbWarn
            // 
            this.lbWarn.Location = new System.Drawing.Point(142, 83);
            this.lbWarn.Name = "lbWarn";
            this.lbWarn.Padding = new DevExpress.XtraPrinting.PaddingInfo(2, 2, 0, 0, 100F);
            this.lbWarn.Size = new System.Drawing.Size(373, 36);
            this.lbWarn.StyleName = "csHeader2";
            this.lbWarn.Text = "Warning";
            // 
            // lblTips
            // 
        ...
        {
            lbWarn.Text = _langID == "EN" ? "Warning" : "警告";
            lblTips.Text = _langID == "EN" ?
                string.Format("\"Location of Supplier Facotry\" cannot blank,\r\nbefore print po [ {0} ] report, \r\nplease fill in \"Location of Supplier Facotry\".", this._pono)
                : string.Format("\"供應商工廠所在地\"不能為空值,\r\n在打印采購單 [ {0} ] 報表之前, \r\n請填寫好\"供應商工廠所在地\".", this._pono);
