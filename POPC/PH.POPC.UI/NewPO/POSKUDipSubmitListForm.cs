...
namespace PH.POPC.UI.NewPO
{
    public partial class POSKUDipSubmitListForm : PH.Platform.UI.CS.UI2.ListForm
    {
        ...
        {
            InitializeComponent();
            this.EditorTypeName = typeof(POSKUDipSubmitDetailForm).FullName;
        ...
        public POSKUDipSubmitListForm(object pur, DevExpress.XtraTab.XtraTabPage parentPage)
            : this()
        {
            #region Get infor
        ...
        private void SetValue()
        {
            ...
            //PH.POPC.BO.POSKUOperate item = this._lists.Where(p => p.HandleNo == LotNO && p.HandleType == Common.DipSubmit).FirstOrDefault();

            //this._PUR.DipSeq = null;
            //this._PUR.DipReceiptDate = null;
            //this._PUR.DipCompletedDate = null;
            //this._PUR.DipStatus = null;
            //this._PUR.DipReceiptDate = null;
            //this._PUR.DipDropDeadDate = null;
            //if (item != null)
            //{
            //    this._PUR.DipSeq = item.HandleNo;
            //    this._PUR.DipReceiptDate = item.ReceiveDate;
            //    this._PUR.DipCompletedDate = item.OperateDate;
            //    this._PUR.DipStatus = item.Status;
            //    this._PUR.DipReceiptDate = item.ReceiveDate;
            //    this._PUR.DipDropDeadDate = item.DipDropDeadDate;
            //}
