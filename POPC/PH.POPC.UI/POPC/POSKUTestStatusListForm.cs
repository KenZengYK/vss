...
namespace PH.POPC.UI
{
    public partial class POSKUTestStatusListForm : PH.Platform.UI.CS.UI2.ListForm
    {
        ...
        public POSKUTestStatusListForm(object pur, DevExpress.XtraTab.XtraTabPage parentPage, PH.POPC.UI.POInfo poinfo)
            : this()
        {
            _poinfo = poinfo;
            #region Get infor
            ...
            this.objListGridView.ActiveFilterString = string.Format("[HandleType] = '{0}'", PH.POPC.BO.Common.TestStatus);
