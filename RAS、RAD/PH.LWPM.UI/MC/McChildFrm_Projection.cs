...
{
    public partial class McChildFrm_Projection : DetailForm
    {
        Boolean AddnewFlg;
        ...
        {
            this.barBtnAddNew.Visibility = (this.PrevForm as McPListFrm_Projection).ReadOnlyParam == "ReadOnly" ? BarItemVisibility.Never : BarItemVisibility.Always;
        ...
        protected override void OnClickSave()
        {
            ...
            if (_current.BOWorkMode == PH.Platform.BO.Interface.WorkMode.Edit)
            {
                ...
                _current.oldFactory = oldFactory;
                _current.UpdateTime = DateTime.Now;
            }
            if ((this.BindingSource.Current as Machine).BOWorkMode == PH.Platform.BO.Interface.WorkMode.New)
            {
                ...
                _current.PrepanedByName = PH.Platform.AuthMgr.BO.Environment.Instance.CurrentUser.UserID;
                _current.PrepanedByDate = DateTime.Now;
            }
            base.OnClickSave();
        ...
        public override void EditCurrent()
        {
            ...
            if (IsEditting)
            {
                ...
                if (mh.Class != null && mh.Class.Contains("Mc-Dead Stock Room"))
                {
                    MessageBox.Show("The machine has been scrapped,please to restored it first!");
                    return;
                }
                this.btnQuaDetail.Enabled = true;
            }

            if (IsNew)
            {
                McPListFrm_Projection _preform = this.PrevForm as McPListFrm_Projection;
                if (_preform.CurMenuParam == "Heavy")
                    mh.IsFix = true;
                else
                    mh.IsFix = false;
                mh.IsProjection = true;
            }
            ...
            //if (IsNew)
            //{
            //    string ParaMCWF = (this.ListForm as McPListFrm_Projection).ParaMFWF.Trim().ToString();
            ...
            base.EditCurrent();
            edtQuatation.Enabled = false;
            edtVNumber.Enabled = false;
        ...
        private void setSelectClsNameMethod()
        {
            if (AddnewFlg)
            {
                switch ((this.PrevForm as McPListFrm_Projection).GetTypeTitle)
                {
                    case "ALL":
                    ...
                    case "Sewing Direct M/C Cost":
                        (this.BindingSource.Current as PH.LWPM.BO.Machine).MCPartEn = (this.PrevForm as McPListFrm_Projection).GetTypeTitle;
                        (this.BindingSource.Current as PH.LWPM.BO.Machine).MCPartCn = publicLibary.getSelectIndex("MCPart", null, (this.PrevForm as McPListFrm_Projection).GetTypeTitle, this.DataContext);
                        break;
        ...
        private void bdtDateEdit_EditValueChanged(object sender, EventArgs e)
        {
        ...
        private void lblHeavy_Click(object sender, EventArgs e)
        {
        ...
        private void vndrLabel_Click(object sender, EventArgs e)
        {

        }

        private void vndrTextEdit_EditValueChanged(object sender, EventArgs e)
        {
        ...
        private void lblMachineClass_Click(object sender, EventArgs e)
        {
        ...
        private void type2Label_Click(object sender, EventArgs e)
        {

        }

        private void uYearLabel_Click(object sender, EventArgs e)
        {

        }

        private void bdtLabel_Click(object sender, EventArgs e)
        {

        }

        private void lblProjectionDate_Click(object sender, EventArgs e)
        {
        ...
        private void mcRatingLabel_Click(object sender, EventArgs e)
        {

        }

        private void lblIsRelated_Click(object sender, EventArgs e)
        {
        ...
        private void uYearSpinEdit_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void edProjDate_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void lineComboBoxEdit_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void cobMachineState_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void mcRatingComboBoxEdit_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void classComboBoxEdit_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void nameComboBoxEdit_SelectedIndexChanged(object sender, EventArgs e)
        {

        }

        private void btnQuaDetail_Click(object sender, EventArgs e)
        {
            Machine _current = this.BindingSource.Current as Machine;
            //  this.OnClickCancel();
            if (_current.Type1 != "")
                CreateProgramForm(typeof(PH.LWPM.UI.MC.QuatationListForm), "Maintain Quatation", true, new object[] { _current.Factory, _current.Type1, _current.Type }, null);
        }

        private void pressureRangeLabel_Click(object sender, EventArgs e)
        {

        }

        private void lbl_peronline_Click(object sender, EventArgs e)
        {

        }

        private void lblKW_Click(object sender, EventArgs e)
        {
        ...
        private void temperatureRangeLabel_Click(object sender, EventArgs e)
        {

        }

        private void borrowLabel_Click(object sender, EventArgs e)
        {
        ...
        private void rpmTextEdit_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void pressureRangeTextEdit_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void edtKW_EditValueChanged(object sender, EventArgs e)
        {

        }

        private void edt_Online_EditValueChanged(object sender, EventArgs e)
        {
