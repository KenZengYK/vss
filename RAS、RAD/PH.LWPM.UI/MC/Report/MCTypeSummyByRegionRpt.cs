...
{
    public partial class MCTypeSummyByRegionRpt : DevExpress.XtraReports.UI.XtraReport
    {
        public MCTypeSummyByRegionRpt()
        {
            InitializeComponent();
        }

        string _region;
        public MCTypeSummyByRegionRpt(string regrion)
        {
            InitializeComponent();
            _region = regrion;
        }
        ...
        private void MCTypeSummyByRegionRpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
           // xrLabel11.Text = DateTime.Now.ToShortDateString();
            xrLabel11.Text = DateTime.Now.ToShortDateString();
            xrLabel5.Text = DateTime.Now.ToShortDateString();
            ...
            //Sub_MCTypeSummyByRegionRpt _subrpt = new Sub_MCTypeSummyByRegionRpt(_regionid);
            //_subrpt.bsSummyMc_sub.DataSource =
           // xrSubreport1.bs = _subrpt;
        ...
        int _grandtotal = 0, _grdsl = 0, _grdgg = 0, _grdrx = 0,_grdfj=0,_grdcg=0;
        private void grpMc_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            int _fj = xtcSale.Summary.GetResult() != null ? int.Parse(xtcSale.Summary.GetResult().ToString()) : 0;
            ...
            int subtotal = _sl + _gg + _rx + _fj + _cg;            
