...
{
    public partial class MCTypeSummyByRegionRpt_OS : DevExpress.XtraReports.UI.XtraReport
    {
        public MCTypeSummyByRegionRpt_OS()
        {
            InitializeComponent();
        }

        string _region;
        public MCTypeSummyByRegionRpt_OS(string regrion)
        {
            InitializeComponent();
            _region = regrion;
        }
