...
{
    public partial class sHWListReportByFactorySub : DevExpress.XtraReports.UI.XtraReport
    {
        public sHWListReportByFactorySub()
        {
            InitializeComponent();
        }
        ...
        private void xtFactory_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            {
                this.xtFactory.Text = "Consolidated Regions";
            }
        }
