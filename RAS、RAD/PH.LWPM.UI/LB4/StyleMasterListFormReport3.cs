...
{
    public partial class StyleMasterListFormReport3 : DevExpress.XtraReports.UI.XtraReport
    {
        public int BindingSourceCount { get; set; }
        public StyleMasterListFormReport3(DataSet lists, string stepReport)
        //(string Rwo, string Qn, string j_NO, string LineCode, string Bcolor, string J2_job, string Factory, string OptionType, string Steptype, string OTN, DateTime dateTime, string OperationCode, string WorkId, string stepReport, string  WPSN)
        {
            ...
            List<OpsSpecSheetMaster3> RptSource = db.GetDataSet3(lists); //(Rwo, Qn, j_NO, LineCode, Bcolor, J2_job, Factory, OptionType, Steptype, OTN, dateTime, OperationCode, WorkId, WPSN);
        ...
        public StyleMasterListFormReport3(string Rwo, string Qn, string j_NO, string LineCode, string Bcolor, string J2_job, string Factory, string OptionType, string Steptype, string OTN, DateTime dateTime, string OperationCode, string WorkId, string StepReport, string WPSN,bool IsAllStep5)
        {
            InitializeComponent();

            RAPLQDataContext db = ContextBuilder.CreateContext<RAPLQDataContext>();
            List<OpsSpecSheetMaster3> lists = db.Step5GetDataSet3 (Rwo, Qn, j_NO, LineCode, Bcolor, J2_job, Factory, OptionType, Steptype, OTN, dateTime, OperationCode, WorkId, WPSN);
