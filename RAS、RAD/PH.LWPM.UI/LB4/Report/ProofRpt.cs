...
{
    public partial class ProofRpt : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public ProofRpt(WPMaster wpmaster)
        {
            this.Wps = wpmaster;
            InitializeComponent();
        }

        private void ProofRpt_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            int Total = 0;
