...
namespace PH.LWPM.UI.LB4.Report
{
    public partial class LBSAHReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void cell_team_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (EmpRows == TeamRows && EmpRows == 1)  //·í«eteam¤¤°¦¦³¤@­Ó¤H¡A¤@±ø°O¿ý
            {
            ...
            if (EmpRows == TeamRows && EmpRows > 1)  //¾´«eteam¤¤°¦¦³¤@­Ó¤H¡A¦h±ø°O¿ý
            {


                if (CurRowsCount == 1)//²Ä¤@±ø°O¿ý
                {
                ...
                else if (CurRowsCount < EmpRows) //¤¤¶¡ªº°O¿ý
                {
                ...
                else if (CurRowsCount == EmpRows) //³Ì¦Z¤@±ø
                {
                    cell_name.Text = string.Empty;
                   // cell_movetype.Text = string.Empty;
                    cell_wftype.Text = string.Empty;
            ...
            if (EmpRows != TeamRows) //·í«eteam¤¤¦³¦h­Ó¤H
            {


                if (this.CurRowsCount == 1)  //¤p¤À²Õ¤¤²Ä¤@±ø°O¿ý
                {
                    if (EmpRows == 1) //¾´«eteam¤¤¤p¤À²Õ¤¤¦¹¤H°¦¦³¤@±ø°O¿ýªº±¡ªp 
                    {
                    ...
                    else //¤p¤À²Õ¤¤¤p¤À²Õ¤¤¦¹¤H¦³¦h±ø°O¿ýªº±¡ªp
                    {
                ...
                else if (this.CurRowsCount > 1 && this.CurRowsCount < EmpRows) //¤p¤À²Õ¤¤²Ä¤@±ø°O¿ý¤§¦Z,³Ì¦Z¤@±ø°O¿ý¤§«e
                {
                    cell_name.Text = string.Empty;
                    //cell_movetype.Text = string.Empty;
                    cell_wftype.Text = string.Empty;
        ...
        private void GroupHeader1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            TeamRows = gsr.tcount.GetValueOrDefault(0); //¦¹team¦³¦h¤Ö±ø°O¿ý
        ...
        private void GroupHeader2_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            GetLBSAHResult gsr = this.GetCurrentRow() as GetLBSAHResult;
            EmpRows = gsr.rcount.GetValueOrDefault(0); //¦¹¤À²Õ¦³¦h¤Ö±ø°O¿ý
