...
namespace PH.LWPM.UI.LB4//PH.MobileQC.UI.RPT.AQL
{
    public partial class StyleMasterListFormReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public StyleMasterListFormReport(DataSet lists, string StepReport)
         //(string Rwo, string Qn, string j_NO, string LineCode, string Bcolor, string J2_job, string Factory, string OptionType, string Steptype, string OTN, DateTime dateTime, string OperationCode, string WorkId, string StepReport, string WPSN)
        {
            ...
            List<OpsSpecSheetMaster> RptSource = db.GetDataSet(lists);
        ...
        public StyleMasterListFormReport(string AFactory)
            : this("", "", "", "", "", "", AFactory, "", "Step 4", "", DateTime.Now, "", "", "Step 5 re-arrangement", "", true)
        {

        }


        public StyleMasterListFormReport(string Rwo, string Qn, string j_NO, string LineCode, string Bcolor, string J2_job, string Factory, string OptionType, string Steptype, string OTN, DateTime dateTime, string OperationCode, string WorkId, string StepReport, string WPSN, bool IsAllStep5)
        {
            InitializeComponent();

            RAPLQDataContext db = ContextBuilder.CreateContext<RAPLQDataContext>();
            List<OpsSpecSheetMaster> lists = db.Step5GetDataSet(Rwo, Qn, j_NO, LineCode, Bcolor, J2_job, Factory, OptionType, Steptype, OTN, dateTime, OperationCode, WorkId, WPSN);
