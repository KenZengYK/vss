...
{
    public partial class Step5DeploymentReArrangingReportSub : DevExpress.XtraReports.UI.XtraReport
    {
        public Step5DeploymentReArrangingReportSub(List<Step5DeploymentReArranging> ADataList)
        {
            InitializeComponent();

            this.bsStep5DeploymentReArranging.DataSource = ADataList;
        ...
        private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            ProcessCellBorder("QN", this.tcTotalDesk);
        }
