...
namespace PH.LWPM.UI.LB5.Report
{
    public partial class MatchingRpt : DevExpress.XtraReports.UI.XtraReport
    {
         ...
         private PoolInfo Wps;
        public MatchingRpt()
        {
            InitializeComponent();
        }

        public MatchingRpt(PoolInfo pinfo)
        {
            this.Wps = pinfo;
            InitializeComponent();
        }
        ...
        {
            //addworkerId1
            //System.Windows.Forms.MessageBox.Show(DetailReport.GetCurrentColumnValue("addworkerId1") != null ? DetailReport.GetCurrentColumnValue("addworkerId1").ToString() : string.Empty);
            
            if (string.IsNullOrEmpty(DetailReport.GetCurrentColumnValue("addworkerId1") != null ? DetailReport.GetCurrentColumnValue("addworkerId1").ToString() : string.Empty))
