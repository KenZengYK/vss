...
namespace PH.LWPM.UI.WF
{
    public partial class WFChildFrm_Projection : ParentChildForm
    {
        ...
        {
            this.barBtnAddNew.Visibility = (this.PrevForm as WFPListFrm_Projection).ReadOnlyParam == "ReadOnly" ? BarItemVisibility.Never : BarItemVisibility.Always;
            ...
            _lstemptype = (this.DataContext as RAPLQDataContext).BaseCodes.Where(P => P.Type == "EmpType").ToList();
            ...
            string menuname = (this.PrevForm as WFPListFrm_Projection).MenuName.ToLower();
            if (this.IsNew)
            {
                if (menuname == "staff")
        ...
        private void setSelectClsNameMethod()
        {
            ...
            string strParaName = (this.PrevForm as WFPListFrm_Projection).ParaName;
            string strMenuName = (this.PrevForm as WFPListFrm_Projection).MenuName;
            ...
            switch ((this.PrevForm as WFPListFrm_Projection).ParaName)
            {
                //Skill dWF Pool
        ...
        private void getCobBindMethod(bool IsAddnewFlg)
        {
            ...
            cobWFPart.Properties.DisplayMember = "Name";
            ...
            // var q = null;
            //if ((this.PrevForm as WFPListFrm_Projection).MenuName.ToLower() == "staff")
            if ((this.PrevForm as WFPListFrm_Projection).MenuName.ToLower() == "sf")
            {
        ...
        private void BindDivision()
        {
            ...
            this.lue_Divison.Properties.Columns.Clear();
            ...
            this.lue_Divison.Properties.Columns.AddRange(new DevExpress.XtraEditors.Controls.LookUpColumnInfo[] { newLookUpColumnInfo, newLookUpColumnInfo1 });

            this.lue_Divison.Properties.AutoSearchColumnIndex = 0;
            this.lue_Divison.Properties.DataSource = bs_divison;
            this.lue_Divison.Properties.ValueMember = "Code";
            this.lue_Divison.Properties.DisplayMember = "Description";
        ...
        private void jobTitleEnComboBoxEdit_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (NameEn != null)
            {
                ...
                if (aa != null)
                {
                    ...
                    //選擇JobTitle時，自動帶出Grade  由David加入 2018-07-24
        ...
        private void cobcontrolsupport_EditValueChanged(object sender, EventArgs e)
        {
            BaseCode _base = this.bs_divison.Current as BaseCode;
            object obj = this.lue_Divison.GetColumnValue("DefectChineseName");
            //if (obj != null)
            //{
