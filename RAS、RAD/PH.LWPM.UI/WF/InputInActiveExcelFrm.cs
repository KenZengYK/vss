...
{
    public partial class InputInActiveExcelFrm : Form
    {
        public InputInActiveExcelFrm()
        {
            InitializeComponent();
        }
        ...
        private void simpleButton2_Click(object sender, EventArgs e)
        {
            ...
            {              
               context.ExecuteCommand(string.Format(@"update workforce set InActive='1',REDate='{0}' where Id='{1}' ",DateTime.Now.ToString(), ss[0].ToString()));
