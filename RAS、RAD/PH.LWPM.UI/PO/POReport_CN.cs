...
{
    public partial class POReport_CN : DevExpress.XtraReports.UI.XtraReport
    {
        public POReport_CN()
        {
            InitializeComponent();
        ...
        public POReport_CN(POHeader APOHeader, POReportTypes APOType, int APOType1)
            : this()
        {
            ...
            {
                POSubReport_OtherItem subReportOtherItem = new POSubReport_OtherItem(ReportLanguages.Chinese);
                ...
                this.lbPOTotalDesc.Text = "金額小計：";
            }
            else
            {
                this.Subreport_AmountDescription.Visible = false;
                this.lbPOTotalDesc.Text = "金額總計：";
            }

            this.lbBuyer.Text = APOHeader.BuyerName_CN;
            ...
            //處理Vendor顯示信息
            this.lbVendorName.Text = vendor.Name_TW;
            ...
            this.lbBuyer.Text = buyer.Name_TW;
            this.lbCoordinator.Text = buyer.Attn;
            this.lbBuyerSign.Text = buyer.Name_TW;
            ...
            this.lblNotepad.Text = APOHeader.Notepad_CN;

            this.tcMCType.Text = APOType1 == 0 ? "機械\r\n種類" : "Item";
            this.xrTableCell12.DataBindings.Add("Text", this.bindingSource, APOType1 == 0 ? "MCType" : "ItemCode");

            this.tcModel.Text = APOType1 == 0 ? "型號" : "型號";
            this.tcBrand.Text = APOType1 == 0 ? "機械品牌" : "品牌";

            this.lbAmountDescription.Text = APOHeader.AmountRemark;
            this.lbAmount.Text = APOHeader.GetTotal().ToString("0.00");

            this.tcGoodsDescription.Text = APOHeader.GoodsDescription_CN;
        ...
        {
            this.lbHint.Text = e.PageIndex == e.PageCount - 1 ? "已完成" : "待續 , 請查看下一頁";
        }
