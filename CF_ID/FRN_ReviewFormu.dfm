object frmFRN_review: TfrmFRN_review
  ...
  object cxGrid1: TcxGrid
    ...
    object cxView1: TcxGridDBTableView
      ...
      object cxView1ttl_prj: TcxGridDBColumn
        Caption = 'Proj'#13#10'Ttl'
        DataBinding.FieldName = 'ttl_prj'
        HeaderAlignmentHorz = taCenter
        Options.Editing = False
        Styles.Content = cxStyle1
        Width = 34
      end
      object cxView1frn_dt: TcxGridDBColumn
        Caption = 'Create dd'
        DataBinding.FieldName = 'FRN_DT'
        HeaderAlignmentHorz = taCenter
        Options.Editing = False
        Styles.Content = cxStyle1
        Width = 85
      ...
      object cxView1Column2: TcxGridDBColumn
        Caption = 'Cfm & Appv'
        DataBinding.FieldName = 'ppl_234'
        HeaderAlignmentHorz = taCenter
        Options.Editing = False
        Styles.Content = cxStyle1
        Width = 203
      end
      object cxView1pu_marker: TcxGridDBColumn
        DataBinding.FieldName = 'pu_marker'
        Visible = False
      end
    end
