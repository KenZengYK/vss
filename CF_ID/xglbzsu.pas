  ...
  if edit2.text<>'' then begin
   if label3.caption='lbjh' then begin
     ...
     with adoquery1 do begin
       close;
       sql.text:='update cut_lbjh2 set mjjs=mjs*:mjjs where prjno=:prjno and wl=:wl and xh=:xh';
       ...
       execsql;
       close;
       sql.text:='update cut_lbjh3 set jhlbzs=:jhlbzs,jhwlcd=jhlbzs*jhdzlbcd where prjno=:prjno and wl=:wl and xh=:xh';
       parameters[0].value:=strtoint(edit2.text);
       parameters[1].value:=prjno;
       parameters[2].value:=wl;
       parameters[3].value:=xh;
       execsql;
       close;
       sql.text:='update cut_lbjh1 set lbzs=:lbzs where prjno=:prjno and wl=:wl and xh=:xh';
       parameters[0].value:=strtoint(edit2.text);
       parameters[1].value:=prjno;
       parameters[2].value:=wl;
       parameters[3].value:=xh;
