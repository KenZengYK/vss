object frmcalc_rules: Tfrmcalc_rules
  Left = 0
  Top = 0
  Caption = 'How to calculate CU Marker copies per each Marking br.'
  ClientHeight = 323
  ClientWidth = 703
  Color = clBtnFace
  ...
  object cxGrid1: TcxGrid
    ...
    object cxView1: TcxGridDBBandedTableView
      NavigatorButtons.ConfirmDelete = False
      DataController.DataSource = dsrules
      DataController.Summary.DefaultGroupSummaryItems = <>
      DataController.Summary.FooterSummaryItems = <>
      DataController.Summary.SummaryGroups = <>
      ...
      object cxView1r_type: TcxGridDBBandedColumn
        Caption = 'Brief Desc.'
        DataBinding.FieldName = 'r_type'
        HeaderAlignmentHorz = taCenter
        Width = 600
        Position.BandIndex = 0
        Position.ColIndex = 1
      ...
      object cxView1rules: TcxGridDBBandedColumn
        Caption = 'Details'
  ...
  object cut_rules: TADODataSet
    Connection = frmmain.ADOConnection1
    CursorType = ctStatic
    AfterPost = cut_rulesAfterPost
    CommandText = 'select * from cut_rules'
    CommandTimeout = 300
    IndexFieldNames = 'cde'
    Parameters = <>
    Left = 280
