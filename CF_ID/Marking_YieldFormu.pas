...
begin
  ...
  with frmmarker_remarks.ADODataSet1 do begin
    close;
    commandtext:='select * from cut_marker_remarks where frn_no='''+frn_yield.FieldByName('frn_no').Value+''' and wl='''+frn_yield.FieldByName('wl').Value+''' and sh='''+copy(frn_yield.FieldByName('cfid').Value,1,3)+'''';
    open;
  end;
