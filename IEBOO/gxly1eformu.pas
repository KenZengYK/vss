...
uses
  ...
  Dialogs, ppDB, ppMemo, ppBands, ppVar, ppClass, myChkBox, ppCtrls,
  ppStrtch, ppRegion, ppPrnabl, ppCache, ppProd, ppReport, DB, DBClient,
  ppComm, ppRelatv, ppDBPipe, ppDBBDE, ppViewr, Txcomp;

type
  Tfrmgxly1e = class(TForm)
...
procedure Tfrmgxly1e.ppGroupHeaderBand1BeforePrint(Sender: TObject);
var
  str1,s1:string;
begin
  //
      if frmscgxdy.op2.checked=true then begin
        str1:='';
        {
        if frmgxly=nil then frmgxly:=tfrmgxly1e.create(self);
        with frmgxly1e.zygx do begin
          ...
          frmgxly1e.spx0.visible:=false;
          frmgxly1e.sp00.Visible:=false;
          frmgxly1e.sp01.Visible:=false;
          frmgxly1e.sp02.Visible:=false;
          frmgxly1e.sp03.Visible:=false;
          frmgxly1e.sp04.Visible:=false;
          frmgxly1e.sp05.Visible:=false;
          frmgxly1e.sp06.Visible:=false;
          frmgxly1e.sp07.Visible:=false;
          frmgxly1e.sp08.Visible:=false;
          frmgxly1e.sp09.Visible:=false;
          frmgxly1e.sp10.Visible:=false;
          frmgxly1e.sp11.Visible:=false;

          frmgxly1e.xp00.Visible:=false;

          frmgxly1e.xbx0.Checked:=false;
          frmgxly1e.xb00.Checked:=false;
          frmgxly1e.xb01.Checked:=false;
          frmgxly1e.xb02.Checked:=false;
          frmgxly1e.xb03.Checked:=false;
          frmgxly1e.xb04.Checked:=false;
          frmgxly1e.xb05.Checked:=false;
          frmgxly1e.xb06.Checked:=false;
          frmgxly1e.xb07.Checked:=false;
          frmgxly1e.xb08.Checked:=false;
          frmgxly1e.xb09.Checked:=false;
          frmgxly1e.xb10.Checked:=false;
          frmgxly1e.xb11.Checked:=false;
        with frmgxly1e.ClientDataSet1 do begin
          close;
          params.clear;
          commandtext:='select isnull(sum(sj),0) as s1,isnull(sum(bzsj2),0) as s2,isnull(sum(sjdj),0) as s3,isnull(sum(sjdj2),0) as s4 from ie_zygx1 where seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
          ...
          open;
          frmgxly1e.zsj01.Caption:=formatfloat('0.0000',fieldbyname('s1').value);
          frmgxly1e.zsj02.Caption:=formatfloat('0.0000',fieldbyname('s2').value);
          frmgxly1e.zdj01.Caption:=formatfloat('0.0000',fieldbyname('s3').value);
          frmgxly1e.zdj02.Caption:=formatfloat('0.0000',fieldbyname('s4').value);
          close;
          params.clear;
          commandtext:='select isnull(sum(sj),0) as s1,isnull(sum(bzsj2),0) as s2,isnull(sum(sjdj),0) as s3,isnull(sum(sjdj2),0) as s4 from ie_zygx1 where zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
          if frmscgxdy.xh1.Checked then commandtext:=commandtext+' and xz07=1'
          else if frmscgxdy.xh2.Checked then begin
            if frmscgxdy.chk1.ItemIndex=0 then commandtext:=commandtext+' and xz04=1'
            else if frmscgxdy.chk1.ItemIndex=1 then commandtext:=commandtext+' and (xz30=1 or xz31=1)'
          ...
          open;
          frmgxly1e.zsj03.Caption:=formatfloat('0.0000',fieldbyname('s1').value);
          frmgxly1e.zsj04.Caption:=formatfloat('0.0000',fieldbyname('s2').value);
          frmgxly1e.zdj03.Caption:=formatfloat('0.0000',fieldbyname('s3').value);
          frmgxly1e.zdj04.Caption:=formatfloat('0.0000',fieldbyname('s4').value);
        end;
            frmgxly1e.sp00.Visible:=true;
            frmgxly1e.xp00.Visible:=true;
            frmgxly1e.xb00.Checked:=true;
            {
            frmgxly1e.sp06.Visible:=true;
            frmgxly1e.xp06.Visible:=true;
            frmgxly1e.xb06.Checked:=true;
            frmgxly1e.sp07.Visible:=true;
            frmgxly1e.xp07.Visible:=true;
            frmgxly1e.xb07.Checked:=true;
            frmgxly1e.sp09.Visible:=true;
            frmgxly1e.xp09.Visible:=true;
            frmgxly1e.xb09.Checked:=true;
            frmgxly1e.sp08.Visible:=true;
            frmgxly1e.xp08.Visible:=true;
            frmgxly1e.xb08.Checked:=true;
            frmgxly1e.sp11.Visible:=true;
            frmgxly1e.xp11.Visible:=true;
            frmgxly1e.xb11.Checked:=true;
            frmgxly1e.sp10.Visible:=true;
            frmgxly1e.xp10.Visible:=true;
            frmgxly1e.xb10.Checked:=true;
            }
      end;
        season001.caption:='';
...
procedure Tfrmgxly1e.ppGroupFooterBand1BeforePrint(Sender: TObject);
var
...
begin
  //
          with frmgxly1e.ClientDataSet1 do begin
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz01=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz03=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz05=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz06=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz04=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz30=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz31=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz40=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz41=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz42=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz08=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz09=1 and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz01=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz03=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz05=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz06=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz04=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz30=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz31=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz40=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz41=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz42=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz08=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz09=1 and zb<>''O'' and seq='+frmgxly1e.zygx.fieldbyname('seq').asstring;
            open;
          ...
          frmgxly1e.jb01.Caption:='(1a): '+formatfloat('0.0000',jb009);//+' / '+formatfloat('0.0000',jb010);
          frmgxly1e.jb02.Caption:='';
          frmgxly1e.jb03.Caption:='';
          frmgxly1e.jb04.Caption:='';
          frmgxly1e.jb05.Caption:='';
          frmgxly1e.jb06.Caption:='';
          frmgxly1e.jb001.Caption:='(1a): '+formatfloat('0.0000',jb109);//+' / '+formatfloat('0.0000',jb110);
          frmgxly1e.jb002.Caption:='';
          frmgxly1e.jb003.Caption:='';
          frmgxly1e.jb004.Caption:='';
          frmgxly1e.jb005.Caption:='';
          frmgxly1e.jb006.Caption:='';
{  with clientdataset1 do begin
    close;
    params.clear;
...
procedure Tfrmgxly1e.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppreport1.previewform.windowstate:=wsmaximized;
  tppviewer(ppreport1.previewform.viewer).zoompercentage:=100;
end;

procedure Tfrmgxly1e.ppSummaryBand1BeforePrint(Sender: TObject);
var
  s1:string;
begin
        if frmgxly1e.zygx.FieldByName('xzr').value='GSD' then begin
          frmgxly1e.mychk01.checked:=true;
          frmgxly1e.mychk02.checked:=false;
          frmgxly1e.mychk03.checked:=false;
          frmgxly1e.mychk04.checked:=false;
        end else if frmgxly1e.zygx.fieldbyname('xzr').value='Optimum' then begin
          frmgxly1e.mychk03.checked:=true;
          frmgxly1e.mychk01.checked:=false;
          frmgxly1e.mychk02.checked:=false;
          frmgxly1e.mychk04.checked:=false;
        end else if frmgxly1e.zygx.fieldbyname('xzr').value='Best' then begin
          frmgxly1e.mychk04.checked:=true;
          frmgxly1e.mychk01.checked:=false;
          frmgxly1e.mychk02.checked:=false;
          frmgxly1e.mychk03.checked:=false;
        end else begin
          frmgxly1e.mychk02.checked:=true;
          frmgxly1e.mychk01.checked:=false;
          frmgxly1e.mychk03.checked:=false;
          frmgxly1e.mychk04.checked:=false;
        end;
...
procedure Tfrmgxly1e.zygxAfterOpen(DataSet: TDataSet);
begin
