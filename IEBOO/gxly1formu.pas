...
procedure Tfrmgxly1.ppGroupHeaderBand1BeforePrint(Sender: TObject);
var
  str1,s1:string;
begin
  //
      if frmscgxdy.op1.checked=true then begin
        str1:='';
        {
        if frmgxly=nil then frmgxly:=tfrmgxly1.create(self);
        with frmgxly1.zygx do begin
          ...
          frmgxly1.spx0.visible:=false;
          frmgxly1.sp00.Visible:=false;
          frmgxly1.sp01.Visible:=false;
          frmgxly1.sp02.Visible:=false;
          frmgxly1.sp03.Visible:=false;
          frmgxly1.sp04.Visible:=false;
          frmgxly1.sp05.Visible:=false;
          frmgxly1.sp06.Visible:=false;
          frmgxly1.sp07.Visible:=false;
          frmgxly1.sp08.Visible:=false;
          frmgxly1.sp09.Visible:=false;
          frmgxly1.sp10.Visible:=false;
          frmgxly1.sp11.Visible:=false;

          frmgxly1.xp00.Visible:=false;

          frmgxly1.xbx0.Checked:=false;
          frmgxly1.xb00.Checked:=false;
          frmgxly1.xb01.Checked:=false;
          frmgxly1.xb02.Checked:=false;
          frmgxly1.xb03.Checked:=false;
          frmgxly1.xb04.Checked:=false;
          frmgxly1.xb05.Checked:=false;
          frmgxly1.xb06.Checked:=false;
          frmgxly1.xb07.Checked:=false;
          frmgxly1.xb08.Checked:=false;
          frmgxly1.xb09.Checked:=false;
          frmgxly1.xb10.Checked:=false;
          frmgxly1.xb11.Checked:=false;
        with frmgxly1.ClientDataSet1 do begin
          close;
          params.clear;
          commandtext:='select isnull(sum(sj),0) as s1,isnull(sum(bzsj2),0) as s2,isnull(sum(sjdj),0) as s3,isnull(sum(sjdj2),0) as s4 from ie_zygx1 where seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
          ...
          open;
          frmgxly1.zsj01.Caption:=formatfloat('0.0000',fieldbyname('s1').value);
          frmgxly1.zsj02.Caption:=formatfloat('0.0000',fieldbyname('s2').value);
          frmgxly1.zdj01.Caption:=formatfloat('0.0000',fieldbyname('s3').value);
          frmgxly1.zdj02.Caption:=formatfloat('0.0000',fieldbyname('s4').value);
          close;
          params.clear;
          commandtext:='select isnull(sum(sj),0) as s1,isnull(sum(bzsj2),0) as s2,isnull(sum(sjdj),0) as s3,isnull(sum(sjdj2),0) as s4 from ie_zygx1 where zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
          if frmscgxdy.xh1.Checked then commandtext:=commandtext+' and xz07=1'
          else if frmscgxdy.xh2.Checked then begin
            if frmscgxdy.chk1.ItemIndex=0 then commandtext:=commandtext+' and xz04=1'
            else if frmscgxdy.chk1.ItemIndex=1 then commandtext:=commandtext+' and (xz30=1 or xz31=1)'
          ...
          open;
          frmgxly1.zsj03.Caption:=formatfloat('0.0000',fieldbyname('s1').value);
          frmgxly1.zsj04.Caption:=formatfloat('0.0000',fieldbyname('s2').value);
          frmgxly1.zdj03.Caption:=formatfloat('0.0000',fieldbyname('s3').value);
          frmgxly1.zdj04.Caption:=formatfloat('0.0000',fieldbyname('s4').value);
        end;
            frmgxly1.sp00.Visible:=true;
            frmgxly1.xp00.Visible:=true;
            frmgxly1.xb00.Checked:=true;
            {
            frmgxly1.sp06.Visible:=true;
            frmgxly1.xp06.Visible:=true;
            frmgxly1.xb06.Checked:=true;
            frmgxly1.sp07.Visible:=true;
            frmgxly1.xp07.Visible:=true;
            frmgxly1.xb07.Checked:=true;
            frmgxly1.sp09.Visible:=true;
            frmgxly1.xp09.Visible:=true;
            frmgxly1.xb09.Checked:=true;
            frmgxly1.sp08.Visible:=true;
            frmgxly1.xp08.Visible:=true;
            frmgxly1.xb08.Checked:=true;
            frmgxly1.sp11.Visible:=true;
            frmgxly1.xp11.Visible:=true;
            frmgxly1.xb11.Checked:=true;
            frmgxly1.sp10.Visible:=true;
            frmgxly1.xp10.Visible:=true;
            frmgxly1.xb10.Checked:=true;
            }
      end;
        season001.caption:='';
...
procedure Tfrmgxly1.ppGroupFooterBand1BeforePrint(Sender: TObject);
var
...
begin
  //
          with frmgxly1.ClientDataSet1 do begin
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz01=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz03=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz05=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz06=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz04=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz30=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz31=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz40=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz41=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz42=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz08=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz09=1 and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz01=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz03=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz05=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz06=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz04=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz30=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz31=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz40=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz41=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz42=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz08=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz09=1 and zb<>''O'' and seq='+frmgxly1.zygx.fieldbyname('seq').asstring;
            open;
          ...
          frmgxly1.jb01.Caption:='(1a): '+formatfloat('0.0000',jb009);//+' / '+formatfloat('0.0000',jb010);
          frmgxly1.jb02.Caption:='';
          frmgxly1.jb03.Caption:='';
          frmgxly1.jb04.Caption:='';
          frmgxly1.jb05.Caption:='';
          frmgxly1.jb06.Caption:='';
          frmgxly1.jb001.Caption:='(1a): '+formatfloat('0.0000',jb109);//+' / '+formatfloat('0.0000',jb110);
          frmgxly1.jb002.Caption:='';
          frmgxly1.jb003.Caption:='';
          frmgxly1.jb004.Caption:='';
          frmgxly1.jb005.Caption:='';
          frmgxly1.jb006.Caption:='';
{  with clientdataset1 do begin
    close;
    params.clear;
...
procedure Tfrmgxly1.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppreport1.previewform.windowstate:=wsmaximized;
  tppviewer(ppreport1.previewform.viewer).zoompercentage:=100;
end;

procedure Tfrmgxly1.zygxAfterOpen(DataSet: TDataSet);
begin
...
procedure Tfrmgxly1.ppSummaryBand1BeforePrint(Sender: TObject);
var
  s1:string;
begin
        if frmgxly1.zygx.FieldByName('xzr').value='¥¼°µLB' then begin
          frmgxly1.mychk01.checked:=true;
          frmgxly1.mychk02.checked:=false;
          frmgxly1.mychk03.checked:=false;
          frmgxly1.mychk04.checked:=false;
        end else if frmgxly1.zygx.fieldbyname('xzr').value='Àu¤Æ' then begin
          frmgxly1.mychk03.checked:=true;
          frmgxly1.mychk01.checked:=false;
          frmgxly1.mychk02.checked:=false;
          frmgxly1.mychk04.checked:=false;
        end else if frmgxly1.zygx.fieldbyname('xzr').value='·¥¨Î' then begin
          frmgxly1.mychk04.checked:=true;
          frmgxly1.mychk01.checked:=false;
          frmgxly1.mychk02.checked:=false;
          frmgxly1.mychk03.checked:=false;
        end else begin
          frmgxly1.mychk02.checked:=true;
          frmgxly1.mychk01.checked:=false;
          frmgxly1.mychk03.checked:=false;
          frmgxly1.mychk04.checked:=false;
        end;
