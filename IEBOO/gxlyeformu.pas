...
uses
  ...
  Dialogs, DB, DBClient, ppMemo, ppBands, ppVar, ppClass, myChkBox,
  ppCtrls, ppStrtch, ppRegion, ppPrnabl, ppCache, ppProd, ppReport, ppDB,
  ppComm, ppRelatv, ppDBPipe, ppDBBDE, ppViewr, Txcomp;

type
  Tfrmgxlye = class(TForm)
...
procedure Tfrmgxlye.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppreport1.previewform.windowstate:=wsmaximized;
  tppviewer(ppreport1.previewform.viewer).zoompercentage:=100;
end;

procedure Tfrmgxlye.zygxAfterOpen(DataSet: TDataSet);
begin
...
procedure Tfrmgxlye.ppGroupHeaderBand1BeforePrint(Sender: TObject);
var
  str1,s1:string;
begin
  //
      if frmscgxdy.op2.checked=true then begin
        ...
        with frmgxly.zygx do begin
          ...
          frmgxlye.spx0.visible:=false;
          frmgxlye.sp00.Visible:=false;
          frmgxlye.sp01.Visible:=false;
          frmgxlye.sp02.Visible:=false;
          frmgxlye.sp03.Visible:=false;
          frmgxlye.sp04.Visible:=false;
          frmgxlye.sp05.Visible:=false;
          frmgxlye.sp06.Visible:=false;
          frmgxlye.sp07.Visible:=false;
          frmgxlye.sp08.Visible:=false;
          frmgxlye.sp09.Visible:=false;
          frmgxlye.sp10.Visible:=false;
          frmgxlye.sp11.Visible:=false;

          frmgxlye.xp06.Visible:=false;
          frmgxlye.xp07.Visible:=false;
          frmgxlye.xp08.Visible:=false;
          frmgxlye.xp09.Visible:=false;
          frmgxlye.xp10.Visible:=false;
          frmgxlye.xp11.Visible:=false;

          frmgxlye.xbx0.Checked:=false;
          frmgxlye.xb00.Checked:=false;
          frmgxlye.xb01.Checked:=false;
          frmgxlye.xb02.Checked:=false;
          frmgxlye.xb03.Checked:=false;
          frmgxlye.xb04.Checked:=false;
          frmgxlye.xb05.Checked:=false;
          frmgxlye.xb06.Checked:=false;
          frmgxlye.xb07.Checked:=false;
          frmgxlye.xb08.Checked:=false;
          frmgxlye.xb09.Checked:=false;
          frmgxlye.xb10.Checked:=false;
          frmgxlye.xb11.Checked:=false;
        with frmgxlye.ClientDataSet1 do begin
          close;
          params.clear;
          commandtext:='select isnull(sum(sj),0) as s1,isnull(sum(bzsj2),0) as s2,isnull(sum(sjdj),0) as s3,isnull(sum(sjdj2),0) as s4 from ie_zygx1 where seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
          ...
          open;
          frmgxlye.zsj01.Caption:=formatfloat('0.0000',fieldbyname('s1').value);
          frmgxlye.zsj02.Caption:=formatfloat('0.0000',fieldbyname('s2').value);
          frmgxlye.zdj01.Caption:=formatfloat('0.0000',fieldbyname('s3').value);
          frmgxlye.zdj02.Caption:=formatfloat('0.0000',fieldbyname('s4').value);
          close;
          params.clear;
          commandtext:='select isnull(sum(sj),0) as s1,isnull(sum(bzsj2),0) as s2,isnull(sum(sjdj),0) as s3,isnull(sum(sjdj2),0) as s4 from ie_zygx1 where zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
          if frmscgxdy.xh1.Checked then commandtext:=commandtext+' and xz07=1'
          else if frmscgxdy.xh2.Checked then begin
            if frmscgxdy.chk1.ItemIndex=0 then commandtext:=commandtext+' and xz04=1'
            else if frmscgxdy.chk1.ItemIndex=1 then commandtext:=commandtext+' and (xz30=1 or xz31=1)'
          ...
          open;
          frmgxlye.zsj03.Caption:=formatfloat('0.0000',fieldbyname('s1').value);
          frmgxlye.zsj04.Caption:=formatfloat('0.0000',fieldbyname('s2').value);
          frmgxlye.zdj03.Caption:=formatfloat('0.0000',fieldbyname('s3').value);
          frmgxlye.zdj04.Caption:=formatfloat('0.0000',fieldbyname('s4').value);
        end;
        with clientdataset1 do begin
          close;
          params.clear;
          commandtext:='select seq from ie_zygx1 where xz01=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
          open;
          if not fieldbyname('seq').isnull then begin
            frmgxlye.sp06.Visible:=true;
            frmgxlye.xp06.Visible:=true;
            frmgxlye.xb06.Checked:=true;
          end;
        end;
        with clientdataset1 do begin
          close;
          params.clear;
          commandtext:='select seq from ie_zygx1 where xz03=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
          open;
          if not fieldbyname('seq').isnull then begin
            frmgxlye.sp07.Visible:=true;
            frmgxlye.xp07.Visible:=true;
            frmgxlye.xb07.Checked:=true;
          end;
        end;
        with clientdataset1 do begin
          close;
          params.clear;
          commandtext:='select seq from ie_zygx1 where xz05=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
          open;
          if not fieldbyname('seq').isnull then begin
            frmgxlye.sp09.Visible:=true;
            frmgxlye.xp09.Visible:=true;
            frmgxlye.xb09.Checked:=true;
          end;
        end;
        with clientdataset1 do begin
          close;
          params.clear;
          commandtext:='select seq from ie_zygx1 where xz06=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
          open;
          if not fieldbyname('seq').isnull then begin
            frmgxlye.sp08.Visible:=true;
            frmgxlye.xp08.Visible:=true;
            frmgxlye.xb08.Checked:=true;
          end;
        end;
        with clientdataset1 do begin
          close;
          params.clear;
          commandtext:='select seq from ie_zygx1 where xz09=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
          open;
          if not fieldbyname('seq').isnull then begin
            frmgxlye.sp11.Visible:=true;
            frmgxlye.xp11.Visible:=true;
            frmgxlye.xb11.Checked:=true;
          end;
        end;
        with clientdataset1 do begin
          close;
          params.clear;
          commandtext:='select seq from ie_zygx1 where xz08=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
          open;
          if not fieldbyname('seq').isnull then begin
            frmgxlye.sp10.Visible:=true;
            frmgxlye.xp10.Visible:=true;
            frmgxlye.xb10.Checked:=true;
          end;
        end;
      end;
        season001.caption:='';
...
procedure Tfrmgxlye.ppGroupFooterBand1BeforePrint(Sender: TObject);
var
...
begin
  //
          with frmgxlye.ClientDataSet1 do begin
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz01=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz03=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz05=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz06=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz04=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz30=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz31=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz40=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz41=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz42=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz08=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz09=1 and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz01=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz03=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz05=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz06=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz04=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz30=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz31=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz40=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz41=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz42=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz08=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz09=1 and zb<>''O'' and seq='+frmgxlye.zygx.fieldbyname('seq').asstring;
            open;
          ...
          frmgxlye.jb01.Caption:='(4a): '+formatfloat('0.0000',jb001);//+' / '+formatfloat('0.0000',jb002);
          frmgxlye.jb02.Caption:='(4b): '+formatfloat('0.0000',jb003);//+' / '+formatfloat('0.0000',jb004);
          frmgxlye.jb03.Caption:='(4c): '+formatfloat('0.0000',jb007);//+' / '+formatfloat('0.0000',jb008);
          frmgxlye.jb04.Caption:='(4d): '+formatfloat('0.0000',jb005);//+' / '+formatfloat('0.0000',jb006);
          frmgxlye.jb05.Caption:='(4e): '+formatfloat('0.0000',jb203);//+' / '+formatfloat('0.0000',jb204);
          frmgxlye.jb06.Caption:='(4f): '+formatfloat('0.0000',jb205);//+' / '+formatfloat('0.0000',jb206);
          frmgxlye.jb001.Caption:='(4a): '+formatfloat('0.0000',jb101);//+' / '+formatfloat('0.0000',jb102);
          frmgxlye.jb002.Caption:='(4b): '+formatfloat('0.0000',jb103);//+' / '+formatfloat('0.0000',jb104);
          frmgxlye.jb003.Caption:='(4c): '+formatfloat('0.0000',jb107);//+' / '+formatfloat('0.0000',jb108);
          frmgxlye.jb004.Caption:='(4d): '+formatfloat('0.0000',jb105);//+' / '+formatfloat('0.0000',jb106);
          frmgxlye.jb005.Caption:='(4e): '+formatfloat('0.0000',jb303);//+' / '+formatfloat('0.0000',jb304);
          frmgxlye.jb006.Caption:='(4f): '+formatfloat('0.0000',jb305);//+' / '+formatfloat('0.0000',jb306);
{  with clientdataset1 do begin
    close;
    params.clear;
...
procedure Tfrmgxlye.ppSummaryBand1BeforePrint(Sender: TObject);
var
  s1:string;
begin
        if frmgxlye.zygx.FieldByName('xzr').value='GSD' then begin
          frmgxlye.mychk01.checked:=true;
          frmgxlye.mychk02.checked:=false;
          frmgxlye.mychk03.checked:=false;
          frmgxlye.mychk04.checked:=false;
        end else if frmgxlye.zygx.fieldbyname('xzr').value='Optimum' then begin
          frmgxlye.mychk03.checked:=true;
          frmgxlye.mychk01.checked:=false;
          frmgxlye.mychk02.checked:=false;
          frmgxlye.mychk04.checked:=false;
        end else if frmgxlye.zygx.fieldbyname('xzr').value='Best' then begin
          frmgxlye.mychk04.checked:=true;
          frmgxlye.mychk01.checked:=false;
          frmgxlye.mychk02.checked:=false;
          frmgxlye.mychk03.checked:=false;
        end else begin
          frmgxlye.mychk02.checked:=true;
          frmgxlye.mychk01.checked:=false;
          frmgxlye.mychk03.checked:=false;
          frmgxlye.mychk04.checked:=false;
        end;
