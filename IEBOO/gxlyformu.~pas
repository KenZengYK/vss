...
var
  s1:string;
begin
        if frmgxly.zygx.FieldByName('xzr').value='¥¼°µLB' then begin
          frmgxly.mychk01.checked:=true;
          frmgxly.mychk02.checked:=false;
          frmgxly.mychk03.checked:=false;
          frmgxly.mychk04.checked:=false;
        end else if frmgxly.zygx.fieldbyname('xzr').value='Àu¤Æ' then begin
          frmgxly.mychk03.checked:=true;
          frmgxly.mychk01.checked:=false;
          frmgxly.mychk02.checked:=false;
          frmgxly.mychk04.checked:=false;
        end else if frmgxly.zygx.fieldbyname('xzr').value='·¥¨Î' then begin
