...
procedure Tfrmgxly2.ppGroupHeaderBand1BeforePrint(Sender: TObject);
var
  str1,s1:string;
begin
  //
      if frmscgxdy.op1.checked=true then begin
        ...
        with frmgxly2.zygx do begin
          ...
          frmgxly2.spx0.visible:=false;
          frmgxly2.sp00.Visible:=false;
          frmgxly2.sp01.Visible:=false;
          frmgxly2.sp02.Visible:=false;
          frmgxly2.sp03.Visible:=false;
          frmgxly2.sp04.Visible:=false;
          frmgxly2.sp05.Visible:=false;
          frmgxly2.sp06.Visible:=false;
          frmgxly2.sp07.Visible:=false;
          frmgxly2.sp08.Visible:=false;
          frmgxly2.sp09.Visible:=false;
          frmgxly2.sp10.Visible:=false;
          frmgxly2.sp11.Visible:=false;

          frmgxly2.xp01.Visible:=false;
          frmgxly2.xp02.Visible:=false;

          frmgxly2.xbx0.Checked:=false;
          frmgxly2.xb00.Checked:=false;
          frmgxly2.xb01.Checked:=false;
          frmgxly2.xb02.Checked:=false;
          frmgxly2.xb03.Checked:=false;
          frmgxly2.xb04.Checked:=false;
          frmgxly2.xb05.Checked:=false;
          frmgxly2.xb06.Checked:=false;
          frmgxly2.xb07.Checked:=false;
          frmgxly2.xb08.Checked:=false;
          frmgxly2.xb09.Checked:=false;
          frmgxly2.xb10.Checked:=false;
          frmgxly2.xb11.Checked:=false;
        with frmgxly2.ClientDataSet1 do begin
          close;
          params.clear;
          commandtext:='select isnull(sum(sj),0) as s1,isnull(sum(bzsj2),0) as s2,isnull(sum(sjdj),0) as s3,isnull(sum(sjdj2),0) as s4 from ie_zygx1 where seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
          ...
          open;
          frmgxly2.zsj01.Caption:=formatfloat('0.0000',fieldbyname('s1').value);
          frmgxly2.zsj02.Caption:=formatfloat('0.0000',fieldbyname('s2').value);
          frmgxly2.zdj01.Caption:=formatfloat('0.0000',fieldbyname('s3').value);
          frmgxly2.zdj02.Caption:=formatfloat('0.0000',fieldbyname('s4').value);
          close;
          params.clear;
          commandtext:='select isnull(sum(sj),0) as s1,isnull(sum(bzsj2),0) as s2,isnull(sum(sjdj),0) as s3,isnull(sum(sjdj2),0) as s4 from ie_zygx1 where zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
          if frmscgxdy.xh1.Checked then commandtext:=commandtext+' and xz07=1'
          else if frmscgxdy.xh2.Checked then begin
            if frmscgxdy.chk1.ItemIndex=0 then commandtext:=commandtext+' and xz04=1'
            else if frmscgxdy.chk1.ItemIndex=1 then commandtext:=commandtext+' and (xz30=1 or xz31=1)'
          ...
          open;
          frmgxly2.zsj03.Caption:=formatfloat('0.0000',fieldbyname('s1').value);
          frmgxly2.zsj04.Caption:=formatfloat('0.0000',fieldbyname('s2').value);
          frmgxly2.zdj03.Caption:=formatfloat('0.0000',fieldbyname('s3').value);
          frmgxly2.zdj04.Caption:=formatfloat('0.0000',fieldbyname('s4').value);
        end;
        with clientdataset1 do begin
          close;
          params.clear;
          commandtext:='select seq from ie_zygx1 where xz30=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
          open;
          if not fieldbyname('seq').isnull then begin
            frmgxly2.sp02.Visible:=true;
            frmgxly2.xp02.Visible:=true;
            frmgxly2.xb02.Checked:=true;
          end;
        end;
        with clientdataset1 do begin
          close;
          params.clear;
          commandtext:='select seq from ie_zygx1 where xz31=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
          open;
          if not fieldbyname('seq').isnull then begin
            frmgxly2.sp01.Visible:=true;
            frmgxly2.xp01.Visible:=true;
            frmgxly2.xb01.Checked:=true;
          end;
        end;
      end;
        season001.caption:='';
...
procedure Tfrmgxly2.ppGroupFooterBand1BeforePrint(Sender: TObject);
var
...
begin
  //
          with frmgxly2.ClientDataSet1 do begin
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz01=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz03=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz05=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz06=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz04=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz30=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz31=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz40=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz41=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz42=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz08=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz09=1 and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz01=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz03=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz05=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz06=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz04=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz30=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz31=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz40=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz41=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz42=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz08=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
            ...
            close;
            params.clear;
            commandtext:='select sum(sj) as zsj1,sum(bzsj2) as zsj2 from ie_zygx1 where xz09=1 and zb<>''O'' and seq='+frmgxly2.zygx.fieldbyname('seq').asstring;
            open;
          ...
          frmgxly2.jb01.Caption:='(2a): '+formatfloat('0.0000',jb011);//+' / '+formatfloat('0.0000',jb012);
          frmgxly2.jb02.Caption:='(2b): '+formatfloat('0.0000',jb013);//+' / '+formatfloat('0.0000',jb014);
          frmgxly2.jb03.Caption:='';
          frmgxly2.jb04.Caption:='';
          frmgxly2.jb05.Caption:='';
          frmgxly2.jb06.Caption:='';
          frmgxly2.jb001.Caption:='(2a): '+formatfloat('0.0000',jb111);//+' / '+formatfloat('0.0000',jb112);
          frmgxly2.jb002.Caption:='(2b): '+formatfloat('0.0000',jb113);//+' / '+formatfloat('0.0000',jb114);
          frmgxly2.jb003.Caption:='';
          frmgxly2.jb004.Caption:='';
          frmgxly2.jb005.Caption:='';
          frmgxly2.jb006.Caption:='';
{  with clientdataset1 do begin
    close;
    params.clear;
...
procedure Tfrmgxly2.zygxAfterOpen(DataSet: TDataSet);
begin
...
procedure Tfrmgxly2.ppReport1PreviewFormCreate(Sender: TObject);
begin
  ppreport1.previewform.windowstate:=wsmaximized;
  tppviewer(ppreport1.previewform.viewer).zoompercentage:=100;
end;

procedure Tfrmgxly2.ppSummaryBand1BeforePrint(Sender: TObject);
var
  s1:string;
begin
        if frmgxly2.zygx.FieldByName('xzr').value='¥¼°µLB' then begin
          frmgxly2.mychk01.checked:=true;
          frmgxly2.mychk02.checked:=false;
          frmgxly2.mychk03.checked:=false;
          frmgxly2.mychk04.checked:=false;
        end else if frmgxly2.zygx.fieldbyname('xzr').value='Àu¤Æ' then begin
          frmgxly2.mychk03.checked:=true;
          frmgxly2.mychk01.checked:=false;
          frmgxly2.mychk02.checked:=false;
          frmgxly2.mychk04.checked:=false;
        end else if frmgxly2.zygx.fieldbyname('xzr').value='·¥¨Î' then begin
          frmgxly2.mychk04.checked:=true;
          frmgxly2.mychk01.checked:=false;
          frmgxly2.mychk02.checked:=false;
          frmgxly2.mychk03.checked:=false;
        end else begin
          frmgxly2.mychk02.checked:=true;
          frmgxly2.mychk01.checked:=false;
          frmgxly2.mychk03.checked:=false;
          frmgxly2.mychk04.checked:=false;
        end;
