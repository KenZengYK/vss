...
namespace PH.SPC.UI
{
    public partial class WARNPSListForm : PH.Platform.UI.CS.UI2.ListForm
    {
        ...
        public WARNPSListForm(string paraArg)
        {
            InitializeComponent();
            this.AllowGridEdit = true;
            this.AllowAddRow = false;
        ...
        public override void DataBind()
        {
            ...
            //this.BindingSource.DataSource = from c in context.SPCCustomers where c.Customer == "WARN" && c.Phase == 3 select c;
        ...
        {
            WARNPSListReport rpt = new WARNPSListReport(_Customer);
        ...
        private void InitializeComponent()
        {
            ...
            this.objListGridControl.Size = new System.Drawing.Size(3164, 532);
            ...
            this.Name = "WARNPSListForm";
            this.Size = new System.Drawing.Size(3164, 558);
