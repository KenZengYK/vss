...
namespace PH.SPC.UI
{
    public partial class WARNPPSListForm : PH.Platform.UI.CS.UI2.ListForm
    {
        ...
        public WARNPPSListForm(string paraArg)
        {
            InitializeComponent();
            this.AllowGridEdit = true;
            this.AllowAddRow = false;
        ...
        public override void DataBind()
        {
            ...
            //this.BindingSource.DataSource = from c in context.SPCCustomers where c.Customer == "WARN" && c.Phase == 2 select c;
        ...
        {
            WARNPPSListReport rpt = new WARNPPSListReport(_Customer);
        ...
        private void InitializeComponent()
        {
            ...
            this.objListGridControl.Size = new System.Drawing.Size(3760, 532);
            ...
            this.Name = "WARNPPSListForm";
            this.Size = new System.Drawing.Size(3760, 558);
