...
{
    public partial class LDSuccessAnalyseDetailReport : DevExpress.XtraReports.UI.XtraReport
    {
        public LDSuccessAnalyseDetailReport()
        {
            InitializeComponent();
            this.BeforePrint += new System.Drawing.Printing.PrintEventHandler(LDSuccessAnalyseReport_BeforePrint);
        }
        public LDSuccessAnalyseDetailReport(string param)
            : this()
        {
            GetValues(param);
        }
