...
{
    public partial class SampleMakedAnalyseReport : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public SampleMakedAnalyseReport(string param)
            : this()
        {
            GetValues(param);
        }
        ...
        public void Banding()
        {
            ...
            this.lbQuotationStyleCount.DataBindings.Add(new XRBinding("Text", this.Report.DataSource, "SampleMakedQty"));
            this.lbLDStyleCount.DataBindings.Add(new XRBinding("Text", this.Report.DataSource, "LDMakedQty"));

            //Xsj201310118
            this.lbStyleCount.DataBindings.Add(new XRBinding("Text", this.Report.DataSource, "StyleCount"));
            //---End
