...
{
    public partial class MRReport : PH.Platform.UI.CS.UI0.BlankForm
    {
        public MRReport()
        {
            InitializeComponent();
        ...
        private void PrintMR()
        {
            ...
            string cono = this.jobMRReport1.Company;
            string project = this.jobMRReport1.ProjectNo;
            ...
            data.ClassFullName = typeof(PH.MR.BackEnd.Job.JobMRReport).FullName;//報表全名
            data.JobName = string.Format("MR Report({0}):{1}", jobMRReport1.ReportOption, project);//JOB名稱
            ...
            data.RunServer = "SL";
            data.Parameter = this.jobMRReport1.GetParameter();
