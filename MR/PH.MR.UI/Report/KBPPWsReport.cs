...
{
    public partial class KBPPWsReport : PH.Platform.UI.CS.UI0.BlankForm
    {
        public KBPPWsReport()
        {
            InitializeComponent();
        ...
        private void PrintMR()
        {
            ...
            string cono = this.jobKBPPWsReport1.Company;
            string project = this.jobKBPPWsReport1.ProjectNo;
            ...
            data.ClassFullName = typeof(PH.MR.BackEnd.Job.JobKBPPWsReport).FullName;//報表全名
            data.JobName = string.Format("MR Report({0}):{1}", jobKBPPWsReport1.ReportOption, project);//JOB名稱
            ...
            data.RunServer = "SL";
            data.Parameter = this.jobKBPPWsReport1.GetParameter();
