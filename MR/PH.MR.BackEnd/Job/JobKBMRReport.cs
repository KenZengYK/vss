...
{
    public partial class JobKBMRReport : UserControl, PH.Platform.BackEnd.BO.IServerReport, PH.Platform.BackEnd.BO.IParameterSetControl
    {
        public JobKBMRReport()
        {
            InitializeComponent();
        ...
        {
            JobKBMRReport ctl = new JobKBMRReport();
