...
{
    public partial class JobFinalMRReport : UserControl, PH.Platform.BackEnd.BO.IParameterSetControl
    {
        public JobFinalMRReport()
        {
            InitializeComponent();
        ...
        public void GetValues(string parameters)
        {
            ...
            _dept = ss[3];
            _wos = ss[4];
            _reportOption = PHPrintReportOption.SumBreakDownListing;
        }
        ...
        {
            JobFinalMRReport ctl = new JobFinalMRReport();
