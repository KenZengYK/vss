...
namespace PH.MR.BO
{
    public static class UISetting
    {
        ...
        private static void GetSettings()
        {
            ...
            _AS400ServerIP = (string)GetSettingValueDefault(_appSettings, "AS400ServerIP", "10.2.1.242");//202.173.254.125:vss2005.sl.phgmt.com.hk:10.2.1.242
            ...
            //===InterBase===
            _IBDBIP = (string)GetSettingValueDefault(_appSettings, "IBDBIP", "10.2.1.10");//10.2.1.10:sql2005.sl.phgmt.com.hk
        ...
        private static string _menuServerIP;

        public static string MenuServerIP
        {
            get { return _menuServerIP; }
            set { _menuServerIP = value; }
        }

        private static string _menuServerName;

        public static string MenuServerName
        {
            get { return _menuServerName; }
            set { _menuServerName = value; }
        }

        private static int _menuServerPort;

        public static int MenuServerPort
        {
            get { return _menuServerPort; }
            set { _menuServerPort = value; }
        }
