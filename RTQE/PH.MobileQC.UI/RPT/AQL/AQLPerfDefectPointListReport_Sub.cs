...
{
    public partial class AQLPerfDefectPointListReport_Sub : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public AQLPerfDefectPointListReport_Sub()
        {
            InitializeComponent();
        }
       ...
       public AQLPerfDefectPointListReport_Sub(DataSet ds)
        {
            InitializeComponent();
