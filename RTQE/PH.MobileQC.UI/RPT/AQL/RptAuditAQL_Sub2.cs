...
{
    public partial class RptAuditAQL_Sub2 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public RptAuditAQL_Sub2()
        {
            InitializeComponent();
        }

        public RptAuditAQL_Sub2(DataTable dbheader,DataTable reportdata,Dictionary<string,int[]> dict_wssum,Dictionary<string,int[]> dict_custsum,
