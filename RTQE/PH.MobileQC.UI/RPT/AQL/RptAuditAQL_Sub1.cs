...
{
    public partial class RptAuditAQL_Sub1 : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        public RptAuditAQL_Sub1()
        {
            InitializeComponent();
        }

        public RptAuditAQL_Sub1(DataTable dbheader,DataTable reportdata,Dictionary<string,int[]> dict_wssum,Dictionary<string,int[]> dict_custsum,
