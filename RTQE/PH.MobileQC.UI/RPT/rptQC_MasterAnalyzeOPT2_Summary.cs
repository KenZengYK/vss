...
{
    public class rptQC_MasterAnalyzeOPT2_Summary : DevExpress.XtraReports.UI.XtraReport
    {
        #region
        ...
        public rptQC_MasterAnalyzeOPT2_Summary()
        {
            InitializeComponent();
        }
        ...
        public rptQC_MasterAnalyzeOPT2_Summary(List<SubRptdata> datasouce, string Factory, string WorkShop, string Customer, string Style, string Project, string Line, DateTime QC_timeForm, DateTime QC_timeTo, bool SortFPY,int _firstpassaudittotal,string _flag)
        {
            InitializeComponent();
          ...
          //  xr_lineper.DataBindings.Add("Text", this.DataSource, "Per_Line", "{0:0.#}");
            ...
            if (Flag == "A")
              xrLabel3.Text = title_part1 + "巡检定工序报表" +"  - 輔表一 (拉首通率和檢考流程管理)";
            else
                xrLabel3.Text = title_part1 + "巡检查工序报表" + "  - 輔表一 (拉首通率和檢考流程管理)";
            ...
            if (Flag == "A")
              xrLabel1.Text = title_part11 + " Mobile Auditing Operation Report " + "  - Supplement Sheet 1 (Line FPY & OPT Qual Exam. Flow Mgt.)";
            else
        ...
        private void InitializeComponent()
        {
            ...
            this.xrTableCell60.Text = "Audited Result 檢定結果";
            ...
            // 
            // rptQC_MasterAnalyzeOPT2_Summary
            // 
        ...
        private void Detail_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            firstpasschktotal = firstpasschktotal + gbs.FirstPassQty;
            ...
            if (Flag=="A")
            {
              //  xrLabel1.Text="Mobile Auditing Operation Report";
               ...
               // xrLabel3.Text ="巡检查工序报表";
                this.xrTableCell60.Text = "Inspected Result 檢查結果";
                this.xrTableCell3.Text = "\r\nInsp\r\nected\r\nQty\r\n己檢查\r\n件數\r\n";
