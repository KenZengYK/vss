...
{
    public partial class rptWorkShopAnalysis_Group : DevExpress.XtraReports.UI.XtraReport
    {
        string Flag = "";
        public rptWorkShopAnalysis_Group()
        {
            InitializeComponent();
        }
        ...
        public rptWorkShopAnalysis_Group(string execdate)
        {
            InitializeComponent();
            QueryDate = execdate;
        //    BindField();
        ...
        public rptWorkShopAnalysis_Group(string execdate,string factory)
        {
            InitializeComponent();
            QueryDate = execdate;     
            Factory = factory;
        ...
        public rptWorkShopAnalysis_Group(string execdate,string dateto,string factory,string flag)
        {
            InitializeComponent();
            QueryDate = execdate;
            ToDate = dateto;
        ...
        private void GroupFooter1_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            //this.xrFailTtl.Text = _failttl.ToString(); _allchkqty
        ...
        private void PageHeader_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (Flag == "A")
            {
                xrLabel1.Text = "工場表現分析報告 - 巡檢定";
       
            }
            else
            {
                xrLabel1.Text = "工場表現分析報告 - 巡檢查";
            }
        }
