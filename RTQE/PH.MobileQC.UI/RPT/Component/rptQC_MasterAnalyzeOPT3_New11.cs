...
{
    public class rptQC_MasterAnalyzeOPT3_New11 : DevExpress.XtraReports.UI.XtraReport
    {
        #region
        ...
        public rptQC_MasterAnalyzeOPT3_New11()
        {
            InitializeComponent();
        }
        ...
        public rptQC_MasterAnalyzeOPT3_New11(object datasouce, string Factory, string WorkShop, string Customer, string Style, string Project, string Line, DateTime QC_timeForm, DateTime QC_timeTo, bool SortFPY,string Flag)
        {
            InitializeComponent();
            _Flag =Flag;
