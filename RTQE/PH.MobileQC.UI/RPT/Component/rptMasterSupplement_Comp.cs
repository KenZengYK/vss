...
{
    public partial class rptMasterSupplement_Comp : DevExpress.XtraReports.UI.XtraReport
    {
        public rptMasterSupplement_Comp()
        {
            InitializeComponent();
        }

        public rptMasterSupplement_Comp(List<Proc_MasterList> rptdata)
        {
            InitializeComponent();
