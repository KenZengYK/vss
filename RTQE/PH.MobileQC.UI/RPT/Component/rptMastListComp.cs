...
{
    public partial class rptMastListComp : DevExpress.XtraReports.UI.XtraReport
    {

        List<QC_Master> RecheckList = new List<QC_Master>();
        rptRecheklist_Comp SubRpt;
        string DateRange = "", Flag = "A";
        int rowcount = 0, j = 0;
        public rptMastListComp(List<QC_Master> rptdata, string cdate, string flag)
        {
            InitializeComponent();
            DateRange = cdate;
          ...
          //  this.bsMaster.Sort = "Factory asc,WorkShop asc,Line asc,QC_time desc";
            ...
            SubRpt = new rptRecheklist_Comp(RecheckList, DateRange,Flag);
