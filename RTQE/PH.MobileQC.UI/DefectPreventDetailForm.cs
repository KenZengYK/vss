...
{
    public partial class DefectPreventDetailForm : PH.Platform.UI.CS.UI2.DetailForm//PH.UI.UI1.SingleDetailForm
    {
        //public int mtype;

        public DefectPreventDetailForm()
        {
            InitializeComponent(); 
        }
