...
{
    public partial class StyleLineQCStatByWorkshopListForm_Comp : PH.Platform.UI.CS.UI2.ListForm
    {
        //#region
        ...
        public StyleLineQCStatByWorkshopListForm_Comp()
        {
            InitializeComponent();
        ...
        protected override void OnClickFind()
        {
            ...
            if (frmCondition.ShowDialog() == DialogResult.OK)
            {
                ...
                var lists = (this.DataContext as MobileQCDataContext).StyleLineQCStatByWorkShop_Comp(
                                this._Factory, this._Workshop,
                                PH.Platform.AuthMgr.BO.Environment.Instance.UserLanguage.LangID,
                                this._ShowYellow, this._ShowGreen, this._ShowRed);                  
        ...
        private void BtnPrint_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                StyleLineQCStat_Comp rpt = new StyleLineQCStat_Comp(this.BindingSource.List,
                       this._Factory, this._Workshop );
