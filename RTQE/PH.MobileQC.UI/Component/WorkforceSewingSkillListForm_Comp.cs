...
{
    public partial class WorkforceSewingSkillListForm_Comp : PH.Platform.UI.CS.UI2.ListForm
    {
        //#region
        ...
        public WorkforceSewingSkillListForm_Comp()
        {
            InitializeComponent();
        ...
        protected override void OnClickFind()
        {
            ...
            if (frmCondition.ShowDialog() == DialogResult.OK)
            {
                ...
                this.BindingSource.DataSource = (this.DataContext as MobileQCDataContext).WorkforceSewingSkill_Comp(
