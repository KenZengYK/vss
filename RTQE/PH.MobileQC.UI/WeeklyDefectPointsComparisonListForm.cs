...
using PH.MobileQC.UI.FullInspection;

namespace PH.MobileQC.UI
{
    public partial class WeeklyDefectPointsComparisonListForm : PH.Platform.UI.CS.UI2.ListForm
    {
        ...
        public WeeklyDefectPointsComparisonListForm()
        {
            InitializeComponent();
            //WeeklySource();
        ...
        private void barQuery_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            WeeklyDefectPointsComparisonQueryForm frm = new WeeklyDefectPointsComparisonQueryForm(this);
        ...
        private void barPrint_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                WeeklyDefectPointsComparsionReport WDPCReport = new WeeklyDefectPointsComparsionReport(ReportSource, AReportDatePeroidType, AWeeklyOrMonthly, AFromDate, AToDate);
