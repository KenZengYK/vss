...
{
    public partial class StyleLineQCStatListForm : PH.Platform.UI.CS.UI2.ListForm
    {
        //#region
        ...
        public StyleLineQCStatListForm()
        {
            InitializeComponent();
        ...
        private void BtnPrint_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                StyleLineQCStat rpt = new StyleLineQCStat(this.BindingSource.List, this._Line, this._Style);
                rpt.ShowPreview();
            }
