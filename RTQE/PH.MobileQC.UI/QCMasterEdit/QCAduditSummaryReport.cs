...
{
    public partial class QCAduditSummaryReport : DevExpress.XtraReports.UI.XtraReport
    {

        DataSet ds = new DataSet();
        public QCAduditSummaryReport(string ACustomer, string ADateStart, string ADateDue)
        {
            InitializeComponent();
        ...
        void GetDataSource(string Customer, string DateStart, string DateDue) 
        {
            ...
            string SqlStr = "exec Sp_QCAduditSummary '{0}','{1}','{2}'";
