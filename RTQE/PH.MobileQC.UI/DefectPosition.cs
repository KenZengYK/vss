...
{
    public partial class DefectPosition : PH.Platform.UI.CS.UI2.ListForm //PH.UI.UI1.SingleListForm
    {
        MobileQCDataContext context = PH.Platform.BO.ContextBuilder.CreateContext<MobileQCDataContext>();

        public DefectPosition()
        {
            InitializeComponent();
        }         
        ...
        public override void DataBind()
        {
            ...
            this.DataSource = from d in context.QC_Defects where d.Defect_Type == 2 select d;
            this.EditorTypeName = typeof(DefectPostionDetailForm).FullName;
