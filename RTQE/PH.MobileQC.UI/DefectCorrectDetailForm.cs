...
{
    public partial class DefectCorrectDetailForm : PH.Platform.UI.CS.UI2.DetailForm//PH.UI.UI1.SingleDetailForm
    {
        //public int mtype;

        public DefectCorrectDetailForm()
        {
            InitializeComponent(); 
        }
