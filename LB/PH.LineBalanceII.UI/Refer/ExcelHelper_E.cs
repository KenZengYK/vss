...
{
    public class ExcelHelper_E
    {
        #region  Field Define
        private string _ExcelFilePath;
        private StyleMasterDetailForm_E _StyleMasterDetailForm;
        ...
        #region 構造函數
        public ExcelHelper_E(string AExcelFilePath, StyleMasterDetailForm_E AStyleMasterDetailForm, GridView AGridView, StyleMaster AMaster, bool APrintMainTable, bool APrintAdjTable,string ALangid)
        {
