...
{
    public partial class LmTypeDetailForm : DetailForm
    {
        public LmTypeDetailForm()
        {
            InitializeComponent();
        }
        ...
        protected override void SaveCurrent()
        {
            ...
            if (IsNew)
            {
                ...
                //if (chkYt.Checked)
                mdd.DataType = "PH.BondingSpec.LmType";


                mdd.DataCode = textEdit1.Text;
