...
{
    public class StyleProcedureListForm_F : PH.Platform.UI.CS.UI2.ListForm
    {
        #region
        ...
        public StyleProcedureListForm_F()
        {
        ...
        void gridView1_CellMerge(object sender, CellMergeEventArgs e)
        {
            ...
            StyleMasterDetailForm_F myParentForm = this.ParentForm as StyleMasterDetailForm_F;
        ...
        {
            StyleMasterDetailForm_F myParentForm = this.ParentForm as StyleMasterDetailForm_F;
            if (myParentForm.Master.StyleProcedure_Fs.Count == 0) return;//zrtag add
        ...
        void gridView1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            {
                StyleProcedure_F CurInfo = (StyleProcedure_F)this.BindingSource.Current;
        ...
        void gridView1_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            myParentForm.barToolbarsListItemCOp.Enabled = ((StyleProcedure_F)this.BindingSource.Current).TeamGSD.ToUpper() != "O";
        }
        ...
        {
            StyleProcedure_F obj = this.BindingSource.Current as StyleProcedure_F;
            ...
            if ((this.ParentForm != null) && (this.ParentForm is StyleMasterDetailForm_F))
            {
                StyleMasterDetailForm_F myParentForm = this.ParentForm as StyleMasterDetailForm_F;
                StyleMaster myStyleMaster = ((StyleProcedure_F)this.BindingSource.Current).StyleMaster;//zr ((this.BindingSource.DataSource as BindingSource).Current as StyleMaster);

                if (myParentForm.objEditBar.Visible && this.gridView1.FocusedColumn.Name == "gridColCJQR") //車間確認
                {
                    StyleProcedure_F Current = (StyleProcedure_F)this.BindingSource.Current;
        ...
        private void InitializeComponent()
        {
            ...
            this.repEquaItem});
            this.objListGridControl.Size = new System.Drawing.Size(910, 395);
            ...
            this.gridBand1.Width = 42;
            // 
            // gcEquaItem
            // 
            this.gcEquaItem.AppearanceCell.Options.UseTextOptions = true;
            this.gcEquaItem.AppearanceCell.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
            ...
            // 
            // StyleProcedureListForm_F
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 12F);
            this.Name = "StyleProcedureListForm_F";
            this.Size = new System.Drawing.Size(910, 422);
