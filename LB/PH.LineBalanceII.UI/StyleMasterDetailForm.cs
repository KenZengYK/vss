...
{
    public class StyleMasterDetailForm : PH.Platform.UI.CS.UI2.ParentChildForm
    {
        ...
        private StyleProcedureListForm styleProcedureListForm1;
        ...
        //    // repEquaItem.DataSource = StyleList;
        //}
        ...
        /// 當前StyleProcedureListForm
        /// </summary>
        public StyleProcedureListForm ChildStyleProcedureListForm
        {
            get
            {
                return this.styleProcedureListForm1;
        ...
        /// 子頁面中的StyleProcedure所有數據
        /// <summary>
        /// 子頁面中的StyleProcedure所有數據
        /// </summary>
        public EntitySet<StyleProcedure> CurStyleProcedureList
        {
            get
            {
                System.Data.Linq.EntitySet<StyleProcedure> Infos = new EntitySet<StyleProcedure>();

                for (int i = 0; i < this.ChildStyleProcedureListForm.BindingSource.Count; i++)
                {
                    Infos.Add((StyleProcedure)this.ChildStyleProcedureListForm.BindingSource[i]);
                }
                return Infos;
            }
        ...
        public StyleMasterDetailForm()
        {
            ...
            styleProcedureListForm1.Visible = true;
        ...
        public void BindStatus()
        {
            ...
            //// lueStatu.Properties.PopulateColumns();
        ...
        public override void DataBind()
        {
            ...
            if (IsEditting)
            {
                styleProcedureListForm1.AllowGridEdit = true;
                styleProcedureListForm1.AllowAddRow = false;
            }


            if (this.BindingSource == null || this.BindingSource.DataSource == null || this.BindingSource.Current == null ||
               (this.BindingSource.Current as StyleMaster).StyleProcedures.Count == 0)
            {
                return;
            }
            this.ReCalculateXH();
            ...
            //this.styleProcedureListForm1.BindingSource.DataSource = from a in this.Master.StyleProcedures
            //                                                        orderby a.XH
            //                                                        select a;

            if ((this.PrevForm as StyleMasterListForm).OperType == "A")
            {
                this.styleProcedureListForm1.BindingSource.DataSource = this.Master.StyleProcedures.OrderBy(p => p.XH);
            }
            else if ((this.PrevForm as StyleMasterListForm).OperType == "All")
            {
                this.styleProcedureListForm1.BindingSource.DataSource = this.Master.GetAllDataStyleProcedure();
            }
        ...
        public override void EditCurrent()
        {
            ...
            //LineBalanceII_Factory
            if (this.IsNew)
            {
                // chkIsUsed.Checked = true;
                // this.lueStatu.ItemIndex = 0;
            ...
            {
                styleProcedureListForm1.AllowGridEdit = false;
                styleProcedureListForm1.AllowAddRow = false;
            }
        ...
        private void MoveUp(string type)
        {
            ...
            StyleProcedure CurInfo = (StyleProcedure)this.styleProcedureListForm1.BindingSource.Current;
            StyleProcedure PriorInfo = (StyleProcedure)this.styleProcedureListForm1.BindingSource[index - 1];
        ...
        //    foreach (StyleProcedure obj in this.Master.StyleProcedures)
        //    {
        ...
        {
            //System.Data.Linq.EntitySet<StyleProcedure> Infos = (this.BindingSource.Current as StyleMaster).StyleProcedures;
            System.Data.Linq.EntitySet<StyleProcedure> Infos = this.CurStyleProcedureList;
            ...
            StyleProcedure CurInfo = Infos[index];
            ...
            if (!string.IsNullOrEmpty(CurInfo.JFlag))
            {
                ...
                foreach (StyleProcedure obj in Infos)
                {
        ...
        private bool BeforeMoveProcess(MoveType AMoveType)
        {
            ...
            {
                StyleProcedure PriorInfo = Infos[index - 1];
            ...
            {
                StyleProcedure NextInfo = Infos[index + 1];
        ...
        private void MoveDown(string type)
        {
            ...
            StyleProcedure CurInfo = (StyleProcedure)this.styleProcedureListForm1.BindingSource.Current;
            StyleProcedure NextInfo = (StyleProcedure)this.styleProcedureListForm1.BindingSource[index + 1];
        ...
        private void barToolbarsListItemDelete_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (ErrorMessageManager.ShowMessage(this.SideProgramID, this.FileID, this.FormName, "msgdeleteconfirm", this.Langid) == DialogResult.Yes)
            {
                ...
                (this.DataContext as LineBalanceIIDataContext).StyleProcedures.DeleteOnSubmit(this.ChildStyleProcedureListForm.BindingSource.Current as StyleProcedure);
                this.Master.StyleProcedures.Remove(this.ChildStyleProcedureListForm.BindingSource.Current as StyleProcedure);
        ...
        {
            //System.Data.Linq.EntitySet <StyleProcedure> SaveList = new System.Data.Linq.EntitySet <StyleProcedure>();
            //foreach (StyleProcedure obj in (this.BindingSource.Current as StyleMaster).StyleProcedures)
            //{
        ...
        {
            int i = 0;
            foreach (StyleProcedure obj in this.CurStyleProcedureList)//(this.BindingSource.Current as StyleMaster).StyleProcedures)
            {
                obj.XH = ++i;
            }
        }
        ...
        private void barToolbarsListImportData_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            if (this.Master.StyleProcedures.Count > 0)
            {
                //  MessageBox.Show(this.Master.StyleProcedures.Count.ToString());
            ...
            //try
            {
                ...
                this.Master.StyleProcedures.Clear();
                this.Master.StyleProcedure_Es.Clear();
                this.Master.StyleProcedure_Fs.Clear();
                this.RefreshPageData();

                DataRow[] dr1 = dt.Select("zbdesc_en='A'", "gxh asc");
                DataRow[] dr2 = dt.Select("zbdesc_en='E'", "gxh asc");
                DataRow[] dr3 = dt.Select("zbdesc_en<>'E' and zbdesc_en<>'A'", "gxh asc");
                this.ImportA(dr1); this.ImportE(dr2); this.ImportF(dr3);
        ...
        #region 導入數據 Import Operation data
        void ImportF(DataRow[] rows)
        {
            for (int i = 0; i < rows.Count(); i++)
            {
                ...
                info.TeamGSD = rows[i]["ZB"].ToString();
                info.SN = Convert.ToInt32(rows[i]["GXH"].ToString());

                info.WorkSN = rows[i]["GXDH"].ToString();

                //    info.Price = Decimal.Parse(rows[i]["dj"].ToString()); //add by joseph
                ...
                //{
                //    info.WorkName = rows[i]["EGXM"].ToString();
                //    info.YCType = rows[i]["EYCZL"].ToString();
                //}
                //else if (PH.Platform.AuthMgr.BO.Environment.Instance.UserLanguage.LangID == "TH")
                //{
                //    info.WorkName = rows[i]["TGXM"].ToString();
                //    info.YCType = rows[i]["EYCZL"].ToString();
                //}
                //else
                //{
                //    info.WorkName = rows[i]["GXM"].ToString();
                //    info.YCType = rows[i]["YCZL"].ToString();
                //}

                //由David修改 2022-11-29
                info.WorkName = rows[i]["GXM"].ToString();    //工序名称(中文)
                info.WorkNameEN = rows[i]["EGXM"].ToString(); //工序名称(英文)
                info.YCType = rows[i]["YCZL"].ToString();     //衣车种类(中文)
                info.YCTypeEN = rows[i]["EYCZL"].ToString();  ////衣车种类(英文)

                info.GSDSAHSN = Convert.ToDecimal(Convert.ToDecimal(rows[i]["BZSJ"].ToString()).ToString("#0.0000"));
                ...
                {
                    info.YCDM = rows[i]["YCDM"].ToString();
                }
                info.CJQR = rows[i]["cjqr"].ToString() == "True" ? "1" : "0";
                info.BurstNo = rows[i]["zh"].ToString();
                info.Width = rows[i]["zf"].ToString();
                info.Length = rows[i]["zkcc"].ToString();
                info.YCAdj = rows[i]["ycfj"].ToString();
                info.YCSD = rows[i]["YCSD"].ToString();

                info.FAE = rows[i]["zbdesc_en"].ToString();
        ...
        void ImportE(DataRow[] rows)
        {
            for (int i = 0; i < rows.Count(); i++)
            {
                StyleProcedure_E info = new StyleProcedure_E();
                ...
                info.GZWMergeShowValue = -19;
                (this.DataContext as LineBalanceIIDataContext).StyleProcedure_Es.InsertOnSubmit(info);
                this.Master.StyleProcedure_Es.Add(info);
            }


        }
        void ImportA(DataRow[] rows)
        {
            for (int i = 0; i < rows.Count(); i++)
            {
                StyleProcedure info = new StyleProcedure();
                ...
                info.GZWMergeShowValue = -19;
                (this.DataContext as LineBalanceIIDataContext).StyleProcedures.InsertOnSubmit(info);
                this.Master.StyleProcedures.Add(info);
            }
            ...
            if (dt.Rows.Count > 0)
            {
                ...
                for (int j = 0; j < dt.Rows.Count; j++)
                {
                    for (int i = 2; i < dt.Columns.Count; i++)
                    {
                        ...
                        //add PHKH1 to list
                        // object phkh1 =dt.Rows[j]["PHKH1"];                        
                        //if (phkh1!=null&&string.IsNullOrEmpty(phkh1.ToString())&&!this.txtPHKH.Properties.Items.Contains(phkh1.ToString()))
                        //{
                        //    this.txtPHKH.Properties.Items.Add(dt.Rows[j]["PHKH1"].ToString());
                        //}
                        ...
                        if (!string.IsNullOrEmpty(dt.Rows[j][i].ToString()))
                        {
                                ...
                                || PH.Platform.AuthMgr.BO.Environment.Instance.UserLanguage.LangID == "TH")//英文
                            {
                                ...
                                temp = dt.Rows[j][i].ToString() + dt.Rows[j][i + 1].ToString(); //全改為中文
                            }
                            else
                            {
        ...
        private void barToolbarsListItemCOp_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            StyleProcedure curInfo = this.ChildStyleProcedureListForm.BindingSource.Current as StyleProcedure;

            StyleMaster sm = this.Master;
            //sm.StyleProcedures = null;

            //for (int i = 0; i < this.ChildStyleProcedureListForm.BindingSource.Count; i++)
            //{
            //    this.Master.StyleProcedures.Add((StyleProcedure)this.ChildStyleProcedureListForm.BindingSource[i]);
            //}
        ...
        private void barToolbarsListItemJOp_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            foreach (DictionaryEntry item in SaveXHList)
            {
                ...
                StyleProcedure info = this.ChildStyleProcedureListForm.gridView1.GetRow(xh - 1) as StyleProcedure;
                SumJ += (info.CWorkSN ?? 0);
            }
        ...
        {
            //StyleProcedure obj = (StyleProcedure)this.ChildStyleProcedureListForm.gridView1.GetRow(this.ChildStyleProcedureListForm.gridView1.GetRowHandle);


            StyleProcedure obj = this.ChildStyleProcedureListForm.BindingSource.Current as StyleProcedure;
            ...
            {
                StyleProcedure Current = (StyleProcedure)this.ChildStyleProcedureListForm.BindingSource.Current;
        ...
        private void gridView1_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            barToolbarsListItemCOp.Enabled = this.ChildStyleProcedureListForm.BindingSource.Current != null &&
                          ((StyleProcedure)this.ChildStyleProcedureListForm.BindingSource.Current).TeamGSD.ToUpper() != "O";
        }
        #endregion
        ...
        private Hashtable SaveXHList
        {
            get
            {
                return this.styleProcedureListForm1.SaveXHList;
            }
        ...
        private void gridView1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            {
                StyleProcedure CurInfo = (StyleProcedure)this.ChildStyleProcedureListForm.BindingSource.Current;
        ...
        private void CalSummary()
        {
            ...
            //if (Commands.ConvertLBPhare(this.Master.Phase) >= LBPhare.YHLB)
            //{
            //    this.lblJKLM1_T.Text = this.Master.Sum_YHSAH.ToString();
            //    this.lblJKLM2_T.Text = this.Master.Sum_YHSAH_A.ToString();
            //    this.lblJKLM3_T.Text = this.Master.Sum_YHSAH_B.ToString();
            //    this.lblJKLM4_T.Text = this.Master.Sum_YHSAH_C == 0 ? "N.A." : this.Master.Sum_YHSAH_C.ToString();
            //    this.lblJKLM6_T.Text = this.Master.YHJSCL.ToString();
            //    this.lblJKLM7_T.Text = this.Master.Sum_YHLDL.ToString();
            //    this.lblJKLM8_T.Text = this.Master.YHGZW.ToString();

            //    this.lblJKLM9_T.Text = this.Master.YHMaxZJ.ToString();
            //    this.lblJKLM21_T.Text = this.Master.YHMinZJ.ToString();
            //    this.lblJKLM10_T.Text = this.Master.YHMinSAH.ToString();
            //    this.lblJKLM13_T.Text = this.Master.YHLPHS.ToString() + "%";
            //    this.lblJKLM14_T.Text = this.Master.YHSAHZWS.ToString();
            //    this.lblJKLM20_T.Text = this.Master.YHLineVale.ToString("N4");
            //    this.lblJKLM15_T.Text = this.Master.YHMaxMTM.ToString();
            //    this.lblJKLM16_T.Text = this.Master.YHMTMCount.ToString();
            //    this.lblJKLM17_T.Text = this.Master.YHMTMPercent.ToString() + "%";
            //}
            //#endregion

            //#region 二度優化SAH
            //if (Commands.ConvertLBPhare(this.Master.Phase) >= LBPhare.BisYHLB)
            //{
            //    this.lblJKLM1_X.Text = this.Master.Sum_BisYHSAH.ToString();
            //    this.lblJKLM2_X.Text = this.Master.Sum_BisYHSAH_A.ToString();
            //    this.lblJKLM3_X.Text = this.Master.Sum_BisYHSAH_B.ToString();
            //    this.lblJKLM4_X.Text = this.Master.Sum_BisYHSAH_C == 0 ? "N.A." : this.Master.Sum_BisYHSAH_C.ToString();
            //    this.lblJKLM6_X.Text = this.Master.BisYHJSCL.ToString();
            //    this.lblJKLM7_X.Text = this.Master.Sum_BisYHLDL.ToString();
            //    this.lblJKLM8_X.Text = this.Master.BisYHGZW.ToString();

            //    this.lblJKLM9_X.Text = this.Master.BisYHMaxZJ.ToString();
            //    this.lblJKLM21_X.Text = this.Master.BisYHMinZJ.ToString();
            //    this.lblJKLM10_X.Text = this.Master.BisYHMinSAH.ToString();
            //    this.lblJKLM13_X.Text = "N.A.";//this.master.BisYHLPHS.ToString() + "%";
            //    this.lblJKLM14_X.Text = this.Master.BisYHSAHZWS.ToString();
            //    this.lblJKLM20_X.Text = (this.Master.BestLineValue ?? 0).ToString("N4");//(this.BestLineValue??0)this.Master.BestLineValue.ToString("N4");(this.BestLineValue??0)
            //    this.lblJKLM15_X.Text = this.Master.BisYHMaxMTM.ToString();
            //    this.lblJKLM16_X.Text = this.Master.BisYHDownLDL.ToString();
            //    this.lblJKLM17_X.Text = this.Master.BisYHMTMPercent.ToString() + "%";
            //}
        ...
        private void barToolbarsListItemPaste_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (SaveInfo != null)
            {
                ...
                StyleProcedure info = (StyleProcedure)this.ChildStyleProcedureListForm.BindingSource.Current;
                ...
                if (SaveCurXH != -19) //剪切
                {
                    StyleProcedure CutInfo = (StyleProcedure)this.ChildStyleProcedureListForm.gridView1.GetRow(SaveCurXH);

                    System.Data.Linq.EntitySet<StyleProcedure> Infos = this.CurStyleProcedureList; //(this.BindingSource.Current as StyleMaster).StyleProcedures;
                    this.Master.ResetXH(SaveCurXH + 1, -1);

                    Infos.Remove(CutInfo);
                    (this.DataContext as LineBalanceIIDataContext).StyleProcedures.DeleteOnSubmit(CutInfo);
                }
                this.SaveInfo = null;
                this.SaveCurXH = -19;
                this.Master.CalBNCX();
        ...
        #region 複製
        private StyleProcedure SaveInfo = null;
        ...
        private void Print()
        {
            ...
            try
            {
                ...
                ExcelHelper excelHelper = new ExcelHelper(path, this, this.ChildStyleProcedureListForm.gridView1, this.Master, fPrintSetup.PrintMainTable, fPrintSetup.PrintAdjTable, this.Langid);
        ...
        private void btnExportGraph_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            p.StartInfo.FileName = Application.StartupPath + @"\" + lib.OutputVisioName;
            p.Start();
        ...
        private void AddUndoList()
        {
            ...
            foreach (StyleProcedure oldobj in CurStyleProcedureList)
            {
                StyleProcedure newobj = new StyleProcedure();

                EntityCopy(newobj, oldobj);

                perobj.StyleProcedures.Add(newobj);
            }
        ...
        private void barToolbarsListItemUndo_ItemClick(object sender, ItemClickEventArgs e)
        {
            if (undolistStyleMaster.Count > 0)
            {
                ...
                //////////////////////////////刪除原數據子信息，還原主信息//////////////////////////////////////               
                foreach (StyleProcedure sp in this.Master.StyleProcedures)
                {
                    try
                    {
                        (this.DataContext as LineBalanceIIDataContext).StyleProcedures.DeleteOnSubmit(sp);
                    }
                    catch { continue; }
                ...
                foreach (StyleProcedure obj in Perobj.StyleProcedures)
                {
                    StyleProcedure newobj = new StyleProcedure();

                    EntityCopy(newobj, obj);

                    (this.DataContext as LineBalanceIIDataContext).StyleProcedures.InsertOnSubmit(newobj);

                    this.Master.StyleProcedures.Add(newobj);
                }
        ...
        private void EntityCopy(StyleProcedure newobj, StyleProcedure oldobj)
        {
        ...
        {
            int indexno = 0;
            for (int i = 0; i < this.styleProcedureListForm1.BindingSource.Count; i++)
            {
                if (((StyleProcedure)this.styleProcedureListForm1.BindingSource[i]).XH == ((StyleProcedure)this.styleProcedureListForm1.BindingSource.Current).XH)
                {
                    indexno = i;
                    break;
                }
        ...
        private void RefreshPageData()
        {
            ...
            this.styleProcedureListForm1.DataSource = from a in this.Master.StyleProcedures
                                                      orderby a.XH
                                                      select a;
            this.styleProcedureListForm1.gridView1.RefreshData();
        ...
        {
            //(this.DataContext as LineBalanceIIDataContext).StyleProcedures.DeleteAllOnSubmit(this.Master.StyleProcedures); 

            this.styleProcedureListForm1.DataSource = from a in sm.StyleProcedures
                                                      orderby a.XH
                                                      select a;
        ...
        {
            foreach (StyleProcedure info in this.Master.StyleProcedures)
            {
                (this.DataContext as LineBalanceIIDataContext).StyleProcedures.InsertOnSubmit(info);
            }
        }
        ...
        private void InitializeComponent()
        {
            ...
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(StyleMasterDetailForm));
            ...
            this.styleProcedureListForm1 = new PH.LineBalanceII.UI.StyleProcedureListForm();
            ...
            this.splitterControl1.Size = new System.Drawing.Size(1498, 6);
            ...
            this.headerTitleBar.Location = new System.Drawing.Point(0, 79);
            this.headerTitleBar.Size = new System.Drawing.Size(1498, 80);
            ...
            this.panelControl1.Size = new System.Drawing.Size(1498, 371);
            this.PlatetoolTipController.SetSuperTip(this.panelControl1, null);
            this.panelControl1.TabIndex = 1;
            // 
            // xtraTabPage1
            // 
            this.xtraTabPage1.Controls.Add(this.styleProcedureListForm1);
            this.xtraTabPage1.Size = new System.Drawing.Size(1485, 335);
            // 
            // xtraTabControl1
            // 
            this.xtraTabControl1.SelectedTabPage = this.xtraTabPage1;
            this.xtraTabControl1.Size = new System.Drawing.Size(1494, 367);
            // 
            // BindingSource
            // 
            ...
            this.barToolbarsListItemAutoJSC.Caption = "極佳(間時拆)";
            ...
            // 
            this.barToolbarsListItemAutoPJH.Caption = "極佳(平准化)";
            ...
            this.barToolbarsListItemFixed.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListItemFixed.Glyph")));
            ...
            this.barToolbarsListItemMovePrevious.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListItemMovePrevious.Glyph")));
            ...
            this.barToolbarsListItemMoveNext.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListItemMoveNext.Glyph")));
            ...
            this.barToolbarsListItemDelete.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListItemDelete.Glyph")));
            ...
            this.barToolbarsListItemCopy.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListItemCopy.Glyph")));
            ...
            this.barToolbarsListItemCut.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListItemCut.Glyph")));
            ...
            this.barToolbarsListItemPaste.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListItemPaste.Glyph")));
            ...
            this.barToolbarsListItemCOp.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListItemCOp.Glyph")));
            ...
            this.barToolbarsListItemJOp.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListItemJOp.Glyph")));
            ...
            this.barToolbarsListImportData.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListImportData.Glyph")));
            ...
            this.barToolbarsListItemCal.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListItemCal.Glyph")));
            ...
            this.txtCPLB.Location = new System.Drawing.Point(371, 3);
            this.txtCPLB.Name = "txtCPLB";
            this.txtCPLB.Size = new System.Drawing.Size(68, 21);
            ...
            this.lblCategory.Location = new System.Drawing.Point(312, 0);
            ...
            this.lblSize.Location = new System.Drawing.Point(445, 0);
            ...
            this.txtSizeYJ.Location = new System.Drawing.Point(560, 3);
            this.txtSizeYJ.Name = "txtSizeYJ";
            this.txtSizeYJ.Size = new System.Drawing.Size(62, 21);
            ...
            this.lblZH.Size = new System.Drawing.Size(43, 27);
            ...
            this.lblEdition.Location = new System.Drawing.Point(628, 0);
            ...
            this.txtEdition.Location = new System.Drawing.Point(663, 3);
            this.txtEdition.Name = "txtEdition";
            this.txtEdition.Size = new System.Drawing.Size(59, 21);
            ...
            this.txtZH.Size = new System.Drawing.Size(82, 21);
            ...
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.txtPHKH.Size = new System.Drawing.Size(83, 21);
            ...
            this.lblValid.Location = new System.Drawing.Point(728, 0);
            this.lblValid.Name = "lblValid";
            this.lblValid.Size = new System.Drawing.Size(56, 30);
            this.PlatetoolTipController.SetSuperTip(this.lblValid, null);
            this.lblValid.TabIndex = 26;
            this.lblValid.Text = "有效日期";
            ...
            this.hideContainerBottom.Location = new System.Drawing.Point(0, 530);
            this.hideContainerBottom.Name = "hideContainerBottom";
            this.hideContainerBottom.Size = new System.Drawing.Size(1498, 20);
            ...
            this.dockPanelSummary.Size = new System.Drawing.Size(1498, 373);
            ...
            this.dockPanel1_Container.Size = new System.Drawing.Size(1492, 345);
            ...
            this.tableSum.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 90F));
            this.tableSum.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 90F));
            this.tableSum.ColumnStyles.Add(new System.Windows.Forms.ColumnStyle(System.Windows.Forms.SizeType.Absolute, 423F));
            ...
            this.lblJKLM1_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblJKLM2_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblJKLM3_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblJKLM4_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblJKLM6_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblJKLM7_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblJKLM8_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblJKLM9_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblJKLM10_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblJKLM13_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblJKLM14_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblPJH.Size = new System.Drawing.Size(417, 20);
            ...
            this.lblJKLM21_Z.Size = new System.Drawing.Size(417, 20);
            ...
            this.tableLayoutPanel3.Controls.Add(this.edtUpdateTime, 20, 1);
            this.tableLayoutPanel3.Controls.Add(this.txtCust, 1, 2);
            this.tableLayoutPanel3.Controls.Add(this.lblUpdateTime, 19, 1);
            this.tableLayoutPanel3.Controls.Add(this.cbbFac, 20, 2);
            this.tableLayoutPanel3.Controls.Add(this.edtUpdater, 17, 1);
            this.tableLayoutPanel3.Controls.Add(this.lblFac, 19, 2);
            this.tableLayoutPanel3.Controls.Add(this.lblUpdater, 16, 1);
            this.tableLayoutPanel3.Controls.Add(this.edtCreateTime, 12, 2);
            this.tableLayoutPanel3.Controls.Add(this.lblCreateTime, 11, 2);
            ...
            this.tableLayoutPanel3.Controls.Add(this.lblValid, 11, 1);
            this.tableLayoutPanel3.Controls.Add(this.edtCreater, 17, 2);
            this.tableLayoutPanel3.Controls.Add(this.deValid, 12, 1);
            this.tableLayoutPanel3.Controls.Add(this.lblCreater, 16, 2);
            ...
            this.tableLayoutPanel3.RowStyles.Add(new System.Windows.Forms.RowStyle());
            this.tableLayoutPanel3.RowStyles.Add(new System.Windows.Forms.RowStyle());
            this.tableLayoutPanel3.Size = new System.Drawing.Size(1494, 57);
            ...
            this.edtUpdateTime.Location = new System.Drawing.Point(1037, 3);
            this.edtUpdateTime.Name = "edtUpdateTime";
            this.edtUpdateTime.Size = new System.Drawing.Size(82, 21);
            this.edtUpdateTime.TabIndex = 34;
            // 
            // txtCust
            // 
            ...
            this.txtCust.TabIndex = 38;
            // 
            // lblUpdateTime
            // 
            this.lblUpdateTime.Dock = System.Windows.Forms.DockStyle.Fill;
            this.lblUpdateTime.Location = new System.Drawing.Point(981, 3);
            this.lblUpdateTime.Name = "lblUpdateTime";
            this.lblUpdateTime.Size = new System.Drawing.Size(56, 14);
            this.lblUpdateTime.TabIndex = 33;
            this.lblUpdateTime.Text = "修訂日期 :";
            // 
            // cbbFac
            // 
            ...
            this.cbbFac.Location = new System.Drawing.Point(1037, 33);
            ...
            "GG",
            "RX"});
            this.cbbFac.Size = new System.Drawing.Size(82, 21);
            this.cbbFac.TabIndex = 37;
            ...
            this.edtUpdater.Dock = System.Windows.Forms.DockStyle.Fill;
            this.edtUpdater.Location = new System.Drawing.Point(931, 3);
            this.edtUpdater.Name = "edtUpdater";
            this.edtUpdater.Size = new System.Drawing.Size(44, 21);
            this.edtUpdater.TabIndex = 30;
            // 
            // lblFac
            // 
            this.lblFac.AutoSize = true;
            this.lblFac.Dock = System.Windows.Forms.DockStyle.Fill;
            this.lblFac.Location = new System.Drawing.Point(981, 30);
            this.lblFac.Name = "lblFac";
            this.lblFac.Size = new System.Drawing.Size(50, 27);
            this.PlatetoolTipController.SetSuperTip(this.lblFac, null);
            this.lblFac.TabIndex = 40;
            this.lblFac.Text = "工廠";
            ...
            this.lblUpdater.Location = new System.Drawing.Point(881, 3);
            this.lblUpdater.Name = "lblUpdater";
            this.lblUpdater.Size = new System.Drawing.Size(44, 14);
            this.lblUpdater.TabIndex = 31;
            ...
            this.edtCreateTime.Location = new System.Drawing.Point(790, 33);
            this.edtCreateTime.Name = "edtCreateTime";
            this.edtCreateTime.Size = new System.Drawing.Size(85, 21);
            this.edtCreateTime.TabIndex = 32;
            // 
            // lblCreateTime
            // 
            this.lblCreateTime.Location = new System.Drawing.Point(728, 33);
            this.lblCreateTime.Name = "lblCreateTime";
            this.lblCreateTime.Size = new System.Drawing.Size(56, 14);
            ...
            this.lblCust.Size = new System.Drawing.Size(59, 27);
            this.PlatetoolTipController.SetSuperTip(this.lblCust, null);
            this.lblCust.TabIndex = 39;
            ...
            this.lblJZ_Prod.Location = new System.Drawing.Point(445, 30);
            this.lblJZ_Prod.Name = "lblJZ_Prod";
            this.lblJZ_Prod.Size = new System.Drawing.Size(109, 27);
            this.PlatetoolTipController.SetSuperTip(this.lblJZ_Prod, null);
            this.lblJZ_Prod.TabIndex = 45;
            ...
            this.edtJZ_Prod.Location = new System.Drawing.Point(560, 33);
            this.edtJZ_Prod.Name = "edtJZ_Prod";
            this.edtJZ_Prod.Size = new System.Drawing.Size(62, 21);
            this.edtJZ_Prod.TabIndex = 46;
            // 
            // lblProc
            // 
            this.lblProc.AutoSize = true;
            this.lblProc.Dock = System.Windows.Forms.DockStyle.Fill;
            this.lblProc.Location = new System.Drawing.Point(312, 30);
            this.lblProc.Name = "lblProc";
            this.lblProc.Size = new System.Drawing.Size(53, 27);
            ...
            this.cbbProc.EditValue = "";
            this.cbbProc.Location = new System.Drawing.Point(371, 33);
            this.cbbProc.Name = "cbbProc";
            this.cbbProc.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo)});
            this.cbbProc.Size = new System.Drawing.Size(68, 21);
            this.cbbProc.TabIndex = 44;
            // 
            // lblStatu
            // 
            this.lblStatu.AutoSize = true;
            this.lblStatu.Dock = System.Windows.Forms.DockStyle.Fill;
            this.lblStatu.Location = new System.Drawing.Point(628, 30);
            this.lblStatu.Name = "lblStatu";
            this.lblStatu.Size = new System.Drawing.Size(29, 27);
            this.PlatetoolTipController.SetSuperTip(this.lblStatu, null);
            this.lblStatu.TabIndex = 41;
            this.lblStatu.Text = "狀態";
            this.lblStatu.TextAlign = System.Drawing.ContentAlignment.MiddleCenter;
            // 
            // lueStatu
            // 
            this.lueStatu.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.BindingSource, "Statu_Disp", true));
            this.lueStatu.Location = new System.Drawing.Point(663, 33);
            ...
            this.lueStatu.Properties.PopupFormMinSize = new System.Drawing.Size(60, 0);
            this.lueStatu.Properties.PopupWidth = 120;
            this.lueStatu.Size = new System.Drawing.Size(59, 21);
            this.lueStatu.TabIndex = 42;
            // 
            // edtCreater
            // 
            this.edtCreater.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", this.BindingSource, "CreateBy", true));
            this.edtCreater.Location = new System.Drawing.Point(931, 33);
            this.edtCreater.Name = "edtCreater";
            this.edtCreater.Size = new System.Drawing.Size(44, 21);
            this.edtCreater.TabIndex = 28;
            // 
            // deValid
            // 
            ...
            this.deValid.Location = new System.Drawing.Point(790, 3);
            ...
            this.deValid.Size = new System.Drawing.Size(85, 21);
            this.deValid.TabIndex = 47;
            // 
            // lblCreater
            // 
            this.lblCreater.Location = new System.Drawing.Point(881, 33);
            this.lblCreater.Name = "lblCreater";
            this.lblCreater.Size = new System.Drawing.Size(40, 14);
            this.lblCreater.TabIndex = 27;
            this.lblCreater.Text = "建立人:";
            // 
            // barToolbarsListItemPrint
            // 
            this.barToolbarsListItemPrint.Caption = "列印";
            this.barToolbarsListItemPrint.Glyph = ((System.Drawing.Image)(resources.GetObject("barToolbarsListItemPrint.Glyph")));
            ...
            // 
            // styleProcedureListForm1
            // 
            this.styleProcedureListForm1.AllowAddRow = true;
            this.styleProcedureListForm1.AlwaysShowDesignLayout = false;
            this.styleProcedureListForm1.AutoOpenDetailForm = false;
            this.styleProcedureListForm1.DataContext = null;
            this.styleProcedureListForm1.DataSource = null;
            this.styleProcedureListForm1.Dock = System.Windows.Forms.DockStyle.Fill;
            this.styleProcedureListForm1.EditorTypeName = null;
            this.styleProcedureListForm1.FileID = null;
            this.styleProcedureListForm1.FirstForm = null;
            this.styleProcedureListForm1.FormName = "StyleProcedureListForm";
            this.styleProcedureListForm1.FormState = PH.Platform.BO.Interface.WorkMode.New;
            this.styleProcedureListForm1.FormTitle = "PH.LineBalanceII.UI.StyleProcedureListForm";
            this.styleProcedureListForm1.IsCancelList = false;
            this.styleProcedureListForm1.IsShowPivotTable = false;
            this.styleProcedureListForm1.LayoutData = null;
            this.styleProcedureListForm1.LayoutName = null;
            this.styleProcedureListForm1.ListForm = null;
            this.styleProcedureListForm1.Location = new System.Drawing.Point(0, 0);
            this.styleProcedureListForm1.MenuID = ((long)(0));
            this.styleProcedureListForm1.Name = "styleProcedureListForm1";
            this.styleProcedureListForm1.NeedCheckPermission = true;
            this.styleProcedureListForm1.NextForm = null;
            this.styleProcedureListForm1.ParentForm = null;
            this.styleProcedureListForm1.PrevForm = null;
            this.styleProcedureListForm1.RowChangeAutoSave = true;
            this.styleProcedureListForm1.ShowMultiCheck = false;
            this.styleProcedureListForm1.SideProgramID = null;
            this.styleProcedureListForm1.Size = new System.Drawing.Size(1485, 335);
            this.PlatetoolTipController.SetSuperTip(this.styleProcedureListForm1, null);
            this.styleProcedureListForm1.TabControls = null;
            this.styleProcedureListForm1.TabIndex = 0;
            this.styleProcedureListForm1.TabPage = null;
            // 
            // barBtnPrint
            // 
            ...
            this.Name = "StyleMasterDetailForm";
            this.Size = new System.Drawing.Size(1498, 572);
        ...
        private void styleProcedureListForm1_Load(object sender, EventArgs e)
        {
        ...
        {
            FrmPrintSetup fPrintSetup = new FrmPrintSetup(this,"A");
            ...
            try
            {
                ...
                //_lst[0, 0] = lblJKLM7_O.Text; _lst[0, 1] = lblJKLM7_O.Text; _lst[0, 2] = lblJKLM7_O.Text;
                //_lst[1, 0] = lblJKLM7_O.Text; _lst[1, 1] = lblJKLM7_O.Text; _lst[1, 2] = lblJKLM7_O.Text;
                //_lst[2, 0] = lblJKLM7_O.Text; _lst[2, 1] = lblJKLM7_O.Text; _lst[2, 2] = lblJKLM7_O.Text;
