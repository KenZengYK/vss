...
{
    public class StyleProcedureListForm:PH.Platform.UI.CS.UI2.ListForm
    {
        ...
        void gridView1_CellMerge(object sender, CellMergeEventArgs e)
        {
            ...
            StyleMasterDetailForm myParentForm = this.ParentForm as StyleMasterDetailForm;
        ...
        {
            StyleMasterDetailForm myParentForm = this.ParentForm as StyleMasterDetailForm;
            if (myParentForm.Master.StyleProcedures.Count == 0) return;//zrtag add
            ...
            else if (e.Column.FieldName == "JSCSAHSN")
            {
                ...
                if ((bool)myParentForm.barToolbarsListItemAutoJSC.EditValue && JWorkSN != JSCSAH)
                {
                   ...
                   // e.Appearance.BackColor = Color.FromArgb(186, 85, 211);
                   // e.Appearance.BackColor = Color.FromArgb(218, 112, 214); 
                  //  e.Appearance.BackColor = Color.FromArgb(238, 130, 238); 
                    //e.Appearance.BackColor = Color.FromArgb(221, 160, 221);  李子紫

                    //e.Appearance.BackColor = Color.FromArgb(138, 43, 226);
                  //  e.Appearance.BackColor = Color.FromArgb(147, 112, 219);
                  //  e.Appearance.BackColor = Color.FromArgb(153, 50, 204); //暗蘭花紫
        ...
        void gridView1_MouseUp(object sender, MouseEventArgs e)
        {
            ...
            {
                StyleProcedure CurInfo = (StyleProcedure)this.BindingSource.Current;
        ...
        {    
            ...
            myParentForm.barToolbarsListItemCOp.Enabled = ((StyleProcedure)this.BindingSource.Current).TeamGSD.ToUpper() != "O";
        }
        ...
        {
            StyleProcedure obj = this.BindingSource.Current as StyleProcedure;
            ...
            if ((this.ParentForm != null) && (this.ParentForm is StyleMasterDetailForm))
            {
                StyleMasterDetailForm myParentForm = this.ParentForm as StyleMasterDetailForm;
                StyleMaster myStyleMaster = ((StyleProcedure)this.BindingSource.Current).StyleMaster;//zr ((this.BindingSource.DataSource as BindingSource).Current as StyleMaster);

                if (myParentForm.objEditBar.Visible && this.gridView1.FocusedColumn.Name == "gridColCJQR") //車間確認
                {
                    StyleProcedure Current = (StyleProcedure)this.BindingSource.Current;
        ...
        private void InitializeComponent()
        {
            ...
            this.repEquaItem});
            this.objListGridControl.Size = new System.Drawing.Size(1594, 395);
            ...
            // BindingSource
            // 
            this.BindingSource.DataSource = typeof(PH.LineBalanceII.BO.StyleProcedure);
            // 
            // gridView1
            // 
            ...
            // colYCTypeEN
            // 
            this.colYCTypeEN.AppearanceHeader.Options.UseTextOptions = true;
            this.colYCTypeEN.AppearanceHeader.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Center;
            ...
            this.gcEquaItem.Caption = "工序影響SAH的因素";
            ...
            // 
            // StyleProcedureListForm
            // 
            this.AutoScaleDimensions = new System.Drawing.SizeF(6F, 12F);
            this.Name = "StyleProcedureListForm";
            this.Size = new System.Drawing.Size(1594, 422);
        ...
        public override void ExportData(string filetype)
        {
            ...
            if (dlgr != DialogResult.Cancel)
            {
                ...
                List<LB3Info> _lst =new List<LB3Info>();

                string file = sfd.FileName;
                //saveFileDialog1.FilterIndex = 2;
                // var datalist = (IEnumerable<Matching>)this.BindingSource.DataSource;

                StyleMaster CurMaster = (this.ParentForm as StyleMasterDetailForm).BindingSource.Current as StyleMaster;
                ...
                IEnumerable<StyleProcedure> datalist = (IEnumerable<StyleProcedure>)this.BindingSource.DataSource;

              //  List<StyleProcedure> _lstmatching = new List<StyleProcedure>();


                foreach (StyleProcedure spd in datalist)
                {
                    LB3Info lb =new LB3Info();
                    lb.FAE ="A";
                    lb.SortId =2;
                    lb.OptCode =spd.WorkSN;
                    lb.OptDesc =spd.WorkName;
                    lb.McType =spd.YCDM;
                    lb.MoveType=spd.Move;
                    _lst.Add(lb);
                }

   
                foreach (StyleProcedure_E spe in CurMaster.StyleProcedure_Es)
                {
                    LB3Info lb = new LB3Info();
                    lb.FAE = "E";
                    lb.SortId = 3;
                    lb.OptCode = spe.WorkSN;
                    lb.OptDesc = spe.WorkName;
                    lb.McType = spe.YCDM;
                    lb.MoveType = spe.Move;
                    _lst.Add(lb);
                }



                foreach (StyleProcedure_F spe in CurMaster.StyleProcedure_Fs)
                {
                    LB3Info lb = new LB3Info();
                    lb.FAE = "F";
                    lb.SortId = 1;
                ...
                List<LB3Info>  _lst1 = _lst.OrderBy(p=>p.SortId).ThenBy(m=>m.SN).ToList();

                ExportLB3Info(CurMaster, file,_lst1);
        ...
        #region 導出LB4資料
        void ExportLB3Info(StyleMaster Master, string FilePath, List<LB3Info> LbList)
        {
            try
            {
                ...
                _WorkSheet.PageSetup.Orientation = PHExcel.XlPageOrientation.xlLandscape;
                ...
                _WorkRange.FormulaR1C1 = "LB3 Infomation List";

                //_WorkRange.Text = "aaaa";
                ...
                _WorkSheet.Cells[5, 6] = "MC Type";
                _WorkSheet.Cells[5, 7] = "Move Type";
                int i = 0, start = 6;
                ...
                foreach (LB3Info mct in LbList)
                {

                    _WorkSheet.Cells[start + i, 1] = mct.FAE;
                    _WorkSheet.Cells[start + i, 2] = mct.SN;
                    _WorkSheet.Cells[start + i, 3] = mct.OptCode;
                    _WorkSheet.Cells[start + i, 4] = mct.OptDesc;
                    _WorkSheet.Cells[start + i, 5] = mct.GSD_SAH;
                    _WorkSheet.Cells[start + i, 6] = mct.McType;
                    _WorkSheet.Cells[start + i, 7] = mct.MoveType;

                     
                    i++;

                }
                SetCellBorder(_WorkSheet.Cells[start-1, 1], _WorkSheet.Cells[start + i-1, 7], true, true, true, true, true, true); 
